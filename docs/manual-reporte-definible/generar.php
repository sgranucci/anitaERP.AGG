...
/**
 * Genera Manual de Usuario Reportes contables definibles (Word + PDF) con capturas.
 * Ejecutar: php docs/manual-reporte-definible/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualReporteDefinibleService::class);
$contenido = $manual->meta();
$capturas = config('manual_reporte_definible.capturas', []);
$imgBase = public_path('docs/manual-reporte-definible/img');

$baseName = 'Manual_Usuario_AnitaERP_Reportes_Definibles';
