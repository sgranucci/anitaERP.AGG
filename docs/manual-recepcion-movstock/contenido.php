    ...
    'secciones' => [
        ...
        [
            ...
            'parrafos' => [
                ...
                'Rutina de pickeo: botón Cámara (en HTTP abre la cámara nativa del celular y saca foto; en HTTPS puede leer en vivo), lector Bluetooth o SKU a mano y Enter. Trae el stock del depósito de salida, suma cantidad 1 (si el ítem ya está, incrementa 1 hasta el saldo). Puede corregir la cantidad a mano. Al Transferir se genera la TRA en el ERP.',
