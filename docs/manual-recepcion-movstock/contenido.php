    ...
    'secciones' => [
        ...
        [
            ...
            'parrafos' => [
                ...
                'Rutina de pickeo: botón Cámara (visión en vivo o foto), lector Bluetooth que actúa como teclado, o SKU a mano y Enter. Trae el stock del depósito de salida, suma cantidad 1 (si el ítem ya está, incrementa 1 hasta el saldo). Puede corregir la cantidad a mano. Al Transferir se genera la TRA en el ERP. La cámara en vivo requiere HTTPS; si el ERP está en HTTP, el navegador ofrece sacar una foto del código.',
                ...
                'TRCONT: si el artículo es de otros activos (cuenta compra del catálogo), la pantalla pasa a TRCONT para no omitir la contabilidad. El depósito de salida debe tener una recepción de compra de ese SKU; si no, avisa y no deja cargar. TITO: el depósito de salida debe ser el de la última recepción. «Cargar stock» con TRCONT lista solo artículos válidos; los demás se omiten con aviso.',
        ...
        [
            ...
            'items' => [
                ...
                'Transferencia inmediata (pickeo): Transferencia → TRA y depósitos 1→8 ya vienen cargados → pickear SKU/barra (cantidad 1) → Transferir.',
