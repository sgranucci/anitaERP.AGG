...
/**
 * Genera Manual de Usuario Recuento (Word + PDF) con capturas.
 * Ejecutar: php docs/manual-recepcion-movstock/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualRecepcionMovstockService::class);
$contenido = $manual->meta();
$capturas = config('manual_recepcion_movstock.capturas', []);
$imgBase = public_path('docs/manual-recepcion-movstock/img');

$baseName = 'Manual_Usuario_AnitaERP_Recepcion_Movimientos_Stock';
