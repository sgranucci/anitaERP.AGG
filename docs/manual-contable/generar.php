...
/**
 * Genera Manual de Usuario Módulo Contable (Word + PDF) con capturas.
 * Ejecutar: php docs/manual-contable/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualContableService::class);
$contenido = $manual->meta();
$capturas = config('manual_contable.capturas', []);
$imgBase = public_path('docs/manual-contable/img');

$baseName = 'Manual_Usuario_AnitaERP_Modulo_Contable';
