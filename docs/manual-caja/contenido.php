    ...
    'secciones' => [
        [
            ...
            'items' => [
                ...
                'Las rendiciones de máquinas alimentan venta de fichas e impuesto drop que el Flash consume en el turno C (cierre).',
        ...
        [
            ...
            'items' => [
                ...
                '2) Por turno: se cargan rendiciones de máquinas M, T y N (parciales). Al cierre del día, turno C con venta de fichas, impuesto drop y totales completos.',
            ...
            'tabla' => [
                ...
                'rows' => [
                    ...
                    ['Cierre día máquinas', 'ERP turno C', 'Venta fichas + impuesto drop para Flash slot_d / slot_r'],
        ...
        [
            ...
            'tabla' => [
                ...
                'rows' => [
                    ['slot_d', 'Bill + venta fichas rendición C + QR neto − impuesto drop', 'Wigos M + rendmaquina C'],
                    ['slot_r', 'slot_d − pagos tickets − pagos manuales (M+T+N) − impuesto drop', 'Wigos + rendición'],
                    ...
                    ['rul_d / rul_r', 'Bill ruletas − pagos ruletas (sin ventas tickets)', 'Wigos drop + pagos TerminalType=2'],
        ...
        [
            ...
            'parrafos' => [
                ...
                'Turnos: M (mañana), T (tarde), N (noche) son parciales del working day; C (completo) es el cierre del día e incluye venta de fichas e impuesto drop que el Flash usa en slot_d y slot_r.',
            ],
            'tabla' => [
                ...
                'rows' => [
                    ...
                    ['C', 'Cierre financiero del día; venta fichas e impuesto drop', 'Modo cierre — drop real del día'],
                ],
            ],
            'items' => [
                ...
                'Relación Flash: venta_ficha e impuesto_drop del turno C alimentan slot_d y slot_r (reemplazan ventas tickets slots/caja e impuesto venta); pagos manuales M+T+N restan en slot_r. Ruletas: solo bill, sin ventas tickets.',
        ...
        [
            ...
            'tabla' => [
                ...
                'rows' => [
                    ['El Flash no coincide con Wigos', 'Pulse Calcular desde ERP/Wigos. Abra origen de total en slot_d/slot_r. Verifique turno C cargado con venta de fichas e impuesto drop.'],
                    ...
                    ['Turno C sin rendición', 'slot_d/slot_r usarán VentaTickets Wigos como venta de fichas y quedarán sin impuesto drop. Cargue turno C antes del flash para alinear con rendición.'],
