...
/**
 * Genera Manual de Plataforma IA (Word + PDF).
 * Ejecutar: php docs/manual-ia/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualIaService::class);
$contenido = $manual->meta();
$capturas = config('manual_ia.capturas', []);
$imgBase = public_path('docs/manual-ia/img');

$baseName = 'Manual_Plataforma_IA_AnitaERP';
