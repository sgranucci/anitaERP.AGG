...
/**
 * Genera Manual de Usuario Módulo UIF (Word + PDF) con capturas.
 * Ejecutar: php docs/manual-uif/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualUifService::class);
$contenido = $manual->meta();
$capturas = config('manual_uif.capturas', []);
$imgBase = public_path('docs/manual-uif/img');

$baseName = 'Manual_Usuario_AnitaERP_Modulo_UIF';
