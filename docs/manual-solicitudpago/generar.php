...
/**
 * Genera Manual de Usuario Solicitudes de pago (Word + PDF) con capturas.
 * Ejecutar: php docs/manual-solicitudpago/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualSolicitudpagoService::class);
$contenido = $manual->meta();
$capturas = config('manual_solicitudpago.capturas', []);
$imgBase = public_path('docs/manual-solicitudpago/img');

$baseName = 'Manual_Usuario_AnitaERP_Solicitudes_Pago';
