...
/**
 * Genera Manual de Usuario Propuesta de pagos (Word + PDF) con capturas.
 * Ejecutar: php docs/manual-propuesta-pago/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualPropuestaPagoService::class);
$contenido = $manual->meta();
$capturas = config('manual_propuesta_pago.capturas', []);
$imgBase = public_path('docs/manual-propuesta-pago/img');

$baseName = 'Manual_Usuario_AnitaERP_Propuesta_Pagos';
