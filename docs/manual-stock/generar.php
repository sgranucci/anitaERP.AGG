 ...
 * Ejecutar: php docs/manual-stock/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualStockService::class);
$contenido = $manual->meta();
$capturas = config('manual_stock.capturas', []);
$imgBase = public_path('docs/manual-stock/img');

$baseName = 'Manual_Usuario_AnitaERP_Recuento_Inventario';
