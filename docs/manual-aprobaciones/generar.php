...
/**
 * Genera Manual Mis aprobaciones (Word + PDF).
 * Ejecutar: php docs/manual-aprobaciones/generar.php
 */
...
$outDir = __DIR__;
$manual = app(ManualAprobacionesService::class);
$contenido = $manual->meta();

$baseName = 'Manual_Usuario_AnitaERP_Mis_Aprobaciones';
