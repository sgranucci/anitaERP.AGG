...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Listas de precios', $padreId, $orden, 'fa-tags');

        $slugs = [
            ['nombre' => 'Listar listas de precios estacionamiento', 'slug' => 'listar-estacionamiento-lista-precio'],
            ['nombre' => 'Ingresar listas de precios estacionamiento', 'slug' => 'crear-estacionamiento-lista-precio'],
            ['nombre' => 'Editar listas de precios estacionamiento', 'slug' => 'editar-estacionamiento-lista-precio'],
            ['nombre' => 'Actualizar listas de precios estacionamiento', 'slug' => 'actualizar-estacionamiento-lista-precio'],
            ['nombre' => 'Borrar listas de precios estacionamiento', 'slug' => 'borrar-estacionamiento-lista-precio'],
        ];
