...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/prenda';

    private const HIJO_NOMBRE = 'Prendas';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar prenda sueldos', 'slug' => 'listar-prenda-sueldos'],
        ['nombre' => 'Crear prenda sueldos', 'slug' => 'crear-prenda-sueldos'],
        ['nombre' => 'Editar prenda sueldos', 'slug' => 'editar-prenda-sueldos'],
        ['nombre' => 'Actualizar prenda sueldos', 'slug' => 'actualizar-prenda-sueldos'],
        ['nombre' => 'Borrar prenda sueldos', 'slug' => 'borrar-prenda-sueldos'],
    ];
