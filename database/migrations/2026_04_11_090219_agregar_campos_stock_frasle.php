    ...
    public function down(): void
    {
        if (config('app.empresa') == 'FRASLE')
            Schema::table('articulo', function (Blueprint $table) {
                ...
                $table->dropColumn('leyendanofacturar',255) ;
                $table->dropColumn('skuproveedor',50) ;
                $table->dropColumn('skuproveedor2',50) ;
                $table->dropColumn('posicionaracelaria',50) ;
                $table->dropColumn('vigenteenlista',1) ;
                ...
                $table->dropColumn('abc',1) ;
                $table->dropColumn('punto',10) ;
                $table->dropColumn('lote',10) ;
                $table->dropColumn('coeficientelitro') ;
                $table->dropColumn('estadobloqueo_id') ;
                $table->dropColumn('estuche',50) ;
                $table->dropColumn('skuetiqueta',50) ;
                $table->dropColumn('skulistaprecio',50) ;
                $table->dropColumn('clase',1) ;
                $table->dropColumn('fechaprimeraventa') ;
                $table->dropColumn('fechaprimeringreso') ;
                $table->dropColumn('estadofacturacion');
            });
    }
};
