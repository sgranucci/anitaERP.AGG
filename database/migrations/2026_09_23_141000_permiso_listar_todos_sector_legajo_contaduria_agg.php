...
/**
 * AGG: Contaduría ve OC de todos los sectores (egalarza y resto no tienen sector_legajocompra_id;
 * sin este permiso el index queda vacío por 1=0). Mismo criterio que Control de Gestión.
 */
