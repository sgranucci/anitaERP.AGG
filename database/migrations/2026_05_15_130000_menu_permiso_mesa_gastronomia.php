...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $slugs = [
            ['nombre' => 'Listar mesas gastronomía', 'slug' => 'listar-mesa-gastronomia'],
            ['nombre' => 'Ingresar mesas gastronomía', 'slug' => 'crear-mesa-gastronomia'],
            ['nombre' => 'Editar mesas gastronomía', 'slug' => 'editar-mesa-gastronomia'],
            ['nombre' => 'Actualizar mesas gastronomía', 'slug' => 'actualizar-mesa-gastronomia'],
            ['nombre' => 'Borrar mesas gastronomía', 'slug' => 'borrar-mesa-gastronomia'],
        ];
    ...
    {
        $slugs = [
            'listar-mesa-gastronomia',
            'crear-mesa-gastronomia',
            'editar-mesa-gastronomia',
            'actualizar-mesa-gastronomia',
            'borrar-mesa-gastronomia',
        ];
