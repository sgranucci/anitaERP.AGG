...
{
    private const MENU = [
        'url' => 'compras/requisicion-reporte',
        'nombre' => 'Informe de requisiciones',
        'icono' => 'fa-file-alt',
        'permisos' => [
            ['slug' => 'listar-reporte-requisicion-compras', 'nombre' => 'Listar informe de requisiciones de compra'],
        ],
    ];
    ...
    public function up(): void
    {
        ...
        $refMenuId = (int) (DB::table('menu')->where('url', 'compras/requisicion')->value('id') ?? 0);
    ...
    /** @param list<array{slug: string, nombre: string}> $permisos @return list<int> */
