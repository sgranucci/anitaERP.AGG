...
return new class extends Migration
{
    ...
    private const MENU_URL = 'caja/estacionamiento/habilitacion-turno';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Habilitación de turno', $padreId, $orden, 'fa-key');

        $slugs = [
            ['nombre' => 'Gestionar habilitación de turno estacionamiento', 'slug' => 'gestionar-habilitacion-turno-estacionamiento'],
            ['nombre' => 'Habilitar turno estacionamiento', 'slug' => 'habilitar-turno-estacionamiento'],
            ['nombre' => 'Cierre parcial turno estacionamiento', 'slug' => 'cierre-parcial-turno-estacionamiento'],
            ['nombre' => 'Cerrar turno operativo estacionamiento', 'slug' => 'cerrar-turno-operativo-estacionamiento'],
            ['nombre' => 'Anular cierre turno estacionamiento', 'slug' => 'anular-cierre-turno-estacionamiento'],
            ['nombre' => 'Modificar monto habilitación turno estacionamiento', 'slug' => 'modificar-monto-habilitacion-turno-estacionamiento'],
        ];
    ...
    {
        $slugs = [
            'gestionar-habilitacion-turno-estacionamiento',
            'habilitar-turno-estacionamiento',
            'cierre-parcial-turno-estacionamiento',
            'cerrar-turno-operativo-estacionamiento',
            'anular-cierre-turno-estacionamiento',
            'modificar-monto-habilitacion-turno-estacionamiento',
        ];
