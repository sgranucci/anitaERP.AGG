...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/concepto';

    private const HIJO_NOMBRE = 'Conceptos de liquidación';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar concepto sueldos', 'slug' => 'listar-concepto-sueldos'],
        ['nombre' => 'Crear concepto sueldos', 'slug' => 'crear-concepto-sueldos'],
        ['nombre' => 'Editar concepto sueldos', 'slug' => 'editar-concepto-sueldos'],
        ['nombre' => 'Actualizar concepto sueldos', 'slug' => 'actualizar-concepto-sueldos'],
        ['nombre' => 'Borrar concepto sueldos', 'slug' => 'borrar-concepto-sueldos'],
    ];
