...
return new class extends Migration
{
    ...
    private const MENU_URL = 'contable/cierre-rendiciones-bingo';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS_TODOS_CONTADURIA = [
        ['nombre' => 'Listar cierre rendiciones bingo', 'slug' => 'listar-cierre-rendicion-bingo-contable'],
        ['nombre' => 'Ejecutar cierre contable rendición bingo', 'slug' => 'ejecutar-cierre-rendicion-bingo-contable'],
        ['nombre' => 'Exportar cierre rendiciones bingo', 'slug' => 'exportar-cierre-rendicion-bingo-contable'],
    ];

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS_SOLO_ENCARGADO = [
        ['nombre' => 'Anular cierre contable rendición bingo', 'slug' => 'anular-cierre-rendicion-bingo-contable'],
    ];
