...
return new class extends Migration
{
    ...
    private const MENU_PADRE_NOMBRE = 'Módulo Ventas';

    private const PERMISO_SLUG = 'listar-iva-ventas';

    private const PERMISO_NOMBRE = 'Listar reporte IVA ventas';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'IVA ventas', $padreId, $orden, 'fa-file-invoice');
