...
return new class extends Migration
{
    ...
    private const MENU_URL = 'caja/estacionamiento/item';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Ítems', $padreId, $orden, 'fa-list');

        $slugs = [
            ['nombre' => 'Listar ítems estacionamiento', 'slug' => 'listar-estacionamiento-item'],
            ['nombre' => 'Ingresar ítems estacionamiento', 'slug' => 'crear-estacionamiento-item'],
            ['nombre' => 'Editar ítems estacionamiento', 'slug' => 'editar-estacionamiento-item'],
            ['nombre' => 'Actualizar ítems estacionamiento', 'slug' => 'actualizar-estacionamiento-item'],
            ['nombre' => 'Borrar ítems estacionamiento', 'slug' => 'borrar-estacionamiento-item'],
        ];
    ...
    {
        $slugs = [
            'listar-estacionamiento-item',
            'crear-estacionamiento-item',
            'editar-estacionamiento-item',
            'actualizar-estacionamiento-item',
            'borrar-estacionamiento-item',
        ];
