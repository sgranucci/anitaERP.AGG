...
/**
 * Tablero de seguimiento del circuito de aprobación de requisiciones.
 * Asignado al rol Encargado de compras (Enc-compras).
 */
return new class extends Migration
{
    ...
    private const PERMISO = [
        'nombre' => 'Tablero seguimiento aprobación requisiciones',
