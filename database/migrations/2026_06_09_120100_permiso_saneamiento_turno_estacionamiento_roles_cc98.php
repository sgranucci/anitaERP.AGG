...
/**
 * Asigna menú y permisos de saneamiento estacionamiento a roles del CC 98 (Tesorería).
 */
return new class extends Migration
{
    ...
    private const SLUGS = [
        'gestionar-saneamiento-turno-estacionamiento',
        'ejecutar-saneamiento-turno-estacionamiento',
    ];
