...
/**
 * Menú + permisos: Importar remitos Anita (REM R 1).
 * Solo EL BIERZO. Bajo menú Administrador; rol administrador.
 */
return new class extends Migration
{
    private const MENU_URL = 'ventas/importar-remito-anita';

    private const MENU_NOMBRE = 'Importar remitos Anita';

    private const ROL_ADMINISTRADOR = 'administrador';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar importar remitos Anita', 'slug' => 'listar-importar-remito-anita'],
        ['nombre' => 'Ejecutar importar remitos Anita', 'slug' => 'ejecutar-importar-remito-anita'],
    ];
