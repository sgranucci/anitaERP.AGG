...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/fallocaja';

    private const HIJO_NOMBRE = 'Fallos de caja';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar fallos de caja sueldos', 'slug' => 'listar-fallocaja-sueldos'],
        ['nombre' => 'Crear fallo de caja sueldos', 'slug' => 'crear-fallocaja-sueldos'],
        ['nombre' => 'Editar fallo de caja sueldos', 'slug' => 'editar-fallocaja-sueldos'],
        ['nombre' => 'Actualizar fallo de caja sueldos', 'slug' => 'actualizar-fallocaja-sueldos'],
        ['nombre' => 'Borrar fallo de caja sueldos', 'slug' => 'borrar-fallocaja-sueldos'],
    ];
     ...
     * ('enc-Capital Humano', 'op-Capital Humano', 'ger-capitalhumano', 'opcont-capitalhumano').
     *
     * @return list<int>
     */
