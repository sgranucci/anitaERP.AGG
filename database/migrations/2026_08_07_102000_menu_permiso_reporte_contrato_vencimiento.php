...
/**
 * Menú y permiso del reporte de contratos / OC abiertas por vencer
 * (compras/contrato-vencimiento-reporte).
 */
return new class extends Migration
{
    private const MENU = [
        'url' => 'compras/contrato-vencimiento-reporte',
        'nombre' => 'Contratos y OC abiertas por vencer',
        'icono' => 'fa-calendar-times',
        'slug' => 'listar-reporte-contrato-vencimiento',
        'permiso_nombre' => 'Listar contratos y OC abiertas por vencer',
        'orden' => 4,
    ];
