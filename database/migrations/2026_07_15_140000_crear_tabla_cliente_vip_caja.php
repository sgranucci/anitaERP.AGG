...
return new class extends Migration
{
    ...
    {
        Schema::create('cliente_vip_caja', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('empresa_id');
            $table->integer('numeroid')->comment('inumeroid Anita (base_admin.clivip)');
            ...
            $table->unique(['empresa_id', 'numeroid'], 'cliente_vip_caja_empresa_numeroid_unique');
            $table->index(['empresa_id', 'apellido', 'numeroid'], 'cliente_vip_caja_apellido_idx');
            $table->index(['empresa_id', 'nrodocumento'], 'cliente_vip_caja_documento_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('cliente_vip_caja');
    }
};
