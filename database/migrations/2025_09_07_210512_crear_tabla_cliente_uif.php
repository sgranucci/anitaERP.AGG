...
class CrearTablaClienteUif extends Migration
{
    ...
    public function up()
    {
        Schema::create('cliente_uif', function (Blueprint $table) {
            ...
            $table->date('fechainformenosis')->nullable();
            ...
            $table->string('cumplenormativaso',1)->nullable();
            $table->string('actividadso',255)->nullable();
            $table->string('firmodeclaracionjurada',1);
            ...
            $table->string('fotodocumento',255);
            $table->unsignedBigInteger('usuario_id');
            $table->foreign('usuario_id', 'fk_cliente_uif_usuario')->references('id')->on('usuario')->onDelete('restrict')->onUpdate('restrict');
            $table->softDeletes();
            $table->timestamps();
