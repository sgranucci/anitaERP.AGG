...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/art';

    private const HIJO_NOMBRE = 'ART';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar art sueldos', 'slug' => 'listar-art-sueldos'],
        ['nombre' => 'Crear art sueldos', 'slug' => 'crear-art-sueldos'],
        ['nombre' => 'Editar art sueldos', 'slug' => 'editar-art-sueldos'],
        ['nombre' => 'Actualizar art sueldos', 'slug' => 'actualizar-art-sueldos'],
        ['nombre' => 'Borrar art sueldos', 'slug' => 'borrar-art-sueldos'],
    ];
