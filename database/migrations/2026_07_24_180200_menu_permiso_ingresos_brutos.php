...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $permisosProceso = [
            ['Listar Ingresos Brutos', 'listar-ingresos-brutos'],
            ['Exportar Ingresos Brutos', 'exportar-ingresos-brutos'],
        ];
        $permisosConfig = [
            ['Listar configuración IIBB', 'listar-ingresos-brutos-config'],
            ['Crear configuración IIBB', 'crear-ingresos-brutos-config'],
            ['Editar configuración IIBB', 'editar-ingresos-brutos-config'],
            ['Actualizar configuración IIBB', 'actualizar-ingresos-brutos-config'],
            ['Eliminar configuración IIBB', 'eliminar-ingresos-brutos-config'],
        ];
    ...
    {
        $slugs = [
            'listar-ingresos-brutos', 'exportar-ingresos-brutos',
            'listar-ingresos-brutos-config', 'crear-ingresos-brutos-config',
            'editar-ingresos-brutos-config', 'actualizar-ingresos-brutos-config',
            'eliminar-ingresos-brutos-config',
        ];
        ...
        $menuIds = DB::table('menu')
            ->whereIn('url', ['contable/ingresos-brutos', 'contable/ingresos-brutos-config'])
            ->pluck('id');
