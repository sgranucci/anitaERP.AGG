...
/**
 * Cuenta contable del ABM cliente: editable solo con este permiso.
 * Sin permiso se precarga / conserva la cuenta default (config cliente.DEUDORES_POR_VENTAS).
 */
return new class extends Migration
{
    private const MENU_URL = 'ventas/cliente';

    private const PERMISO_SLUG = 'modificar-cuenta-contable-cliente';

    private const PERMISO_NOMBRE = 'Modificar cuenta contable del cliente';

    /** @var list<string> */
    private const ROLES = ['administrador', 'Enc-admin', 'Enc-contaduría'];
