...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/saldo-vacaciones';

    private const HIJO_NOMBRE = 'Saldos de vacaciones';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar saldo vacaciones sueldos', 'slug' => 'listar-saldo-vacaciones-sueldos'],
    ];
    ...
    public function up(): void
    {
        ...
        if ($submenuId === 0) {
            ...
            $submenuId = (int) DB::table('menu')->insertGetId([
                ...
                'orden' => $ordenSubmenu, 'icono' => 'fa-chart-bar', 'created_at' => now(), 'updated_at' => now(),
            ]);
        }
