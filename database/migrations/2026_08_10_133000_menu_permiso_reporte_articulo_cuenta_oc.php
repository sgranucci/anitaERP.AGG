...
/**
 * Menú y permiso del reporte de cuentas contables de artículos vs OC Anita
 * (compras/articulo-cuenta-oc-reporte).
 */
return new class extends Migration
{
    private const MENU = [
        'url' => 'compras/articulo-cuenta-oc-reporte',
        'nombre' => 'Cuentas contables vs OC (Anita)',
        'icono' => 'fa-balance-scale',
        'slug' => 'listar-reporte-articulo-cuenta-oc',
        'permiso_nombre' => 'Listar cuentas contables vs OC Anita',
        'orden' => 5,
    ];
