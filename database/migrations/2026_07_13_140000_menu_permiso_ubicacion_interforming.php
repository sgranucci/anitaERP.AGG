...
/**
 * Menú + permisos ABM ubicaciones de stock (INTERFORMING) bajo Tablas de stock.
 */
return new class extends Migration
{
    private const MENU = [
        ...
        'icono' => 'fa-map-marker',
        'permisos' => [
            ['slug' => 'listar-ubicaciones', 'nombre' => 'Listar ubicaciones'],
            ['slug' => 'crear-ubicaciones', 'nombre' => 'Crear ubicaciones'],
            ['slug' => 'editar-ubicaciones', 'nombre' => 'Editar ubicaciones'],
            ['slug' => 'actualizar-ubicaciones', 'nombre' => 'Actualizar ubicaciones'],
            ['slug' => 'borrar-ubicaciones', 'nombre' => 'Borrar ubicaciones'],
        ],
    ];
    ...
    public function up(): void
    {
        ...
        $orden = (int) (DB::table('menu')->where('menu_id', $tablasStockId)->max('orden') ?? 0) + 1;
        $def = self::MENU;
