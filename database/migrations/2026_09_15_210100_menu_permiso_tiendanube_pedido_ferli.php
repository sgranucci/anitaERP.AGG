...
/**
 * Menú Facturación Tiendanube — solo Calzados Ferli.
 * Bajo Facturación Local (#facturacion-local).
 */
return new class extends Migration
{
    private const PADRE_URL = '#facturacion-local';

    private const URL = 'ventas/tiendanube-pedidos';

    /** @var list<array{slug:string,nombre:string}> */
    private const PERMISOS = [
        ['slug' => 'listar-tiendanube-pedidos', 'nombre' => 'Listar pedidos Tiendanube'],
        ['slug' => 'sincronizar-tiendanube-pedidos', 'nombre' => 'Sincronizar pedidos Tiendanube'],
        ['slug' => 'facturar-tiendanube-pedidos', 'nombre' => 'Facturar pedidos Tiendanube'],
    ];
