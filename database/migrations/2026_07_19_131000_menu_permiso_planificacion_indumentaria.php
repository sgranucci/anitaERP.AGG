...
/**
 * Menú/permiso para el reporte de Planificación / compra sugerida de indumentaria,
 * dentro del submenú "Indumentaria" del módulo Sueldos.
 */
return new class extends Migration
{
    ...
    private const URL = 'sueldos/indumentaria/planificacion';

    private const NOMBRE = 'Planificación de compra';

    /** @var list<array{nombre:string, slug:string}> */
    private const PERMISOS = [
        ['nombre' => 'Ver planificación de indumentaria', 'slug' => 'ver-planificacion-indumentaria'],
    ];
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenuHijo(self::URL, self::NOMBRE, $submenuId, $orden, 'fa-clipboard-list');
