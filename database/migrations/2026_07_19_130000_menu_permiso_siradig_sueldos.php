...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/siradig';

    private const HIJO_NOMBRE = 'SiRADIG (F572 Ganancias)';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar SiRADIG sueldos', 'slug' => 'listar-siradig-sueldos'],
        ['nombre' => 'Importar SiRADIG sueldos', 'slug' => 'importar-siradig-sueldos'],
        ['nombre' => 'Ver SiRADIG sueldos', 'slug' => 'ver-siradig-sueldos'],
        ['nombre' => 'Borrar SiRADIG sueldos', 'slug' => 'borrar-siradig-sueldos'],
    ];
