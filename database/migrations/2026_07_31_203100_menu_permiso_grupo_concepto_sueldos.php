...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/grupo-concepto';

    private const HIJO_NOMBRE = 'Grupos de conceptos';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar grupo concepto sueldos', 'slug' => 'listar-grupo-concepto-sueldos'],
        ['nombre' => 'Crear grupo concepto sueldos', 'slug' => 'crear-grupo-concepto-sueldos'],
        ['nombre' => 'Editar grupo concepto sueldos', 'slug' => 'editar-grupo-concepto-sueldos'],
        ['nombre' => 'Actualizar grupo concepto sueldos', 'slug' => 'actualizar-grupo-concepto-sueldos'],
        ['nombre' => 'Borrar grupo concepto sueldos', 'slug' => 'borrar-grupo-concepto-sueldos'],
    ];
