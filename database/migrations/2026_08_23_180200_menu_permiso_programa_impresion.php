...
{
    private const MENU_URL = 'ventas/programa-impresion';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar programas de impresión', 'slug' => 'listar-programa-impresion'],
        ['nombre' => 'Crear programa de impresión', 'slug' => 'crear-programa-impresion'],
        ['nombre' => 'Editar programa de impresión', 'slug' => 'editar-programa-impresion'],
        ['nombre' => 'Actualizar programa de impresión', 'slug' => 'actualizar-programa-impresion'],
        ['nombre' => 'Borrar programa de impresión', 'slug' => 'borrar-programa-impresion'],
    ];
