...
return new class extends Migration
{
    ...
    private const PERMISO_SLUG = 'modificar-exclusion-percepcion-iva-cliente';

    private const PERMISO_NOMBRE = 'Modificar fechas exclusión percepción IVA en clientes';
