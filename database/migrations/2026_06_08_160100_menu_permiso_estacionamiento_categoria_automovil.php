...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Categorías', $padreId, $orden, 'fa-car');

        $slugs = [
            ['nombre' => 'Listar categorías automóvil estacionamiento', 'slug' => 'listar-estacionamiento-categoria-automovil'],
            ['nombre' => 'Ingresar categorías automóvil estacionamiento', 'slug' => 'crear-estacionamiento-categoria-automovil'],
            ['nombre' => 'Editar categorías automóvil estacionamiento', 'slug' => 'editar-estacionamiento-categoria-automovil'],
            ['nombre' => 'Actualizar categorías automóvil estacionamiento', 'slug' => 'actualizar-estacionamiento-categoria-automovil'],
            ['nombre' => 'Borrar categorías automóvil estacionamiento', 'slug' => 'borrar-estacionamiento-categoria-automovil'],
        ];
    ...
    {
        $slugs = [
            'listar-estacionamiento-categoria-automovil',
            'crear-estacionamiento-categoria-automovil',
            'editar-estacionamiento-categoria-automovil',
            'actualizar-estacionamiento-categoria-automovil',
            'borrar-estacionamiento-categoria-automovil',
        ];
