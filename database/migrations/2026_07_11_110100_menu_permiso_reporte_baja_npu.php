...
return new class extends Migration
{
    ...
    private const MENU_URL = 'stock/reporte-baja-npu';

    private const PERMISO_SLUG = 'listar-reporte-baja-npu';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Consulta NPU (bajas)', $reportesPadreId, $orden, 'fa-barcode');
        $permisoId = $this->upsertPermiso('Listar reporte baja NPU', self::PERMISO_SLUG, $menuId);

        foreach ($this->rolesStock() as $rolId) {
    ...
    private function rolesStock(): array
    {
        $slugs = [
            ...
            'listar-reporte-existencias-deposito',
