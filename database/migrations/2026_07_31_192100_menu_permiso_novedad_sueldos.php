...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/novedad';

    private const HIJO_NOMBRE = 'Novedades de liquidación';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar novedad sueldos', 'slug' => 'listar-novedad-sueldos'],
        ['nombre' => 'Crear novedad sueldos', 'slug' => 'crear-novedad-sueldos'],
        ['nombre' => 'Editar novedad sueldos', 'slug' => 'editar-novedad-sueldos'],
        ['nombre' => 'Actualizar novedad sueldos', 'slug' => 'actualizar-novedad-sueldos'],
        ['nombre' => 'Borrar novedad sueldos', 'slug' => 'borrar-novedad-sueldos'],
    ];
