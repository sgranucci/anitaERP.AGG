...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/agrupamiento';

    private const HIJO_NOMBRE = 'Agrupamientos';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar agrupamiento sueldos', 'slug' => 'listar-agrupamiento-sueldos'],
        ['nombre' => 'Crear agrupamiento sueldos', 'slug' => 'crear-agrupamiento-sueldos'],
        ['nombre' => 'Editar agrupamiento sueldos', 'slug' => 'editar-agrupamiento-sueldos'],
        ['nombre' => 'Actualizar agrupamiento sueldos', 'slug' => 'actualizar-agrupamiento-sueldos'],
        ['nombre' => 'Borrar agrupamiento sueldos', 'slug' => 'borrar-agrupamiento-sueldos'],
    ];
