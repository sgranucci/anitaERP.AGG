...
/**
 * Extiende permisos Importar pedidos Anita a roles operativos de pedidos (El Bierzo).
 * Hasta ahora solo administrador; usuarios finales (Despacho, Vendedor, etc.) lo usan
 * desde el botón del index de pedidos.
 */
return new class extends Migration
{
    ...
    /** Roles con crear-pedidos / listar-pedidos operativos en El Bierzo. */
    private const ROLES = [
        'administrador',
        'Despacho',
        'Vendedor',
    ...
    public function up(): void
    {
        ...
        $menuId = (int) (DB::table('menu')->where('url', 'ventas/importar-pedido-anita')->value('id') ?? 0);
