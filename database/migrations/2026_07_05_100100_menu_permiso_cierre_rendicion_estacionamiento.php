...
return new class extends Migration
{
    ...
    private const MENU_URL = 'contable/cierre-rendiciones-estacionamiento';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS_TODOS_CONTADURIA = [
        ['nombre' => 'Listar cierre rendiciones estacionamiento', 'slug' => 'listar-cierre-rendicion-estacionamiento-contable'],
        ['nombre' => 'Ejecutar cierre contable rendición estacionamiento', 'slug' => 'ejecutar-cierre-rendicion-estacionamiento-contable'],
        ['nombre' => 'Exportar cierre rendiciones estacionamiento', 'slug' => 'exportar-cierre-rendicion-estacionamiento-contable'],
    ];

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS_SOLO_ENCARGADO = [
        ['nombre' => 'Anular cierre contable rendición estacionamiento', 'slug' => 'anular-cierre-rendicion-estacionamiento-contable'],
    ];
