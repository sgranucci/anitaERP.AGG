...
{
    private const MENU_URL = 'caja/waitry-cierre-jornada';

    private const MENU_PADRE_RENDICIONES_URL = '#';

    private const MENU_REF_ROLES_URL = 'caja/rendiciongastronomia';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Cierre jornada Waitry', $padreId, $orden, 'fa-balance-scale');

        $slugs = [
            ['nombre' => 'Listar cierre jornada Waitry caja', 'slug' => 'listar-waitry-cierre-jornada-caja'],
        ];
    ...
    {
        $slugs = ['listar-waitry-cierre-jornada-caja'];
