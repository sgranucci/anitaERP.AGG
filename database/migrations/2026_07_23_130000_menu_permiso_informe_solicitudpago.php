...
return new class extends Migration
{
    ...
    private const MENU_URL = 'solicitudpago/informe-solicitudpago';

    private const MENU_NOMBRE = 'Informe solicitudes de pago';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar informe solicitud de pago', 'slug' => 'listar-informe-solicitudpago'],
    ];
