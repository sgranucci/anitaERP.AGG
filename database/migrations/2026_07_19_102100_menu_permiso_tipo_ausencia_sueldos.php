...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/tipo-ausencia';

    private const HIJO_NOMBRE = 'Tipos de ausencia';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar tipo ausencia sueldos', 'slug' => 'listar-tipo-ausencia-sueldos'],
        ['nombre' => 'Crear tipo ausencia sueldos', 'slug' => 'crear-tipo-ausencia-sueldos'],
        ['nombre' => 'Editar tipo ausencia sueldos', 'slug' => 'editar-tipo-ausencia-sueldos'],
        ['nombre' => 'Actualizar tipo ausencia sueldos', 'slug' => 'actualizar-tipo-ausencia-sueldos'],
        ['nombre' => 'Borrar tipo ausencia sueldos', 'slug' => 'borrar-tipo-ausencia-sueldos'],
    ];
