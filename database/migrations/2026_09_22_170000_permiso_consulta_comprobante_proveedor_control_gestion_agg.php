...
/**
 * AGG: Control de Gestión (reirin Enc / dpicerno Op) consulta comprobantes de proveedor
 * de toda la empresa, mismo criterio que órdenes de compra: listar + editar (sin alta/escritura).
 */
