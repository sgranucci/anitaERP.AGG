...
{
    private const MENU_URL = 'ventas/distribuidor';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar distribuidores', 'slug' => 'listar-distribuidor'],
        ['nombre' => 'Crear distribuidor', 'slug' => 'crear-distribuidor'],
        ['nombre' => 'Editar distribuidor', 'slug' => 'editar-distribuidor'],
        ['nombre' => 'Actualizar distribuidor', 'slug' => 'actualizar-distribuidor'],
        ['nombre' => 'Borrar distribuidor', 'slug' => 'borrar-distribuidor'],
    ];
