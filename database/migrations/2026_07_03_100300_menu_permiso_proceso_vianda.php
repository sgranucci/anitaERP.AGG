...
{
    private const MENU_URL = 'ventas/gastronomia/viandas/proceso';
    ...
    public function up(): void
    {
        ...
        // El proceso va primero en el submenú Viandas.
        $orden = 0;
        ...
        $slugs = [
            ['nombre' => 'Usar proceso de viandas', 'slug' => 'usar-proceso-vianda-gastronomia'],
        ];
    ...
    {
        $permisoIds = DB::table('permiso')->where('slug', 'usar-proceso-vianda-gastronomia')->pluck('id')->all();
