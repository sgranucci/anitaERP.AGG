...
{
    private const MENU_URL = 'configuracion/uso-salida-impresora';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar usos de salida de impresión', 'slug' => 'listar-uso-salida-impresora'],
        ['nombre' => 'Crear usos de salida de impresión', 'slug' => 'crear-uso-salida-impresora'],
        ['nombre' => 'Editar usos de salida de impresión', 'slug' => 'editar-uso-salida-impresora'],
        ['nombre' => 'Actualizar usos de salida de impresión', 'slug' => 'actualizar-uso-salida-impresora'],
        ['nombre' => 'Borrar usos de salida de impresión', 'slug' => 'borrar-uso-salida-impresora'],
    ];
