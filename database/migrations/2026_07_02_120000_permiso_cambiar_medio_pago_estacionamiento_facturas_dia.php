...
return new class extends Migration
{
    ...
    private const SLUG = 'cambiar-medio-pago-estacionamiento-facturas-dia';

    private const SLUG_REF_NOTA_CREDITO = 'generar-nota-credito-estacionamiento-facturas-dia';
    ...
    public function up(): void
    {
        ...
        if ($permisoId === 0) {
            $permisoId = (int) DB::table('permiso')->insertGetId([
                'nombre' => 'Cambiar medio de pago (facturas del día estacionamiento)',
                'slug' => self::SLUG,
                'menu_id' => $menuId,
                'created_at' => now(),
                'updated_at' => now(),
