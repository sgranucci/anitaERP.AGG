...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/vacacion';

    private const HIJO_NOMBRE = 'Vacaciones';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar vacación sueldos', 'slug' => 'listar-vacacion-sueldos'],
        ['nombre' => 'Crear vacación sueldos', 'slug' => 'crear-vacacion-sueldos'],
        ['nombre' => 'Editar vacación sueldos', 'slug' => 'editar-vacacion-sueldos'],
        ['nombre' => 'Actualizar vacación sueldos', 'slug' => 'actualizar-vacacion-sueldos'],
        ['nombre' => 'Borrar vacación sueldos', 'slug' => 'borrar-vacacion-sueldos'],
    ];
