...
{
    private const MENU_URL = 'ventas/camion';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar camiones', 'slug' => 'listar-camion'],
        ['nombre' => 'Crear camion', 'slug' => 'crear-camion'],
        ['nombre' => 'Editar camion', 'slug' => 'editar-camion'],
        ['nombre' => 'Actualizar camion', 'slug' => 'actualizar-camion'],
        ['nombre' => 'Borrar camion', 'slug' => 'borrar-camion'],
    ];
