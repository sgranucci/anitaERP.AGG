...
/**
 * Permisos para ver/importar recibos de nómina confidencial en corridas.
 */
return new class extends Migration
{
    /** @var list<array{nombre:string,slug:string}> */
    private const PERMISOS = [
        ['nombre' => 'Ver recibos confidenciales de liquidación', 'slug' => 'ver-confidencial-recibo-sueldos'],
        ['nombre' => 'Importar nómina confidencial a liquidación', 'slug' => 'importar-liquidacion-confidencial-sueldos'],
    ];
