...
{
    private const MENU_USUARIOS_URL = 'ventas/gastronomia/viandas/usuarios';
    ...
    public function up(): void
    {
        ...
        $menuId = (int) (DB::table('menu')->where('url', self::MENU_USUARIOS_URL)->value('id') ?? 0);

        if ($menuId === 0) {
            $menuId = (int) DB::table('menu')->insertGetId([
                'menu_id' => $viandasMenuId,
                'nombre' => 'Usuarios',
                'url' => self::MENU_USUARIOS_URL,
                'orden' => $orden,
                'icono' => 'fa-users',
                'created_at' => now(),
                'updated_at' => now(),
        ...
        $slugs = [
            ['nombre' => 'Listar usuarios vianda gastronomía', 'slug' => 'listar-vianda-usuario-gastronomia'],
            ['nombre' => 'Ingresar usuarios vianda gastronomía', 'slug' => 'crear-vianda-usuario-gastronomia'],
            ['nombre' => 'Editar usuarios vianda gastronomía', 'slug' => 'editar-vianda-usuario-gastronomia'],
            ['nombre' => 'Actualizar usuarios vianda gastronomía', 'slug' => 'actualizar-vianda-usuario-gastronomia'],
            ['nombre' => 'Borrar usuarios vianda gastronomía', 'slug' => 'borrar-vianda-usuario-gastronomia'],
            ['nombre' => 'Sincronizar usuarios vianda desde Anita', 'slug' => 'sincronizar-vianda-usuario-gastronomia-anita'],
        ];
    ...
    {
        $slugs = [
            'listar-vianda-usuario-gastronomia',
            'crear-vianda-usuario-gastronomia',
            'editar-vianda-usuario-gastronomia',
            'actualizar-vianda-usuario-gastronomia',
            'borrar-vianda-usuario-gastronomia',
            'sincronizar-vianda-usuario-gastronomia-anita',
        ];
        ...
        $menuId = DB::table('menu')->where('url', self::MENU_USUARIOS_URL)->value('id');
        if ($menuId) {
