...
{
    private const MENU_URL = 'contable/mayor-plano-cuenta';

    private const MENU_PADRE_NOMBRE = 'Módulo Contable';

    private const PERMISO_SLUG = 'listar-mayor-plano-cuenta';

    private const PERMISO_NOMBRE = 'Listar mayor plano por cuenta contable';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Mayor plano por cuenta', $padreId, $orden, 'fa-book');
