...
return new class extends Migration
{
    ...
    private const MENU_URL = 'solicitudpago/concepto_solicitudpago';

    private const MENU_NOMBRE = 'Conceptos';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar concepto solicitud de pago', 'slug' => 'listar-concepto-solicitud-pago'],
        ['nombre' => 'Crear concepto solicitud de pago', 'slug' => 'crear-concepto-solicitud-pago'],
        ['nombre' => 'Editar concepto solicitud de pago', 'slug' => 'editar-concepto-solicitud-pago'],
        ['nombre' => 'Actualizar concepto solicitud de pago', 'slug' => 'actualizar-concepto-solicitud-pago'],
        ['nombre' => 'Borrar concepto solicitud de pago', 'slug' => 'borrar-concepto-solicitud-pago'],
    ];
