...
/**
 * Menú y permiso del panel de gobernanza IA (configuracion/ai-decisiones).
 */
return new class extends Migration
{
    private const MENU_URL = 'configuracion/ai-decisiones';

    private const PERMISO_SLUG = 'listar-ai-decisiones';

    private const PERMISO_NOMBRE = 'Listar gobernanza IA (decisiones)';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Gobernanza IA', $padreId, $orden, 'fa-magic');
