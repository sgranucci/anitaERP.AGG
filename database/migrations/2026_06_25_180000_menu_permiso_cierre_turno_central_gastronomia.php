...
{
    private const MENU_URL = 'ventas/gastronomia/cierre-turno-central';
    ...
    public function up(): void
    {
        ...
        if ($menuId === 0) {
            $menuId = (int) DB::table('menu')->insertGetId([
                ...
                'nombre' => 'Cierre centralizado turnos',
                'url' => self::MENU_URL,
                'orden' => $orden,
                'icono' => 'fa-desktop',
                'created_at' => now(),
        ...
        $permisos = [
            ...
            [
                'nombre' => 'Cerrar turno centralizado gastronomía',
                'slug' => 'cerrar-turno-central-gastronomia',
            ],
        ];
    ...
    {
        $slugs = [
            'gestionar-cierre-turno-central-gastronomia',
            'cerrar-turno-central-gastronomia',
        ];
