...
{
    private const MENU_URL = 'ventas/categoria-fidelidad-gastronomia';
    ...
    public function up(): void
    {
        ...
        $refMenuId = (int) (DB::table('menu')->where('url', 'ventas/turno-gastronomia')->value('id') ?? $parentMenuId);
        ...
        $slugs = [
            ['nombre' => 'Listar categorías fidelidad gastronomía', 'slug' => 'listar-categoria-fidelidad-gastronomia'],
            ['nombre' => 'Ingresar categorías fidelidad gastronomía', 'slug' => 'crear-categoria-fidelidad-gastronomia'],
            ['nombre' => 'Editar categorías fidelidad gastronomía', 'slug' => 'editar-categoria-fidelidad-gastronomia'],
            ['nombre' => 'Actualizar categorías fidelidad gastronomía', 'slug' => 'actualizar-categoria-fidelidad-gastronomia'],
            ['nombre' => 'Borrar categorías fidelidad gastronomía', 'slug' => 'borrar-categoria-fidelidad-gastronomia'],
        ];
    ...
    {
        $slugs = [
            'listar-categoria-fidelidad-gastronomia',
            'crear-categoria-fidelidad-gastronomia',
            'editar-categoria-fidelidad-gastronomia',
            'actualizar-categoria-fidelidad-gastronomia',
            'borrar-categoria-fidelidad-gastronomia',
        ];
