...
return new class extends Migration
{
    ...
    private const MENU_SUBMENU = 'Personal';

    private const HIJO_URL = 'sueldos/empleado';

    private const HIJO_NOMBRE = 'Empleados';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar empleado sueldos', 'slug' => 'listar-empleado-sueldos'],
        ['nombre' => 'Crear empleado sueldos', 'slug' => 'crear-empleado-sueldos'],
        ['nombre' => 'Editar empleado sueldos', 'slug' => 'editar-empleado-sueldos'],
        ['nombre' => 'Actualizar empleado sueldos', 'slug' => 'actualizar-empleado-sueldos'],
        ['nombre' => 'Borrar empleado sueldos', 'slug' => 'borrar-empleado-sueldos'],
        ['nombre' => 'Autorizar alta empleado sueldos', 'slug' => 'autorizar-empleado-sueldos'],
        ['nombre' => 'Baja / reincorporación empleado sueldos', 'slug' => 'baja-empleado-sueldos'],
        ['nombre' => 'Borrar vigencia base empleado sueldos', 'slug' => 'borrar-vigencia-empleado-sueldos'],
    ];
    ...
    public function up(): void
    {
        ...
        if ($submenuId === 0) {
            // Personal antes que Tablas (orden 0)
            $submenuId = (int) DB::table('menu')->insertGetId([
                'nombre' => self::MENU_SUBMENU, 'url' => '#', 'menu_id' => $moduloId,
                'orden' => 0, 'icono' => 'fa-users', 'created_at' => now(), 'updated_at' => now(),
            ]);
        }
