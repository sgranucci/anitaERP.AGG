...
{
    private const MENU_URL = 'contable/apertura-periodo';

    private const PERMISO_SLUG = 'habilitar-apertura-periodo-contable';

    private const PERMISO_NOMBRE = 'Habilitar apertura de período contable (aviso y enlace)';
