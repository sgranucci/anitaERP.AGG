...
{
    private const MENU_URL = 'contable/cierre-periodo';

    private const PERMISO_SLUG = 'borrar-ultimo-cierre-periodo-contable';

    private const PERMISO_NOMBRE = 'Borrar último cierre de período contable';
