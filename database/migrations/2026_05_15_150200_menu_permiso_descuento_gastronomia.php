...
{
    private const MENU_URL = 'stock/descuento-gastronomia';
    ...
    public function up(): void
    {
        ...
        $slugs = [
            ['nombre' => 'Listar descuentos gastronomía', 'slug' => 'listar-descuento-gastronomia'],
            ['nombre' => 'Ingresar descuentos gastronomía', 'slug' => 'crear-descuento-gastronomia'],
            ['nombre' => 'Editar descuentos gastronomía', 'slug' => 'editar-descuento-gastronomia'],
            ['nombre' => 'Actualizar descuentos gastronomía', 'slug' => 'actualizar-descuento-gastronomia'],
            ['nombre' => 'Borrar descuentos gastronomía', 'slug' => 'borrar-descuento-gastronomia'],
        ];
    ...
    {
        $slugs = [
            'listar-descuento-gastronomia',
            'crear-descuento-gastronomia',
            'editar-descuento-gastronomia',
            'actualizar-descuento-gastronomia',
            'borrar-descuento-gastronomia',
        ];
