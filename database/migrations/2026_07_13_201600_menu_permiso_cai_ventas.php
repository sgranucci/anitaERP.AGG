...
{
    private const MENU_URL = 'ventas/cai';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar CAI', 'slug' => 'listar-cai'],
        ['nombre' => 'Crear CAI', 'slug' => 'crear-cai'],
        ['nombre' => 'Editar CAI', 'slug' => 'editar-cai'],
        ['nombre' => 'Actualizar CAI', 'slug' => 'actualizar-cai'],
        ['nombre' => 'Borrar CAI', 'slug' => 'borrar-cai'],
    ];
