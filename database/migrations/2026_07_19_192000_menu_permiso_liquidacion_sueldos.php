...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/liquidacion';

    private const HIJO_NOMBRE = 'Corridas de liquidación';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar liquidacion sueldos', 'slug' => 'listar-liquidacion-sueldos'],
        ['nombre' => 'Crear liquidacion sueldos', 'slug' => 'crear-liquidacion-sueldos'],
        ['nombre' => 'Editar liquidacion sueldos', 'slug' => 'editar-liquidacion-sueldos'],
        ['nombre' => 'Actualizar liquidacion sueldos', 'slug' => 'actualizar-liquidacion-sueldos'],
        ['nombre' => 'Borrar liquidacion sueldos', 'slug' => 'borrar-liquidacion-sueldos'],
        ['nombre' => 'Cerrar liquidacion sueldos', 'slug' => 'cerrar-liquidacion-sueldos'],
    ];
    ...
    public function up(): void
    {
        ...
        if ($submenuId === 0) {
            ...
            $submenuId = (int) DB::table('menu')->insertGetId([
                ...
                'orden' => $ordenSubmenu, 'icono' => 'fa-calculator', 'created_at' => now(), 'updated_at' => now(),
            ]);
        }
