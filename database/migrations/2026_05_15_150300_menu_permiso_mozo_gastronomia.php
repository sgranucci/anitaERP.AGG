...
{
    private const MENU_URL = 'stock/mozo-gastronomia';

    private const MENU_URL_REF = 'stock/descuento-gastronomia';
    ...
    public function up(): void
    {
        ...
        $slugs = [
            ['nombre' => 'Listar mozos gastronomía', 'slug' => 'listar-mozo-gastronomia'],
            ['nombre' => 'Ingresar mozos gastronomía', 'slug' => 'crear-mozo-gastronomia'],
            ['nombre' => 'Editar mozos gastronomía', 'slug' => 'editar-mozo-gastronomia'],
            ['nombre' => 'Actualizar mozos gastronomía', 'slug' => 'actualizar-mozo-gastronomia'],
            ['nombre' => 'Borrar mozos gastronomía', 'slug' => 'borrar-mozo-gastronomia'],
        ];
