...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('rendicion_estacionamiento_caja', function (Blueprint $table) {
            if (! Schema::hasColumn('rendicion_estacionamiento_caja', 'asiento_id')) {
                $table->unsignedBigInteger('asiento_id')->nullable()->after('observacion');
                $table->index('asiento_id', 'idx_rend_est_caja_asiento');
            }
            if (! Schema::hasColumn('rendicion_estacionamiento_caja', 'cierre_contable_en')) {
                $table->timestamp('cierre_contable_en')->nullable()->after('asiento_id');
            }
            if (! Schema::hasColumn('rendicion_estacionamiento_caja', 'cierre_contable_usuario_id')) {
    ...
    public function down(): void
    {
        Schema::table('rendicion_estacionamiento_caja', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('rendicion_estacionamiento_caja', 'asiento_id')) {
                $table->dropIndex('idx_rend_est_caja_asiento');
