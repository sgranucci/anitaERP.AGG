...
return new class extends Migration
{
    ...
    private const MENU_URL = 'caja/estacionamiento/cierres-turno';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Cierres de turno', $padreId, $orden, 'fa-list-alt');

        $slugs = [
            ['nombre' => 'Listar cierres de turno estacionamiento', 'slug' => 'listar-cierres-turno-estacionamiento'],
            ['nombre' => 'Ver comprobante cierre turno estacionamiento', 'slug' => 'ver-comprobante-cierre-turno-estacionamiento'],
        ];
