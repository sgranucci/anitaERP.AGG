...
return new class extends Migration
{
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar bienes de uso', 'slug' => 'listar-bien-uso'],
        ['nombre' => 'Crear bienes de uso', 'slug' => 'crear-bien-uso'],
        ['nombre' => 'Editar bienes de uso', 'slug' => 'editar-bien-uso'],
        ['nombre' => 'Actualizar bienes de uso', 'slug' => 'actualizar-bien-uso'],
        ['nombre' => 'Borrar bienes de uso', 'slug' => 'borrar-bien-uso'],
    ];
    ...
    public function up(): void
    {
        ...
        $rolesMenu = $this->resolverRolesConAcceso();
    ...
    /** @return list<int> */
    private function resolverRolesConAcceso(): array
    {
        $roles = DB::table('rol')
            ->where(function ($q) {
                $q->whereRaw('LOWER(nombre) LIKE ?', ['%contadur%'])
                    ->orWhereIn('nombre', array_merge(
                        self::ROLES_LABORATORIO,
                        self::ROLES_SISTEMAS,
                        [
                            'administrador',
                            'Enc-impuestos',
