...
return new class extends Migration
{
    ...
    private const HIJO_URL = 'sueldos/lugartrabajo';

    private const HIJO_NOMBRE = 'Lugares de trabajo';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS = [
        ['nombre' => 'Listar lugar trabajo sueldos', 'slug' => 'listar-lugartrabajo-sueldos'],
        ['nombre' => 'Crear lugar trabajo sueldos', 'slug' => 'crear-lugartrabajo-sueldos'],
        ['nombre' => 'Editar lugar trabajo sueldos', 'slug' => 'editar-lugartrabajo-sueldos'],
        ['nombre' => 'Actualizar lugar trabajo sueldos', 'slug' => 'actualizar-lugartrabajo-sueldos'],
        ['nombre' => 'Borrar lugar trabajo sueldos', 'slug' => 'borrar-lugartrabajo-sueldos'],
    ];
