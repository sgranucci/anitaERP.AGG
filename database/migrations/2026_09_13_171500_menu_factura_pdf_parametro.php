...
/**
 * ABM parámetros PDF factura:
 * - Canónica: Configuración → Configuración por módulo → Ventas
 * - Atajo en Módulo de Ventas: solo administrador
 */
return new class extends Migration
{
    private const MENU_URL = 'ventas/factura-pdf-parametro';

    private const MENU_NOMBRE = 'Parámetros PDF factura';
    ...
    private const PERMISOS = [
        ['nombre' => 'Editar parámetros PDF factura', 'slug' => 'editar-factura-pdf-parametro'],
        ['nombre' => 'Actualizar parámetros PDF factura', 'slug' => 'actualizar-factura-pdf-parametro'],
    ];
