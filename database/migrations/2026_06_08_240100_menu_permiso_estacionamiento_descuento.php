...
return new class extends Migration
{
    ...
    private const MENU_URL = 'caja/estacionamiento/descuento';
    ...
    public function up(): void
    {
        ...
        $menuId = $this->upsertMenu(self::MENU_URL, 'Descuentos', $padreId, $orden, 'fa-percent');

        $slugs = [
            ['nombre' => 'Listar descuentos estacionamiento', 'slug' => 'listar-descuento-estacionamiento'],
            ['nombre' => 'Ingresar descuentos estacionamiento', 'slug' => 'crear-descuento-estacionamiento'],
            ['nombre' => 'Editar descuentos estacionamiento', 'slug' => 'editar-descuento-estacionamiento'],
            ['nombre' => 'Actualizar descuentos estacionamiento', 'slug' => 'actualizar-descuento-estacionamiento'],
            ['nombre' => 'Borrar descuentos estacionamiento', 'slug' => 'borrar-descuento-estacionamiento'],
        ];
    ...
    {
        $slugs = [
            'listar-descuento-estacionamiento',
            'crear-descuento-estacionamiento',
            'editar-descuento-estacionamiento',
            'actualizar-descuento-estacionamiento',
            'borrar-descuento-estacionamiento',
        ];
