...
/**
 * Menú + permisos: Numerador fiscal local (tipo ARCA + PV).
 * Solo EL BIERZO. Los facturadores no lo usan todavía.
 */
return new class extends Migration
{
    private const MENU_URL = 'ventas/numerador-fiscal';

    private const MENU_NOMBRE = 'Numerador fiscal';
    ...
    private const PERMISOS = [
        ['nombre' => 'Listar numerador fiscal local', 'slug' => 'listar-venta-serie-numerador'],
        ['nombre' => 'Sembrar numerador fiscal desde ventas', 'slug' => 'sembrar-venta-serie-numerador'],
    ];
