...
return new class extends Migration
{
    ...
    private const MENU_URL = 'contable/cierre-rendiciones-maquina';

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS_TODOS_CONTADURIA = [
        ['nombre' => 'Listar cierre rendiciones máquinas', 'slug' => 'listar-cierre-rendicion-maquina-contable'],
        ['nombre' => 'Ejecutar cierre contable rendición máquinas', 'slug' => 'ejecutar-cierre-rendicion-maquina-contable'],
        ['nombre' => 'Exportar cierre rendiciones máquinas', 'slug' => 'exportar-cierre-rendicion-maquina-contable'],
    ];

    /** @var list<array{nombre: string, slug: string}> */
    private const PERMISOS_SOLO_ENCARGADO = [
        ['nombre' => 'Anular cierre contable rendición máquinas', 'slug' => 'anular-cierre-rendicion-maquina-contable'],
    ];
