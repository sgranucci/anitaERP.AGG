...
return new class extends Migration
{
    ...
    /** Encargados: pueden actualizar presentaciones de cualquier fecha. */
    ...
    public function up(): void
    {
        ...
        $permisos = [
            [
                'nombre' => 'Actualizar rendición vending caja en el día',
                'slug' => 'actualizar-rendicion-maquinavending-caja-dia',
                'roles' => self::ROLES_DIA,
            ],
            [
                'nombre' => 'Actualizar rendición vending caja sin restricción de fecha',
                'slug' => 'actualizar-rendicion-maquinavending-caja-encargado',
                'roles' => self::ROLES_SIN_RESTRICCION,
            ],
        ];
    ...
    {
        $slugs = [
            'actualizar-rendicion-maquinavending-caja-dia',
            'actualizar-rendicion-maquinavending-caja-encargado',
        ];
