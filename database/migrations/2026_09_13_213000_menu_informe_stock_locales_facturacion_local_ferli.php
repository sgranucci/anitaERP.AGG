...
/**
 * Menú Informe stock locales (Facturación Local) — solo Calzados Ferli.
 * Equivalente Anita: l-stocklocal.c.
 */
return new class extends Migration
{
    private const PADRE_URL = '#facturacion-local';

    private const URL = 'ventas/facturacion-local/informe-stock';

    private const PERMISO_SLUG = 'listar-informe-stock-local';

    private const PERMISO_NOMBRE = 'Listar informe stock locales';
