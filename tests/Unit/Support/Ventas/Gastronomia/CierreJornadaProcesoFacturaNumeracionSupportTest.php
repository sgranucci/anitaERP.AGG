...
final class CierreJornadaProcesoFacturaNumeracionSupportTest extends TestCase
{
    ...
    {
        $secuencia = new CierreJornadaProcesoFacturaNumeracionSupport(999_999, 999_999);
    ...
    {
        $secuencia = new CierreJornadaProcesoFacturaNumeracionSupport(999_998, 999_998, 183_680);
    ...
    {
        $this->assertSame(0, CierreJornadaProcesoFacturaNumeracionSupport::maxNumerocomprobanteErp(0, 1));
        $this->assertSame(0, CierreJornadaProcesoFacturaNumeracionSupport::maxNumerocomprobanteErp(1, 0));
    }
}
