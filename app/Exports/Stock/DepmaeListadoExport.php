...
class DepmaeListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(DepmaeRepositoryInterface $depmaeRepository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->depmaeRepository->leeDepmae($this->filtros, false);
            ...
            return view('exports.stock.depmaeindex', [
                'datas' => $datas,
                'tipodeposito_enum' => \App\Models\Stock\Depmae::$enumTipoDeposito,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Stock\Depmae>|\Illuminate\Database\Eloquent\Collection<int, \App\Models\Stock\Depmae>  $datas
     */
