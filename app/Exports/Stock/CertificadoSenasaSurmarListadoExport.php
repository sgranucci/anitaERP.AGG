...
class CertificadoSenasaSurmarListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.stock.certificado_senasa_surmarindex', [
            'datas' => $datas,
