...
class ClasematerialListadoExport implements FromView, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(ClasematerialRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        $datas = $this->flDesdeIndex
            ? $this->repository->leeClasematerial($this->filtros, false)
            : collect();
        ...
        return view('exports.stock.clasematerialindex', [
            'datas' => $datas,
