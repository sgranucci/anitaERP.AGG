...
class RecepcionProveedorSurmarListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.stock.recepcion_proveedor_surmarindex', [
            'datas' => $datas,
