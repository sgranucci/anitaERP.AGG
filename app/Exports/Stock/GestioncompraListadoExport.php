...
class GestioncompraListadoExport implements FromView, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(GestioncompraRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        $datas = $this->flDesdeIndex
            ? $this->repository->leeGestioncompra($this->filtros, false)
            : collect();
        ...
        return view('exports.stock.gestioncompraindex', [
            'datas' => $datas,
