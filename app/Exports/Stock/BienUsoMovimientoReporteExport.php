...
class BienUsoMovimientoReporteExport implements FromView, ShouldAutoSize, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    {
        return view('exports.stock.bien_uso_movimiento_reporteindex', [
            'filas' => $this->filas,
            'titulo' => $this->titulo,
