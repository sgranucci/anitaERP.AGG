...
class ArticuloCuentaOcReporteExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(
        ...
        private string $modo = ArticuloCuentaOcReporteFiltros::MODO_RESUMEN,
    ) {}
    ...
    public function view(): View
    {
        ...
        return view('exports.compras.articulo_cuenta_oc_reporteindex', [
            'filas' => $this->filas,
            'titulo' => $this->titulo,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('H'.$this->filaPrimeraDatosExcel.':K'.$sheet->getHighestRow())
                    ->getAlignment()
                    ->setWrapText(true);
