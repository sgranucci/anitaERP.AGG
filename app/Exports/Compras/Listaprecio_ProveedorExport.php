...
class Listaprecio_ProveedorExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(Listaprecio_ProveedorQueryInterface $query)
    {
        $this->query = $query;
    }
    ...
    {
        $listas = $this->flDesdeIndex
            ? $this->query->leeListas($this->filtros, false)
            : collect();

        $this->rutasLogosExcel = EmpresaLogoArchivo::rutasLogosCabeceraDesdeColeccion($listas);
        $this->hayFilaLogos = count($this->rutasLogosExcel) > 0;
        $this->filaTituloExcel = $this->hayFilaLogos ? 2 : 1;
        $this->filaCabecerasExcel = $this->hayFilaLogos ? 3 : 2;
        $this->filaPrimeraDatosExcel = $this->filaCabecerasExcel + 1;

        return view('exports.compras.listaprecio_proveedorindex', [
            'listas' => $listas,
    ...
    {
        return 'Listas precio proveedor';
    }
