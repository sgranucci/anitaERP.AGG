...
class PortalProveedorRetencionesListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        $filasMeta = 3;
        if (($this->resumen['cantidad_retenciones'] ?? 0) > 0) {
            $filasMeta++;
        }
        ...
        return view('exports.compras.portal_proveedor_retencionesindex', [
            'datas' => $this->filas,
