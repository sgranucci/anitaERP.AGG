...
class PortalProveedorOrdencompraListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.compras.portal_proveedor_ordenesindex', [
            'datas' => $this->filas,
