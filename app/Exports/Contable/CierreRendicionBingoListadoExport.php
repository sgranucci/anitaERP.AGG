...
class CierreRendicionBingoListadoExport implements FromView, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    ...
    /**
     * Recaudación (col. I) con máscara neutra: en modo "auto" Excel la muestra según
     * la región de la PC y queda sumable.
     *
