...
class CierreRendicionMaquinavendingConciliacionFlashExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    ...
    public function view(): View
    {
        ...
        return view('contable.cierre_rendicion_maquinavending.conciliacion_flash_listado', [
    ...
    public static function aplanarFilas(array $resultado): array
    {
        ...
        foreach ($resultado['dias'] ?? [] as $dia) {
            $filas[] = [
                ...
                'total_flash_vending' => (float) ($dia['total_flash_vending'] ?? 0),
                'total_rendgastro_z' => (float) ($dia['total_rendgastro_z'] ?? 0),
    ...
    {
        return 'Conciliacion flash vending';
    }
}
