...
class IngresosBrutosListadoExport implements FromView, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.contable.ingresos_brutosindex', [
    ...
    public function columnWidths(): array
    {
        ...
        // Conciliación reutiliza las mismas columnas: Cód | Concepto | Total IIBB |
    ...
    /**
     * Reaplica número real en C/D/E de filas de conciliación (Total IIBB, mayor, diferencia).
     */
    ...
    /**
     * Fila de la cabecera del detalle IIBB (primer campo "Cert.").
     */
