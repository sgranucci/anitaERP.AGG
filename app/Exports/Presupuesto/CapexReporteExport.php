...
class CapexReporteExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    {
        return view('exports.presupuesto.capexreporteindex', [
            'filas' => $this->filas,
            'titulo' => $this->titulo,
