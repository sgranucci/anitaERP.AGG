...
class CapexExport implements FromView, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(CapexQueryInterface $capexquery)
    {
    ...
    public function view(): View
    {
        ...
        $this->rutasLogosExcel = EmpresaLogoArchivo::rutasLogosCabeceraDesdeColeccion($capexs);
        ...
        return view('exports.presupuesto.capexindex', [
            'capex' => $capexs,
            'esExcel' => true,
    ...
    /**
     * ID como texto (evita notación científica / relleno). Los montos de capex
     * viven dentro de la lista de "Partidas" (texto descriptivo), por lo que no
     * hay columna numérica suelta que enmascarar.
     *
