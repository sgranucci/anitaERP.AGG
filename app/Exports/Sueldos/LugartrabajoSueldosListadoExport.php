...
class LugartrabajoSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeLugartrabajo($this->filtros, false);
            ...
            return view('exports.sueldos.lugartrabajoindex', [
                'datas' => $datas,
