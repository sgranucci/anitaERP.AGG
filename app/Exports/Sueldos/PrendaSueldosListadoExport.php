...
class PrendaSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leePrenda($this->filtros, false);
            ...
            return view('exports.sueldos.prendaindex', [
                'datas' => $datas,
