...
class AgrupamientoSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeAgrupamiento($this->filtros, false);
            ...
            return view('exports.sueldos.agrupamientoindex', [
                'datas' => $datas,
    ...
    {
        return 'Agrupamientos de sueldos';
    }
