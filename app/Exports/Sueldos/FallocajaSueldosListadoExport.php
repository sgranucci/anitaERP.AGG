...
class FallocajaSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeFallocaja($this->filtros, false);
            ...
            return view('exports.sueldos.fallocajaindex', [
                'datas' => $datas,
