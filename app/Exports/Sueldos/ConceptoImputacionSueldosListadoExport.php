...
class ConceptoImputacionSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'H';

    public function __construct(private Concepto_Imputacion_SueldosRepositoryInterface $repository)
    {
    }
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeImputacion($this->filtros, false);
            ...
            return view('exports.sueldos.imputacion_conceptoindex', [
                'datas' => $datas,
    ...
    {
        return $this->flDesdeIndex
            ? ['A' => 8, 'B' => 22, 'C' => 14, 'D' => 36, 'E' => 16, 'F' => 28, 'G' => 16, 'H' => 28]
            : [];
    }
