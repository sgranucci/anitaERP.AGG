...
class SindicatoSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeSindicato($this->filtros, false);
            ...
            return view('exports.sueldos.sindicatoindex', [
                'datas' => $datas,
