...
class ConceptoSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeConcepto($this->filtros, false);
            ...
            return view('exports.sueldos.conceptoindex', [
                'datas' => $datas,
