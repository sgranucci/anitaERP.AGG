...
class AcumuladorSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeAcumulador($this->filtros, false);
            ...
            return view('exports.sueldos.acumuladorindex', [
                'datas' => $datas,
