...
class GrupoConceptoSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(Grupo_Concepto_SueldosRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeGrupo($this->filtros, false);
            ...
            return view('exports.sueldos.grupo_conceptoindex', [
                'datas' => $datas,
