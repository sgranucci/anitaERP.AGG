...
class TipoSancionSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'E';

    private Tipo_Sancion_SueldosRepositoryInterface $repository;
    ...
    public function __construct(Tipo_Sancion_SueldosRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeTipoSancion($this->filtros, false);
            ...
            return view('exports.sueldos.tipo_sancionindex', [
                'datas' => $datas,
    ...
    {
        return $this->flDesdeIndex ? ['A' => 8, 'B' => 10, 'C' => 36, 'D' => 20, 'E' => 12] : [];
    }
