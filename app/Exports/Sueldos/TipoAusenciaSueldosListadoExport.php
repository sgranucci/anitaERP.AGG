...
class TipoAusenciaSueldosListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeTipoAusencia($this->filtros, false);
            ...
            return view('exports.sueldos.tipoausenciaindex', [
                'datas' => $datas,
