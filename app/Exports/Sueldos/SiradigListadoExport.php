...
class SiradigListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if (! $this->flDesdeIndex) {
            ...
            return view('exports.sueldos.siradigindex', [
                'datas' => collect(),
                'reservarFilaLogoExcel' => false,
            ]);
        }

        $filtros = is_array($this->filtros) ? $this->filtros : SiradigListadoFiltros::filtrosVacios();

        $query = Siradig_Presentacion_Sueldos::query()->with(['empresa', 'conceptos']);
        ...
        $datas = $query->orderByDesc('periodo')->orderBy('empleado_apellido')->get();
    ...
    {
        if ($this->flDesdeIndex) {
            return ['A' => 10, 'B' => 9, 'C' => 8, 'D' => 14, 'E' => 16, 'F' => 40, 'G' => 30, 'H' => 30, 'I' => 10, 'J' => 16];
        }
