...
class SaldoVacacionesReporteExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = SaldoVacacionesReporteConsulta::query($this->filtros, $this->empresaRepository)->get();
            ...
            return view('exports.sueldos.saldovacacionesindex', [
                'datas' => $datas,
