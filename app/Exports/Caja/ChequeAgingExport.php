...
class ChequeAgingExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        if ($this->flDesdeIndex) {
            $resumen = ChequeCarteraAgingSupport::resumir(
                ($this->filtros['empresa_id'] ?? null) ? (int) $this->filtros['empresa_id'] : null,
        ...
        return view('exports.caja.chequeagingindex', [
            'filas' => $filas,
