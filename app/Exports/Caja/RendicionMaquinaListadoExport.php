...
class RendicionMaquinaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'J';

    private RendicionMaquinaRepositoryInterface $repository;
    ...
    public function __construct(RendicionMaquinaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeRendicionMaquina($this->filtros, false);
            ...
            return view('exports.caja.rendicion_maquinaindex', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\RendicionMaquina>|\Illuminate\Database\Eloquent\Collection  $datas
     */
