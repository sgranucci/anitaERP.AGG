...
class RendicionGastronomiaCajaExport implements FromView, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    ...
    /**
     * Importes (H–K) con máscara neutra: sumables y adaptables a la región.
     *
