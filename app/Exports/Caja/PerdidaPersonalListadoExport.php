...
class PerdidaPersonalListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'N';

    private PerdidaPersonalRepositoryInterface $repository;
    ...
    public function __construct(PerdidaPersonalRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leePerdidaPersonal($this->filtros, false);
            ...
            return view('exports.caja.perdida_personalindex', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\PerdidaPersonal>|\Illuminate\Database\Eloquent\Collection  $datas
     */
