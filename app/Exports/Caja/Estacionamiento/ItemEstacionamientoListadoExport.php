...
class ItemEstacionamientoListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'D';

    private ItemEstacionamientoRepositoryInterface $repository;
    ...
    public function __construct(ItemEstacionamientoRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeItemEstacionamiento($this->filtros, false);
            ...
            return view('exports.caja.estacionamiento.item_index', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\Estacionamiento\ItemEstacionamiento>|\Illuminate\Database\Eloquent\Collection  $datas
     */
