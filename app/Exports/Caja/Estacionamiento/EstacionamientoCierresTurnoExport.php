...
class EstacionamientoCierresTurnoExport implements FromView, ShouldAutoSize, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.caja.estacionamiento.cierres_turno_estacionamiento', [
            'filas' => $this->filas,
