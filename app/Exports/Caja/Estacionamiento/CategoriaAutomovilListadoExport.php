...
class CategoriaAutomovilListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'B';

    private CategoriaAutomovilRepositoryInterface $repository;
    ...
    public function __construct(CategoriaAutomovilRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeCategoriaAutomovil($this->filtros, false);
            ...
            return view('exports.caja.estacionamiento.categoria_automovil_index', [
                'datas' => $datas,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('B'.$primera.':B'.$sheet->getHighestRow())
                    ->getAlignment()
                    ->setWrapText(true)
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\Estacionamiento\CategoriaAutomovil>|\Illuminate\Database\Eloquent\Collection  $datas
     */
