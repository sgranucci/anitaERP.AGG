...
class ConceptoPerdidaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'C';

    private ConceptoPerdidaRepositoryInterface $repository;
    ...
    public function __construct(ConceptoPerdidaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeConceptoPerdida($this->filtros, false);
            ...
            return view('exports.caja.concepto_perdidaindex', [
                'datas' => $datas,
    ...
    /**
     * Maestro sin empresa: deja nombreempresa vacío para logo default de instalación.
     *
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\ConceptoPerdida>|\Illuminate\Database\Eloquent\Collection  $datas
     */
