...
class InterbankingMovimientoHistoricoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.caja.interbanking_movimiento_historico', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('A'.$filaTit.':'.$ult.$filaTit)->applyFromArray([
                    'font' => [
                        'bold' => true,
                        'size' => 16,
                        'name' => 'Arial',
    ...
    {
        return 'Movimientos Interbanking persistidos';
    }
}
