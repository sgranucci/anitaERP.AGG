...
class ImputacionPerdidaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'E';

    private ImputacionPerdidaRepositoryInterface $repository;
    ...
    public function __construct(ImputacionPerdidaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeImputacionPerdida($this->filtros, false);
            ...
            return view('exports.caja.imputacion_perdidaindex', [
                'datas' => $datas,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('C'.$primera.':E'.$sheet->getHighestRow())
                    ->getAlignment()
                    ->setWrapText(true)
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\ImputacionPerdida>|\Illuminate\Database\Eloquent\Collection  $datas
     */
