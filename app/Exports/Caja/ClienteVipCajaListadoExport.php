...
class ClienteVipCajaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(ClienteVipCajaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            ...
            return view('exports.caja.cliente_vip_cajaindex', [
                'datas' => $datas,
