...
class BingoConceptoRendicionListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'G';

    private BingoConceptoRendicionRepositoryInterface $repository;
    ...
    public function __construct(BingoConceptoRendicionRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeBingoConceptoRendicion($this->filtros, false);
            ...
            return view('exports.caja.bingo.concepto_rendicion_index', [
                'datas' => $datas,
    ...
    {
        return 'Conceptos rendición bingo';
    }
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\Bingo\BingoConceptoRendicion>|\Illuminate\Database\Eloquent\Collection  $datas
     */
