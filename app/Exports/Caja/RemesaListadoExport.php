...
class RemesaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'J';

    private RemesaRepositoryInterface $repository;
    ...
    public function __construct(RemesaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeRemesa($this->filtros, false);
            ...
            return view('exports.caja.remesaindex', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Caja\Remesa>|\Illuminate\Database\Eloquent\Collection  $datas
     */
