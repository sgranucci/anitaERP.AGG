...
class FlashCajaHistoricoDiarioExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    {
        // título + Generado + subtítulo (empresa/periodo) + budget
        $this->filasMeta = 4;
