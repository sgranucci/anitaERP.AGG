...
class RegimenPercepcionListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'H';

    private RegimenPercepcionRepositoryInterface $repository;
    ...
    public function __construct(RegimenPercepcionRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeRegimenPercepcion($this->filtros, false);
            ...
            return view('exports.configuracion.regimen_percepcionindex', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Configuracion\RegimenPercepcion>|\Illuminate\Database\Eloquent\Collection  $datas
     */
