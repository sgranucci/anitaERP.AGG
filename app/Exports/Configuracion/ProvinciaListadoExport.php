...
class ProvinciaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'I';

    private ProvinciaRepositoryInterface $repository;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeProvincia($this->filtros, false);
            ...
            return view('exports.configuracion.provinciaindex', [
                'datas' => $datas,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('H'.$this->filaPrimeraDatosExcel.':I'.$ultimaFila)
                    ->getAlignment()
                    ->setWrapText(true);
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Configuracion\Provincia>|\Illuminate\Database\Eloquent\Collection  $datas
     */
