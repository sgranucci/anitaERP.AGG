...
class UbicacionImpresoraListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'C';

    private UbicacionImpresoraRepositoryInterface $repository;
    ...
    public function __construct(UbicacionImpresoraRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeUbicacionImpresora($this->filtros, false);
            ...
            return view('exports.configuracion.ubicacion_impresora_index', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Configuracion\UbicacionImpresora>|\Illuminate\Database\Eloquent\Collection  $datas
     */
