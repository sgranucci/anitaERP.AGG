...
class SistemaNumeradorListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(SistemaNumeradorRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeSistemaNumerador($this->filtros, false);
            ...
            return view('exports.configuracion.sistema_numerador_index', [
                'datas' => $datas,
