...
class UsoSalidaImpresoraListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'D';

    private UsoSalidaImpresoraRepositoryInterface $repository;
    ...
    public function __construct(UsoSalidaImpresoraRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeUsoSalidaImpresora($this->filtros, false);
            ...
            return view('exports.configuracion.uso_salida_impresora_index', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Configuracion\UsoSalidaImpresora>|\Illuminate\Database\Eloquent\Collection  $datas
     */
