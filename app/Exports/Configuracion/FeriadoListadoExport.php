...
class FeriadoListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'D';

    private FeriadoRepositoryInterface $repository;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeFeriado($this->filtros, false);
            ...
            return view('exports.configuracion.feriado_index', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Configuracion\Feriado>|\Illuminate\Database\Eloquent\Collection  $datas
     */
