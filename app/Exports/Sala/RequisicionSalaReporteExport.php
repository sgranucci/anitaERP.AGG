...
class RequisicionSalaReporteExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'V';
    ...
    public function view(): View
    {
        ...
        return view('exports.sala.requisicion_sala_reporteindex', [
            'filas' => $this->filas,
            'titulo' => $this->titulo,
