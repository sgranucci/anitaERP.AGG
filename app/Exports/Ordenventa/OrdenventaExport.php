...
class OrdenventaExport implements FromView, WithColumnFormatting, WithMapping, ShouldAutoSize, WithStyles, WithColumnWidths, WithEvents, WithTitle
{
	use Exportable;
	private $origen;
	...
	public function view(): View
	{
		...
		return view('exports.ordenventa.ordenventaindex', ['ordenventa' => $ordenventas]);
	}
