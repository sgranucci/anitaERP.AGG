...
class ConceptoVentaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'H';

    private Concepto_VentaRepositoryInterface $repository;
    ...
    public function __construct(Concepto_VentaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeConceptoVenta($this->filtros, false);
            ...
            return view('exports.ventas.concepto_ventaindex', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Ventas\Concepto_Venta>|\Illuminate\Database\Eloquent\Collection  $datas
     */
