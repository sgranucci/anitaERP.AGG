...
class TurnoLocalListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            ...
            $datas = app(TurnoLocalRepositoryInterface::class)->leeTurnos($filtros, false);
            ...
            return view('exports.ventas.turno_localindex', [
                'datas' => $datas,
