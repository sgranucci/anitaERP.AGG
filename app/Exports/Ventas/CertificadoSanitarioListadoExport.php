...
class CertificadoSanitarioListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(
        private readonly CertificadoSanitarioService $service,
    ) {
    }
    ...
    public function view(): View
    {
        $datas = $this->flDesdeIndex
            ? $this->service->listar($this->filtros, false)
            : collect();
        ...
        return view('exports.ventas.certificado_sanitarioindex', [
            'datas' => $datas,
            'reservarFilaLogoExcel' => $this->hayFilaLogos,
            'totalesListado' => $this->flDesdeIndex ? $this->service->totalesListado($this->filtros) : ['kilos' => 0.0, 'cajas' => 0.0],
        ]);
    }
