...
class ViandaUsuarioListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(ViandaUsuarioRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeUsuarios($this->filtros, false);
            ...
            return view('exports.ventas.vianda_usuarioindex', [
                'datas' => $datas,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('D'.$primera.':E'.$sheet->getHighestRow())
                    ->getAlignment()
                    ->setWrapText(true)
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Ventas\ViandaUsuario>|\Illuminate\Database\Eloquent\Collection  $datas
     */
