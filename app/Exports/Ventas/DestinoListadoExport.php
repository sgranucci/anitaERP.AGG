...
class DestinoListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'H';

    private DestinoRepositoryInterface $repository;
    ...
    public function __construct(DestinoRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeDestino($this->filtros, false);
            ...
            return view('exports.ventas.destinoindex', [
                'datas' => $datas,
