...
class ComisionVendedorResumenListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    private string $titulo = 'Comisiones de vendedores — resumen';
    ...
    {
        $resultado = $this->reporteService->generarResumen($this->filtros);
        ...
        return view('exports.ventas.comisionvendedorresumenindex', [
            'filas' => $filas,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('C'.$this->filaPrimeraDatosExcel.':D'.$highest)
                    ->getAlignment()
