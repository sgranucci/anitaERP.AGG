...
class ContratoVentaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;

    private const COL_ULTIMA = 'I';

    private Contrato_VentaRepositoryInterface $repository;
    ...
    public function __construct(Contrato_VentaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeContratoVenta($this->filtros, false);
            ...
            return view('exports.ventas.contrato_ventaindex', [
                'datas' => $datas,
    ...
    /**
     * @param  \Illuminate\Support\Collection<int, \App\Models\Ventas\Contrato_Venta>|\Illuminate\Database\Eloquent\Collection  $datas
     */
