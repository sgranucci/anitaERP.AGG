...
class MaquinavendingRendicionListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(MaquinavendingRendicionRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeRendiciones($this->filtros, false);
            ...
            return view('exports.ventas.maquinavending_rendicionindex', [
                'datas' => $datas,
