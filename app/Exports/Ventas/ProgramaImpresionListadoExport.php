...
class ProgramaImpresionListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(private ComprobanteImpresionProgramaRepositoryInterface $repository)
    {
    }
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeProgramas($this->filtros, false);
            ...
            return view('exports.ventas.programa_impresionindex', [
                'datas' => $datas,
