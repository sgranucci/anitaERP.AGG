...
class PedidoExportFerli implements FromView, WithColumnFormatting, WithMapping, ShouldAutoSize, WithStyles, WithColumnWidths, WithEvents, WithTitle
{
	use Exportable;
	...
	private $busqueda;
	private $desdevendedor;
	private $hastavendedor;
	...
	public function view(): View
	{
		if ($this->flDesdeIndex)
		{
			...
			return view('exports.ventas.pedidoindex_ferli', ['pedidos' => $pedidos]);
		}
