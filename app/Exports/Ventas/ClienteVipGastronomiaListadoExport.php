...
class ClienteVipGastronomiaListadoExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function __construct(ClienteVipGastronomiaRepositoryInterface $repository)
    {
    ...
    public function view(): View
    {
        if ($this->flDesdeIndex) {
            $datas = $this->repository->leeClienteVip($this->filtros, false);
            ...
            return view('exports.ventas.cliente_vip_gastronomiaindex', [
                'datas' => $datas,
    ...
    /**
     * @param  iterable<int, object>  $datas
     */
    private static function enriquecerNombreEmpresa(iterable $datas): void
    {
