...
class FacturacionLocalFacturasExport implements FromView, ShouldAutoSize, WithColumnFormatting, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('exports.ventas.facturacion_local_facturasindex', [
