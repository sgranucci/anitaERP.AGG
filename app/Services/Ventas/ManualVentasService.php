...
class ManualVentasService
{
    public function meta(): array
    {
        $contenido = require base_path('docs/manual-ventas/contenido.php');
        ...
        return array_merge($contenido, [
            ...
            'url_login' => rtrim(config('app.url', env('APP_URL', '')), '/')
                . (env('APP_CARPETA', '') ?: '')
                . '/seguridad/login',
            'version' => config('manual_ventas.version', '1.0'),
    ...
    {
        $defs = require base_path('docs/manual-ventas/herramientas.php');
