...
final class RendicionEstacionamientoRepararJornadaAnitaService
{
    ...
    public function reparar(
        ...
        foreach ($puntosVenta as $pv) {
            ...
            $totalZ = EstacionamientoTurnoOperativoTotalesSupport::totalFacturasSinNotasCreditoPorPuntoventa(
                (int) $pv->id,
                $empresaId,
                $fechaJornada,
            );
            $totNc = EstacionamientoTurnoOperativoTotalesSupport::totalNotasCreditoPorPuntoventa(
                (int) $pv->id,
                $empresaId,
                $fechaJornada,
            );
