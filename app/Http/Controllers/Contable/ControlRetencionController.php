...
use App\Imports\Contable\Retencionimpositiva_ArcaImport;
use App\Exports\Contable\ConciliaRetencionimpositiva_ArcaExport;
use App\Exports\Contable\Retencionimpositiva_ArcaExport;
...
class ControlRetencionController extends Controller
{
	private $repository;
    ...
    public function index(Request $request)
    {
        ...
        return view('contable.control_retencion.index', $datas);
    }
    ...
    public function listar(Request $request, $formato = null, $busqueda = null)
    {
        ...
        case 'PDF':
            ...
            $view =  \View::make('contable.control_retencion.listado', compact('retencionimpositiva_arca'))
                        ->render();
    ...
    public function crear()
    {
        ...
        return view('contable.control_retencion.crear', compact('empresa_query'));
    }
    ...
    public function guardar(ValidacionRetencionimpositiva_Arca $request)
    {
        ...
        return redirect('contable/control-retencion')->with('mensaje', 'Retención Impositiva creada con éxito');
    }
    ...
    public function editar($id)
    {
        ...
        return view('contable.control_retencion.editar', compact('data', 'empresa_query'));
    }
    ...
    public function actualizar(ValidacionRetencionimpositiva_Arca $request, $id)
    {
        ...
        return redirect('contable/control-retencion')->with('mensaje', 'Retención Impositiva actualizada con éxito');
    }
    ...
    public function crearImportacionRetencionimpositiva_Arca()
    {
        ...
        return view('contable.control_retencion.crearimportacion', compact('empresa_query', 'agregapisa_enum'));
    }
    ...
    public function conciliarRetencionimpositiva_Arca()
    {
        ...
        return view('contable.control_retencion.crearconciliacion', compact('empresa_query', 'impuesto_query', 'regimen_query'));
    }
