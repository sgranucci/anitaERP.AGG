...
use App\Repositories\Ventas\MesaGastronomiaRepositoryInterface;
...
class MesaGastronomiaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ventas.mesa_gastronomia.index', compact('datas'));
    }
    ...
    public function crear()
    {
        ...
        return view('ventas.mesa_gastronomia.crear', compact('data', 'empresa_query', 'ubicacion_query'));
    }
    ...
    public function guardar(ValidacionMesaGastronomia $request)
    {
        ...
        return redirect('ventas/mesa-gastronomia')->with('mensaje', 'Mesa creada con éxito');
    }
    ...
    public function editar($id)
    {
        ...
        return view('ventas.mesa_gastronomia.editar', compact('data', 'empresa_query', 'ubicacion_query'));
    }
    ...
    public function actualizar(ValidacionMesaGastronomia $request, $id)
    {
        ...
        return redirect('ventas/mesa-gastronomia')->with('mensaje', 'Mesa actualizada con éxito');
    }
