...
class LocalidadController extends Controller
{
    ...
    public function editar(Request $request, $id)
    {
        ...
        if (!str_contains($request->header("referer"), 'localidad'))
        ...
        return view('configuracion.localidad.editar', compact('data', 'provincia_query', 'referer'));
    }
    ...
    public function actualizar(ValidacionLocalidad $request, $id)
    {
        ...
        if ($request->referer != null)
            return redirect($request->referer)->with('mensaje', 'Localidad actualizada con éxito');
           

            return redirect('configuracion/localidad')->with('mensaje', 'Localidad actualizada con éxito');
    }
