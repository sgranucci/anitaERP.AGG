...
use App\Services\Sueldos\DtoFalloProcesoService;
 ...
 */
class DtoFallo_SueldosController extends Controller
{
    public function __construct(
        private readonly DtoFalloProcesoService $proceso,
        private readonly EmpresaRepositoryInterface $empresaRepository,
    ) {}

    public function index(Request $request)
    {
        can('listar-dtofallo-sueldos');

        $cierres = Cierrefallo_Sueldos::query()
        ...
        return view('sueldos.dtofallo.index', [
    ...
    public function generar(Request $request)
    {
        ...
        return redirect()
            ->route('consultar_dtofallo_sueldos')
            ->with(
                'mensaje',
                sprintf(
    ...
    public function anular(Request $request, $id)
    {
        ...
        return redirect()
            ->route('consultar_dtofallo_sueldos')
            ->with('mensaje', 'Cierre #'.$cierre->nro_cierre.' anulado. Movimientos borrados y novedades asociadas anuladas.');
    }

    public function ver($id)
    {
        can('listar-dtofallo-sueldos');
        $cierre = Cierrefallo_Sueldos::query()
            ->with([
                'empresa',
                'usuario',
        ...
        return view('sueldos.dtofallo.ver', compact('cierre'));
    }
}
