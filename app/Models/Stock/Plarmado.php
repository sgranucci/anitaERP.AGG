...
class Plarmado extends Model
{
    protected $fillable = ['nombre'];
    protected $table = 'plarmado';
    protected $keyField = 'plarm_codigo';
	...
	public function guardarAnita($request, $id) {
        ...
        $data = array( 'tabla' => 'plarmado', 'acc' => 'insert',
