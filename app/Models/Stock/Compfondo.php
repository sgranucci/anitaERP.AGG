...
class Compfondo extends Model
{
    protected $fillable = ['nombre'];
    protected $table = 'compfondo';
    protected $keyField = 'cfond_compfondo';
	...
	public function guardarAnita($request, $id) {
        ...
        $data = array( 'tabla' => 'compfondo', 'acc' => 'insert',
