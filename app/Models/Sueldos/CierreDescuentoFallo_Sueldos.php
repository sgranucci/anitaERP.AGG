...
class CierreDescuentoFallo_Sueldos extends Model implements Auditable
{
    ...
    protected $table = 'cierre_descuento_fallo_sueldos';
    ...
    {
        return $this->hasMany(DescuentoFallo_Sueldos::class, 'cierre_descuento_fallo_id');
    }
