...
class ComentarioUsuarioTareaNotificacion extends Mailable
{
    ...
    public function __construct(
        ...
        $this->subject('Nuevo comentario del usuario en ticket #'.$ticket->id);
    }

    public function build(): self
    {
        return $this->view('mails.ticket.comentario_usuario_tarea');
    }
}
