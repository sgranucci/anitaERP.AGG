...
class MaterialavioRepository implements MaterialavioRepositoryInterface
{
    protected $model;
     ...
     * @param Post $post
     */
    public function __construct(Materialavio $materialavio)
    {
        $this->model = $materialavio;
    }
    ...
    {
        if (null == $materialavio = $this->model->find($id)) {
    ...
    {
        if (null == $materialavio = $this->model->findOrFail($id)) {
            throw new ModelNotFoundException("Registro no encontrado");
        }
    ...
    public function sincronizarConAnita(){
        ...
        $data = array( 'acc' => 'list', 
            			...
            			'whereArmado' => " WHERE stkm_tipo_articulo='6' ",
