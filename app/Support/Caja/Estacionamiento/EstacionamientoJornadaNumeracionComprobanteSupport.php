 ...
 */
final class EstacionamientoJornadaNumeracionComprobanteSupport
{
    /**
     * @return array{filas: list<array<string, mixed>>, resumen_etiqueta: string}
     */
    public static function paraJornada(JornadaEstacionamiento $jornada): array
    {
        ...
        if ($roles === []) {
            return ['filas' => [], 'resumen_etiqueta' => 'Sin puntos de venta configurados en estacionamiento.'];
        }
        ...
        foreach ($roles as $rol) {
            ...
            $filas[] = [
                'configuracion_puntoventa_estacionamiento_id' => (int) ($rol['configuracion_puntoventa_estacionamiento_id'] ?? 0),
    ...
    {
        $configs = ConfiguracionPuntoventaEstacionamiento::query()
    ...
    private static function agregadosPorPuntoventa(
        ...
        $filas = EstacionamientoTurnoOperativoTotalesSupport::queryEmisionesJornadaEmpresa(
            $empresaId,
            $fechaJornada,
            $desde,
            $hastaInclusive,
