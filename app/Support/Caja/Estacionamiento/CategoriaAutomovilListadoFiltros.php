...
/**
 * Filtros del listado de categorías de automóvil (estacionamiento).
 */
class CategoriaAutomovilListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'categoria_automovil_estacionamiento.id', 'type' => 'entero', 'label' => 'ID'],
        'nombre' => ['column' => 'categoria_automovil_estacionamiento.nombre', 'type' => 'texto', 'label' => 'Nombre'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'categoria_automovil_estacionamiento.nombre',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Caja\Estacionamiento\CategoriaAutomovil>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['categoria_automovil_estacionamiento.nombre'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('categoria_automovil_estacionamiento.id', (int) $id);
            }
            $textCols = [
                'categoria_automovil_estacionamiento.nombre',
            ];
