...
/**
 * Filtros del listado de ítems (estacionamiento).
 */
class ItemEstacionamientoListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'item_estacionamiento.id', 'type' => 'entero', 'label' => 'ID'],
        'nombre' => ['column' => 'item_estacionamiento.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'empresa' => ['column' => 'empresa.nombre', 'type' => 'texto', 'label' => 'Empresa'],
        'estado' => ['column' => 'item_estacionamiento.estado', 'type' => 'texto', 'label' => 'Estado'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'empresa.nombre',
        'item_estacionamiento.nombre',
    ];
     ...
     *
     * @param  Builder<\App\Models\Caja\Estacionamiento\ItemEstacionamiento>  $query
    ...
    public static function aplicarScopeEmpresasAsignadas(Builder $query, array $filtros): void
    {
        ...
        if ($empresaId > 0) {
            $query->where('item_estacionamiento.empresa_id', $empresaId);
        ...
        $query->whereIn('item_estacionamiento.empresa_id', $asignadas);
    }
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['item_estacionamiento.nombre', 'item_estacionamiento.estado'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('item_estacionamiento.id', (int) $id);
            }
            $textCols = [
                'empresa.nombre',
                'item_estacionamiento.nombre',
                'item_estacionamiento.estado',
            ];
