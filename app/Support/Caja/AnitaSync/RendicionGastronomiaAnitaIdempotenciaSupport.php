 ...
 *
 * Clave en Anita: rendg_nro_rend_vta = turno_operativo_gastronomia_id + rendg_host (PC del turno).
 * Estacionamiento usa la misma tabla pero otro módulo; el host evita colisiones de ID numérico.
 */
final class RendicionGastronomiaAnitaIdempotenciaSupport
{
    /**
    ...
    public static function hostDesdeRendicion(RendicionGastronomiaCaja $rendicion): string
    {
    ...
    private static function alinearRendicionErp(RendicionGastronomiaCaja $rendicion, int $nroOper): void
    {
