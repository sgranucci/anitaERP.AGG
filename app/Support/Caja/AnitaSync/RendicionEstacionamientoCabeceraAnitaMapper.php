 ...
 */
final class RendicionEstacionamientoCabeceraAnitaMapper
{
    ...
    private static function columnasInsert(): array
    {
        $columnas = [
            ...
            ...RendicionEstacionamientoRendgastroEsquema::definicionesDecimalCero(),
    ...
    {
        $campos = config('rendicion_estacionamiento_anita.cabecera_campos_numericos_cero_en_update', []);
