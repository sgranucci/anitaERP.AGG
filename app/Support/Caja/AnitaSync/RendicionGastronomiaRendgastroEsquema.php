 ...
 */
final class RendicionGastronomiaRendgastroEsquema
{
    /**
     * float/integer del DDL que gastronomía no mapea desde el ERP (INSERT siempre 0).
    ...
    {
        $extra = config('rendicion_gastronomia_anita.cabecera_campos_numericos_insert_cero');
