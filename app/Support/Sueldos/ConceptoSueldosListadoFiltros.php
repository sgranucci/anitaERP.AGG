...
/**
 * Filtros del listado de conceptos de liquidacion (index paginado).
 */
class ConceptoSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'concepto_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'concepto_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'concepto_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'tipo' => ['column' => 'concepto_sueldos.tipo', 'type' => 'texto', 'label' => 'Tipo'],
        'momento' => ['column' => 'concepto_sueldos.momento', 'type' => 'texto', 'label' => 'Momento'],
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Concepto_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('concepto_sueldos.descripcion')->orWhere('concepto_sueldos.descripcion', '');
            });
