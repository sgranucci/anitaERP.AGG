...
/**
 * Filtros del listado de ART (index paginado). Código alfanumérico.
 */
class ArtSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'art_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'art_sueldos.codigo', 'type' => 'texto', 'label' => 'Código'],
        'nombre' => ['column' => 'art_sueldos.nombre', 'type' => 'texto', 'label' => 'Nombre'],
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Art_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('art_sueldos.nombre')->orWhere('art_sueldos.nombre', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like) {
            $q->orWhere('art_sueldos.codigo', 'like', $like);
            $q->orWhere('art_sueldos.nombre', 'like', $like);
