...
/**
 * Filtros del listado de lugares de trabajo de sueldos (index paginado).
 */
class LugartrabajoSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'lugartrabajo_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'lugartrabajo_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'nombre' => ['column' => 'lugartrabajo_sueldos.nombre', 'type' => 'texto', 'label' => 'Nombre'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'lugartrabajo_sueldos.nombre',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Lugartrabajo_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('lugartrabajo_sueldos.nombre')->orWhere('lugartrabajo_sueldos.nombre', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('lugartrabajo_sueldos.id', (int) $id);
                $q->orWhere('lugartrabajo_sueldos.codigo', (int) $id);
            }
            $q->orWhere('lugartrabajo_sueldos.nombre', 'like', $like);
