...
/**
 * Filtros del listado de obras sociales (index paginado).
 */
class ObrasocialSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'obrasocial_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'obrasocial_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'obrasocial_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'numero' => ['column' => 'obrasocial_sueldos.numero', 'type' => 'texto', 'label' => 'Número'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'obrasocial_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Obrasocial_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('obrasocial_sueldos.descripcion')->orWhere('obrasocial_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('obrasocial_sueldos.id', (int) $id);
                $q->orWhere('obrasocial_sueldos.codigo', (int) $id);
            }
            $q->orWhere('obrasocial_sueldos.descripcion', 'like', $like);
            $q->orWhere('obrasocial_sueldos.numero', 'like', $like);
