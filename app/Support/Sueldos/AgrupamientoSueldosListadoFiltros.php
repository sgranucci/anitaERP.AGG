...
/**
 * Filtros del listado de agrupamientos de sueldos (index paginado).
 */
class AgrupamientoSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'agrupamiento_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'agrupamiento_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'agrupamiento_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'fallo_tipo' => ['column' => 'agrupamiento_sueldos.fallo_tipo', 'type' => 'texto', 'label' => 'Fallo (Bingo/Máquinas)'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'agrupamiento_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Agrupamiento_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('agrupamiento_sueldos.descripcion')->orWhere('agrupamiento_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('agrupamiento_sueldos.id', (int) $id);
                $q->orWhere('agrupamiento_sueldos.codigo', (int) $id);
            }
            $q->orWhere('agrupamiento_sueldos.descripcion', 'like', $like);
            $q->orWhere('agrupamiento_sueldos.fallo_tipo', 'like', $like);
