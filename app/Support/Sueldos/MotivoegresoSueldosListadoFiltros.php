...
/**
 * Filtros del listado de motivos de egreso (index paginado).
 */
class MotivoegresoSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'motivoegreso_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'motivoegreso_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'motivoegreso_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'motivoegreso_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Motivoegreso_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('motivoegreso_sueldos.descripcion')->orWhere('motivoegreso_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('motivoegreso_sueldos.id', (int) $id);
                $q->orWhere('motivoegreso_sueldos.codigo', (int) $id);
            }
            $q->orWhere('motivoegreso_sueldos.descripcion', 'like', $like);
