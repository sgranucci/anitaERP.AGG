...
class PrendaSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'prenda_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'prenda_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'prenda_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'marca' => ['column' => 'prenda_sueldos.marca', 'type' => 'texto', 'label' => 'Marca'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'prenda_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Prenda_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('prenda_sueldos.descripcion')->orWhere('prenda_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('prenda_sueldos.id', (int) $id);
                $q->orWhere('prenda_sueldos.codigo', (int) $id);
            }
            $q->orWhere('prenda_sueldos.descripcion', 'like', $like);
            $q->orWhere('prenda_sueldos.marca', 'like', $like);
