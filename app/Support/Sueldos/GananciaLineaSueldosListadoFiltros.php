...
class GananciaLineaSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'ganancia_linea_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'ganancia_linea_sueldos.codigo', 'type' => 'texto', 'label' => 'Código'],
        'descripcion' => ['column' => 'ganancia_linea_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'origen' => ['column' => 'ganancia_linea_sueldos.origen', 'type' => 'texto', 'label' => 'Origen'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'ganancia_linea_sueldos.codigo',
        'ganancia_linea_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Ganancia_Linea_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('ganancia_linea_sueldos.descripcion')->orWhere('ganancia_linea_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('ganancia_linea_sueldos.id', (int) $id);
            }
            $q->orWhere('ganancia_linea_sueldos.codigo', 'like', $like);
            $q->orWhere('ganancia_linea_sueldos.descripcion', 'like', $like);
            $q->orWhere('ganancia_linea_sueldos.origen', 'like', $like);
