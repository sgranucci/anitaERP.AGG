...
class MotivoSancionSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'motivo_sancion_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'motivo_sancion_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'nombre' => ['column' => 'motivo_sancion_sueldos.nombre', 'type' => 'texto', 'label' => 'Nombre'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'motivo_sancion_sueldos.nombre',
    ];
    ...
    public static function aplicar(Builder $query, array $filtros): void
    {
        ...
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('motivo_sancion_sueldos.nombre')->orWhere('motivo_sancion_sueldos.nombre', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('motivo_sancion_sueldos.id', (int) $id);
                $q->orWhere('motivo_sancion_sueldos.codigo', (int) $id);
            }
            $q->orWhere('motivo_sancion_sueldos.nombre', 'like', $like);
