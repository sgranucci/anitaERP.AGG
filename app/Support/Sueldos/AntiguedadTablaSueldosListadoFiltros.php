...
/**
 * Filtros del listado de tablas de antigüedad (index paginado).
 */
class AntiguedadTablaSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'antiguedad_tabla_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'antiguedad_tabla_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'antiguedad_tabla_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'antiguedad_tabla_sueldos.descripcion',
        'antiguedad_tabla_sueldos.codigo',
    ];
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('antiguedad_tabla_sueldos.descripcion')->orWhere('antiguedad_tabla_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('antiguedad_tabla_sueldos.id', (int) $id);
            }
            $q->orWhere('antiguedad_tabla_sueldos.codigo', 'like', $like);
            $q->orWhere('antiguedad_tabla_sueldos.descripcion', 'like', $like);
            $q->orWhere( 'like', $like);
