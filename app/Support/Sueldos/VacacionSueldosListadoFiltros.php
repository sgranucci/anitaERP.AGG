...
/**
 * Filtros del listado de vacaciones de sueldos (index paginado).
 */
class VacacionSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'vacacion_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'vacacion_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'vacacion_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'vacacion_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Vacacion_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('vacacion_sueldos.descripcion')->orWhere('vacacion_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('vacacion_sueldos.id', (int) $id);
                $q->orWhere('vacacion_sueldos.codigo', (int) $id);
            }
            $q->orWhere('vacacion_sueldos.descripcion', 'like', $like);
