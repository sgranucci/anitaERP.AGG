...
/**
 * Filtros del listado de parámetros de liquidación (index paginado).
 */
class ParametroSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'parametro_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'parametro_sueldos.codigo', 'type' => 'texto', 'label' => 'Código'],
        'descripcion' => ['column' => 'parametro_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'unidad' => ['column' => 'parametro_sueldos.unidad', 'type' => 'texto', 'label' => 'Unidad'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'parametro_sueldos.descripcion',
        'parametro_sueldos.codigo',
        'parametro_sueldos.unidad',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Parametro_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('parametro_sueldos.descripcion')->orWhere('parametro_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('parametro_sueldos.id', (int) $id);
            }
            $q->orWhere('parametro_sueldos.codigo', 'like', $like);
            $q->orWhere('parametro_sueldos.descripcion', 'like', $like);
            $q->orWhere('parametro_sueldos.unidad', 'like', $like);
