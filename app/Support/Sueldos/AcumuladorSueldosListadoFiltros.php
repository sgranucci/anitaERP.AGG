...
/**
 * Filtros del listado de acumuladores de liquidación (index paginado).
 */
class AcumuladorSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'acumulador_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'acumulador_sueldos.codigo', 'type' => 'texto', 'label' => 'Código'],
        'descripcion' => ['column' => 'acumulador_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'acumulador_sueldos.codigo',
        'acumulador_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Acumulador_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('acumulador_sueldos.descripcion')->orWhere('acumulador_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('acumulador_sueldos.id', (int) $id);
            }
            $q->orWhere('acumulador_sueldos.codigo', 'like', $like);
            $q->orWhere('acumulador_sueldos.descripcion', 'like', $like);
