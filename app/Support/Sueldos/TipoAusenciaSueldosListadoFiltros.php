...
/**
 * Filtros del listado de tipos de ausencia (index paginado).
 */
class TipoAusenciaSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'tipo_ausencia_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'tipo_ausencia_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'nombre' => ['column' => 'tipo_ausencia_sueldos.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'categoria' => ['column' => 'tipo_ausencia_sueldos.categoria', 'type' => 'texto', 'label' => 'Categoría'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'tipo_ausencia_sueldos.nombre',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Tipo_Ausencia_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('tipo_ausencia_sueldos.nombre')->orWhere('tipo_ausencia_sueldos.nombre', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('tipo_ausencia_sueldos.id', (int) $id);
                $q->orWhere('tipo_ausencia_sueldos.codigo', (int) $id);
            }
            $q->orWhere('tipo_ausencia_sueldos.nombre', 'like', $like);
            $q->orWhere('tipo_ausencia_sueldos.categoria', 'like', $like);
