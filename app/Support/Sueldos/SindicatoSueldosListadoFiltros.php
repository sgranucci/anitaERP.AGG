...
/**
 * Filtros del listado de sindicatos (index paginado).
 */
class SindicatoSueldosListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'sindicato_sueldos.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'sindicato_sueldos.codigo', 'type' => 'entero', 'label' => 'Código'],
        'descripcion' => ['column' => 'sindicato_sueldos.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'numero' => ['column' => 'sindicato_sueldos.numero', 'type' => 'texto', 'label' => 'Número'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'sindicato_sueldos.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Sueldos\Sindicato_Sueldos>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                $q->whereNull('sindicato_sueldos.descripcion')->orWhere('sindicato_sueldos.descripcion', '');
            });
        ...
        $query->where(function ($q) use ($valor, $like, $id) {
            if ($id !== false) {
                $q->orWhere('sindicato_sueldos.id', (int) $id);
                $q->orWhere('sindicato_sueldos.codigo', (int) $id);
            }
            $q->orWhere('sindicato_sueldos.descripcion', 'like', $like);
            $q->orWhere('sindicato_sueldos.numero', 'like', $like);
