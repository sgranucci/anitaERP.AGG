...
/**
 * Filtros del listado de puntos de venta.
 */
class PuntoventaListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'puntoventa.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'puntoventa.codigo', 'type' => 'texto', 'label' => 'Código'],
        'nombre' => ['column' => 'puntoventa.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'domicilio' => ['column' => 'puntoventa.domicilio', 'type' => 'texto', 'label' => 'Domicilio'],
        ...
        'modofacturacion' => ['column' => 'puntoventa.modofacturacion', 'type' => 'texto', 'label' => 'Modo facturación'],
        'estado' => ['column' => 'puntoventa.estado', 'type' => 'texto', 'label' => 'Estado'],
    ];
    ...
    /**
     * @param  Builder<\App\Models\Ventas\Puntoventa>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['puntoventa.codigo', 'puntoventa.nombre', 'puntoventa.domicilio'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('puntoventa.id', (int) $id);
            }
