...
/**
 * Últimos números de ticket y nota de crédito emitidos en un turno operativo,
 * desglosados por punto de venta CAE y CAEA configurados en la terminal.
 */
final class GastronomiaTurnoNumeracionComprobanteSupport
{
    /**
     * @return array{
     *   filas: list<array{
     ...
     * }
     */
    public static function paraTurno(TurnoOperativoGastronomia $turno, ?Carbon $hastaInclusive = null): array
    {
     ...
     * }>
     */
    private static function rolesPuntoventa(ConfiguracionPuntoventaGastronomia $cfg): array
    {
        $roles = [];
