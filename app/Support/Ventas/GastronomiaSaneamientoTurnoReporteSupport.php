 ...
 */
final class GastronomiaSaneamientoTurnoReporteSupport
{
    /**
     * @param  array<string, mixed>  $diagnostico  Respuesta de GastronomiaTurnoSaneamientoService::diagnostico()
    ...
    public function datosInformePdf(array $diagnostico, ?string $empresaNombre = null): array
    {
        ...
        return [
            'titulo' => 'Informe de saneamiento — turnos gastronomía',
