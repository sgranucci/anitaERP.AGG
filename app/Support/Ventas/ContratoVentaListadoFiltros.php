...
/**
 * Filtros del listado de abonos / contratos de venta.
 */
class ContratoVentaListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'contrato_venta.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'contrato_venta.codigo', 'type' => 'texto', 'label' => 'Código'],
        'cliente' => ['column' => 'cliente.nombre', 'type' => 'texto', 'label' => 'Cliente'],
        'concepto' => ['column' => 'concepto_venta.nombre', 'type' => 'texto', 'label' => 'Concepto'],
        'estado' => ['column' => 'contrato_venta.estado', 'type' => 'texto', 'label' => 'Estado'],
        'empresa' => ['column' => 'empresa.nombre', 'type' => 'texto', 'label' => 'Empresa'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'contrato_venta.codigo',
        'cliente.nombre',
    ...
    /**
     * @param  Builder<\App\Models\Ventas\Contrato_Venta>  $query
     */
