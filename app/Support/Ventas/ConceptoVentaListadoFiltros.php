...
/**
 * Filtros del listado de conceptos de venta (mostrador).
 */
class ConceptoVentaListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'concepto_venta.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'concepto_venta.codigo', 'type' => 'texto', 'label' => 'Código'],
        'nombre' => ['column' => 'concepto_venta.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'descripcion' => ['column' => 'concepto_venta.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
        'codigo_gtin' => ['column' => 'concepto_venta.codigo_gtin', 'type' => 'texto', 'label' => 'GTIN'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'concepto_venta.nombre',
        'concepto_venta.descripcion',
        'concepto_venta.codigo',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Ventas\Concepto_Venta>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('concepto_venta.id', (int) $id);
            }
            foreach (self::COLUMNAS_TEXTO_GLOBAL as $col) {
