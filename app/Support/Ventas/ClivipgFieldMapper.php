...
/**
 * Mapeo campo a campo: clivipg (Anita base_admin) → cliente_vip_gastronomia (ERP).
 */
final class ClivipgFieldMapper
{
    ...
    public static function mapAll(object $row, int $empresaId): array
    {
        return [
            ...
            'nickname' => self::mapTexto($row, 'clivig_nickname', 30),
            'localidad' => self::mapTexto($row, 'clivig_localidad', 15),
        ];
    }
