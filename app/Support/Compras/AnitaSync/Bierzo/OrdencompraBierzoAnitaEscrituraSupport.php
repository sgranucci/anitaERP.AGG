...
namespace App\Support\Compras\AnitaSync\Bierzo;
...
/**
 * Arma campos/valores SQL ERP → Anita El Bierzo (/usr2/bierzo): solo pendmaep / pendmovp.
 *
 * No incluye columnas AGG (penmp_empresa, penmp_ccosto, penmp_es_anticipo, penmp_usuario_ini,
 * penmp_estado_aprob, penmp_legajo, movpresup, legcompra, etc.).
 */
final class OrdencompraBierzoAnitaEscrituraSupport
{
    /**
