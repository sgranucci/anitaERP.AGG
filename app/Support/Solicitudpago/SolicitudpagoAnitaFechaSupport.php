...
final class SolicitudpagoAnitaFechaSupport
{
    ...
    public static function fechaAlfaDesde(mixed $fecha): string
    {
        $n = self::fechaAnitaDesde($fecha);

        return $n > 0 ? str_pad((string) $n, 8, '0', STR_PAD_LEFT) : '';
    }
}
