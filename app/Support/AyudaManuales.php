...
class AyudaManuales
{
    ...
    public static function catalogo(): array
    {
        return [
            ...
            [
                'modulo' => 'Seguridad — Ingreso de proveedores',
                'bajada' => 'Guía paso a paso: listado de tickets, alta de visita y archivos asociados.',
                'url' => route('guia_paso_a_paso', ['slug' => 'ingreso-proveedores']),
                'icono' => 'fa-id-badge',
                'disponible' => true,
                'etiqueta_boton' => 'Abrir guía paso a paso',
            ],
            [
                'modulo' => 'Seguridad — Autorización y control de ingresos',
                'bajada' => 'Guía paso a paso: pendientes de autorizar, detalle del ticket y entró/salió en portería.',
                'url' => route('guia_paso_a_paso', ['slug' => 'autorizacion-ingresos']),
                'icono' => 'fa-shield-alt',
                'disponible' => true,
                'etiqueta_boton' => 'Abrir guía paso a paso',
            ],
            [
                'modulo' => 'Compras — Bandeja de legajos',
                'bajada' => 'Guía paso a paso: asignar COM a la factura y enviar a Cuentas a pagar o Gastronomía.',
                'url' => route('guia_paso_a_paso', ['slug' => 'bandeja-legajos']),
