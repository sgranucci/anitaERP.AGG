...
/**
 * Filtros del listado de ubicaciones de impresora (index / exportaciones).
 */
class UbicacionImpresoraListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'ubicacion_impresora.id', 'type' => 'entero', 'label' => 'ID'],
        'nombre' => ['column' => 'ubicacion_impresora.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'descripcion' => ['column' => 'ubicacion_impresora.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'ubicacion_impresora.nombre',
        'ubicacion_impresora.descripcion',
    ];
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['ubicacion_impresora.nombre', 'ubicacion_impresora.descripcion'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('ubicacion_impresora.id', (int) $id);
            }
            $textCols = [
                'ubicacion_impresora.nombre',
                'ubicacion_impresora.descripcion',
