...
/**
 * Filtros del listado de numeradores del sistema (index / exportaciones).
 */
class SistemaNumeradorListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'sistema_numerador.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'sistema_numerador.codigo', 'type' => 'texto', 'label' => 'Código'],
        'nombre' => ['column' => 'sistema_numerador.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'modulo' => ['column' => 'sistema_numerador.modulo', 'type' => 'texto', 'label' => 'Módulo'],
        'empresa_id' => ['column' => 'sistema_numerador.empresa_id', 'type' => 'entero', 'label' => 'Empresa ID'],
        'ultimo_numero' => ['column' => 'sistema_numerador.ultimo_numero', 'type' => 'entero', 'label' => 'Último número'],
        'anita_clave' => ['column' => 'sistema_numerador.anita_clave', 'type' => 'texto', 'label' => 'Clave Anita'],
        'observacion' => ['column' => 'sistema_numerador.observacion', 'type' => 'texto', 'label' => 'Observación'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'sistema_numerador.codigo',
        'sistema_numerador.nombre',
        'sistema_numerador.observacion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Configuracion\UbicacionImpresora>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['sistema_numerador.codigo', 'sistema_numerador.nombre', 'sistema_numerador.observacion'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('sistema_numerador.id', (int) $id);
                $q->orWhere('sistema_numerador.empresa_id', (int) $id);
                $q->orWhere('sistema_numerador.ultimo_numero', (int) $id);
            }
            $textCols = [
                'sistema_numerador.codigo',
                'sistema_numerador.nombre',
                'sistema_numerador.modulo',
                'sistema_numerador.anita_clave',
                'sistema_numerador.observacion',
            ];
