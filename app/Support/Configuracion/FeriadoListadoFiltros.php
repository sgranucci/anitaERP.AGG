...
/**
 * Filtros del listado de feriados (index / exportaciones).
 */
class FeriadoListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'feriado.id', 'type' => 'entero', 'label' => 'ID'],
        'nombre' => ['column' => 'feriado.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'fecha' => ['column' => 'feriado.fecha', 'type' => 'texto', 'label' => 'Fecha'],
        'tipo' => ['column' => 'feriado.tipo', 'type' => 'texto', 'label' => 'Tipo'],
    ];
    ...
    /**
     * @param  Builder<\App\Models\Configuracion\Feriado>  $query
     */
