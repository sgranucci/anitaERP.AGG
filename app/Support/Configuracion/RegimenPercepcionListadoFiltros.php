...
/**
 * Filtros del listado de regímenes de percepción.
 */
class RegimenPercepcionListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'regimen_percepcion.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'regimen_percepcion.codigo', 'type' => 'texto', 'label' => 'Código'],
        'nombre' => ['column' => 'regimen_percepcion.nombre', 'type' => 'texto', 'label' => 'Nombre'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'regimen_percepcion.nombre',
        'regimen_percepcion.codigo',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Configuracion\RegimenPercepcion>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('regimen_percepcion.id', (int) $id);
            }
            foreach (self::COLUMNAS_TEXTO_GLOBAL as $col) {
