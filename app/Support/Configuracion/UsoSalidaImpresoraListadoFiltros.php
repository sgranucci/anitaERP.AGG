...
/**
 * Filtros del listado de usos de salida de impresión (index / exportaciones).
 */
class UsoSalidaImpresoraListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'uso_salida_impresora.id', 'type' => 'entero', 'label' => 'ID'],
        'nombre' => ['column' => 'uso_salida_impresora.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'descripcion' => ['column' => 'uso_salida_impresora.descripcion', 'type' => 'texto', 'label' => 'Descripción'],
    ];

    /** @var list<string> */
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'uso_salida_impresora.nombre',
        'uso_salida_impresora.descripcion',
    ];
    ...
    /**
     * @param  Builder<\App\Models\Configuracion\UsoSalidaImpresora>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['uso_salida_impresora.nombre', 'uso_salida_impresora.descripcion'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('uso_salida_impresora.id', (int) $id);
            }
            $textCols = [
                'uso_salida_impresora.nombre',
                'uso_salida_impresora.descripcion',
