...
/**
 * Filtros del listado de recuentos de inventario (index / exportaciones).
 */
class RecuentoListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'recuento.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'recuento.codigo', 'type' => 'texto', 'label' => 'Código'],
        'fecha' => ['column' => 'recuento.fecha', 'type' => 'texto', 'label' => 'Fecha'],
        ...
        'tipo' => ['column' => 'recuento.tipo', 'type' => 'texto', 'label' => 'Tipo'],
        'estado' => ['column' => 'recuento.estado', 'type' => 'texto', 'label' => 'Estado'],
        'comentario' => ['column' => 'recuento.comentario', 'type' => 'texto', 'label' => 'Comentario'],
    ];
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['recuento.codigo', 'recuento.comentario'] as $col) {
