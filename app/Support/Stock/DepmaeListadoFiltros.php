...
/**
 * Filtros del listado de depósitos (index / exportaciones).
 */
class DepmaeListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'depmae.id', 'type' => 'entero', 'label' => 'ID'],
        'codigo' => ['column' => 'depmae.codigo', 'type' => 'texto', 'label' => 'Código ANITA'],
        'nombre' => ['column' => 'depmae.nombre', 'type' => 'texto', 'label' => 'Descripción'],
        'tipodeposito' => ['column' => 'depmae.tipodeposito', 'type' => 'texto', 'label' => 'Tipo de depósito'],
    ...
    /**
     * @param  Builder<\App\Models\Stock\Depmae>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['depmae.codigo', 'depmae.nombre', 'depmae.tipodeposito'] as $col) {
