...
/**
 * Filtros del listado de presupuestos (index).
 */
class PresupuestoListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'presupuesto.id', 'type' => 'entero', 'label' => 'ID'],
        'nombre' => ['column' => 'presupuesto.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'codigo' => ['column' => 'presupuesto.codigo', 'type' => 'texto', 'label' => 'Código'],
        'anio' => ['column' => 'presupuesto.anio', 'type' => 'entero', 'label' => 'Año'],
        'detalle' => ['column' => 'presupuesto.detalle', 'type' => 'texto', 'label' => 'Detalle'],
        'estado' => ['column' => 'presupuesto.estado', 'type' => 'texto', 'label' => 'Estado'],
    ];
    ...
    /**
     * @param  Builder<\App\Models\Presupuesto\Presupuesto>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['presupuesto.nombre', 'presupuesto.codigo', 'presupuesto.detalle'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('presupuesto.id', (int) $id);
                $q->orWhere('presupuesto.anio', (int) $id);
            }
            $textCols = [
                'presupuesto.nombre',
                'presupuesto.codigo',
            ...
            if ($operador === 'contiene') {
                $q->orWhereHas('presupuesto_escenarios', function ($w) use ($valor, $like) {
