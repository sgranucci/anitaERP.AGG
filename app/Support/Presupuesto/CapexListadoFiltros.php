...
/**
 * Filtros del listado de Capex (index / exportaciones).
 */
class CapexListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'capex.id', 'type' => 'entero', 'label' => 'ID'],
        ...
        'nombre' => ['column' => 'capex.nombre', 'type' => 'texto', 'label' => 'Nombre'],
        'detalle' => ['column' => 'capex.detalle', 'type' => 'texto', 'label' => 'Detalle'],
        'codigoproyecto' => ['column' => 'capex.codigoproyecto', 'type' => 'texto', 'label' => 'Código de proyecto'],
        'codigo' => ['column' => 'capex.codigo', 'type' => 'entero', 'label' => 'Nro. de proyecto'],
        'estado' => ['column' => 'capex.estado', 'type' => 'texto', 'label' => 'Estado'],
    ...
    /**
     * @param  Builder<\App\Models\Presupuesto\Capex>  $query
     */
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['capex.nombre', 'capex.detalle', 'capex.codigoproyecto'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('capex.id', (int) $id);
                $q->orWhere('capex.codigo', (int) $id);
            }
            $textCols = [
                'empresa.nombre',
                'presupuesto.nombre',
