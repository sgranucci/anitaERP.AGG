...
namespace App\Support\Presupuesto;
...
/**
 * Filtros del listado de partidas de gasto (index / exportaciones).
 */
class PartidagastoListadoFiltros
{
    ...
    public const CAMPOS = [
        'id' => ['column' => 'partidagasto.id', 'type' => 'entero', 'label' => 'ID'],
        'empresa' => ['column' => 'empresa.nombre', 'type' => 'texto', 'label' => 'Empresa'],
        'presupuesto' => ['column' => 'presupuesto.nombre', 'type' => 'texto', 'label' => 'Presupuesto'],
        'escenario' => ['column' => 'presupuesto_escenario.nombre', 'type' => 'texto', 'label' => 'Escenario'],
        ...
        'codigopartida' => ['column' => 'partidagasto.codigo', 'type' => 'texto', 'label' => 'Partida'],
        'detalle' => ['column' => 'partidagasto.detalle', 'type' => 'texto', 'label' => 'Detalle'],
        'articulo' => ['column' => 'articulo.descripcion', 'type' => 'texto', 'label' => 'Artículo'],
        'proveedor' => ['column' => 'proveedor.nombre', 'type' => 'texto', 'label' => 'Proveedor'],
        'codigocuentacontable' => ['column' => 'cuentacontable.codigo', 'type' => 'texto', 'label' => 'Cuenta contable (código)'],
        'nombrecuentacontable' => ['column' => 'cuentacontable.nombre', 'type' => 'texto', 'label' => 'Cuenta contable (nombre)'],
        'moneda' => ['column' => 'moneda.abreviatura', 'type' => 'texto', 'label' => 'Moneda'],
        'estado' => ['column' => 'partidagasto.estado', 'type' => 'texto', 'label' => 'Estado'],
    ...
    private const COLUMNAS_COINCIDENCIA_FLEXIBLE = [
        'empresa.nombre',
        'presupuesto.nombre',
        'presupuesto_escenario.nombre',
        'centrocosto.nombre',
        'centrocosto.codigo',
        'partidagasto.detalle',
    ...
    /**
     * @param  Builder<\App\Models\Presupuesto\Partidagasto>  $query
     */
    public static function aplicar(Builder $query, array $filtros): void
    {
        ...
        if ($modo === self::MODO_CAMPO) {
            self::aplicarEnCampo($query, $filtros['campo'] ?? 'detalle', $operador, $valor, $filtros['valor_hasta'] ?? '');
    ...
    private static function aplicarBusquedaGlobal(Builder $query, string $operador, string $valor): void
    {
        if ($operador === 'vacio') {
            $query->where(function ($q) {
                foreach (['partidagasto.detalle', 'partidagasto.codigo'] as $col) {
        ...
        $query->where(function ($q) use ($valor, $like, $id, $operador) {
            if ($id !== false) {
                $q->orWhere('partidagasto.id', (int) $id);
            }
            $textCols = [
                'empresa.nombre',
                'presupuesto.nombre',
