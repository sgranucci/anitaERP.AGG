...
final class CierreRendicionMaquinaConfigSupport
{
    ...
    {
        $raw = trim((string) config('rendicion_maquina_anita.cierre_rendicion_contable.correlatividad_desde', ''));
        if ($raw === '') {
            return null;
        }
    ...
    public static function faltantes(array $cfg): array
    {
        $labels = [
            ...
            'cuenta_canon_loteria_id' => 'Canon lotería (521010001)',
            'cuenta_cont_canon_loteria_id' => 'Contrib. canon lotería (215010001)',
            'cuenta_canon_hospital_id' => 'Canon hospital (521010002)',
            'cuenta_cont_canon_hospital_id' => 'Contrib. canon hospital (215010003)',
