(function ($) {
    ...
    $(function () {
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-depmae');
        ...
        $('#form-filtros-depmae').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-depmae').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-depmae'), {
            selectorPanel: '#panel-filtros-depmae'
        });
