(function ($) {
    ...
    function validarAntesDeConsultar() {
        ...
        var checks = $('#form-cc-proveedores-reporte').find('input[name="empresa_ids[]"]:checked');
        var unica = $('#form-cc-proveedores-reporte').find('input[name="empresa_ids[]"][type="hidden"]');
        if (!unica.length && checks.length === 0) {
    ...
    $(function () {
        ...
        $('#form-cc-proveedores-reporte').on('submit', function (e) {
            var btnConsol = this.querySelector('.btn-toggle-consolidar-empresas');
            var inputConsol = this.querySelector('input[name="consolidar_empresas"]');
