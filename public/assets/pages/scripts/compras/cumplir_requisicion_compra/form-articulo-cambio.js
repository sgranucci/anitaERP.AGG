(function ($) {
    ...
    function htmlCeldaArticulo(linea, idx) {
        ...
        html += '<input type="hidden" class="articulo_id_original" value="' + articuloId + '">';
        html += '<div class="input-group input-group-sm">';
        html += '<div class="input-group-prepend">';
        html += '<button type="button" class="btn btn-outline-secondary btn-sm consultaarticulo btn-cambio-articulo-cumple" title="Cambiar art\u00edculo (requiere permiso log\u00edstica)"><i class="fa fa-search"></i></button>';
        html += '</div>';
    ...
    window.crcHtmlCeldaArticuloCumple = htmlCeldaArticulo;
