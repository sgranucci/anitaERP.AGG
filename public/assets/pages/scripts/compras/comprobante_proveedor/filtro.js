(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-comprobante-proveedor').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-comprobante-proveedor');
        ...
        $('#form-filtros-comprobante-proveedor').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-comprobante-proveedor').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-comprobante-proveedor'), {
            selectorPanel: '#panel-filtros-comprobante-proveedor'
        });
