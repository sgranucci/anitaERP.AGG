(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-listaprecio-proveedor').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-listaprecio-proveedor');
        ...
        $('#form-filtros-listaprecio-proveedor').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-listaprecio-proveedor').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-listaprecio-proveedor'), {
            selectorPanel: '#panel-filtros-listaprecio-proveedor'
        });
