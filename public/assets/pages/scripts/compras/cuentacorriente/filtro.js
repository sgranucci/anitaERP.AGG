(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-cuentacorriente-proveedor').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-cuentacorriente-proveedor');
        ...
        $('#form-filtros-cuentacorriente-proveedor').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-cuentacorriente-proveedor').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-cuentacorriente-proveedor'), {
            selectorPanel: '#panel-filtros-cuentacorriente-proveedor'
        });
