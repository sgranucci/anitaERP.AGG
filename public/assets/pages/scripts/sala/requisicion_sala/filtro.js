(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-requisicion-sala').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-requisicion-sala');
        ...
        $('#form-filtros-requisicion-sala').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-requisicion-sala').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-requisicion-sala'), {
            selectorPanel: '#panel-filtros-requisicion-sala'
        });
