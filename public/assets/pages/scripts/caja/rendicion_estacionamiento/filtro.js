(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-rendicion-estacionamiento').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-rendicion-estacionamiento');
        ...
        $('#form-filtros-rendicion-estacionamiento').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-rendicion-estacionamiento').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        if (LF && LF.initSubmitBusquedaRapida) {
            LF.initSubmitBusquedaRapida($('#form-filtros-rendicion-estacionamiento'), {
                selectorPanel: '#panel-filtros-rendicion-estacionamiento'
            });
        }
