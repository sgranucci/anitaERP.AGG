(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-bingo-concepto-rendicion').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-bingo-concepto-rendicion');
        ...
        $('#form-filtros-bingo-concepto-rendicion').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-bingo-concepto-rendicion').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-bingo-concepto-rendicion'), {
            selectorPanel: '#panel-filtros-bingo-concepto-rendicion'
        });
