(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-rendicion-gastronomia').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-rendicion-gastronomia');
        ...
        $('#form-filtros-rendicion-gastronomia').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-rendicion-gastronomia').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        if (LF && LF.initSubmitBusquedaRapida) {
            LF.initSubmitBusquedaRapida($('#form-filtros-rendicion-gastronomia'), {
                selectorPanel: '#panel-filtros-rendicion-gastronomia'
            });
        }
