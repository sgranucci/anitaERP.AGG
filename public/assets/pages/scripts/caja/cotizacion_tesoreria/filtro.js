(function ($) {
    ...
    function actualizarVisibilidad() {
        ...
        if (tipo === 'entero') {
            ...
            setPlaceholderValor('Fecha d/m/Y o año');
        }
    }
    ...
    $(function () {
        if (!$('#form-filtros-cotizacion-tesoreria').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-cotizacion-tesoreria');
        ...
        $('#form-filtros-cotizacion-tesoreria').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-cotizacion-tesoreria').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-cotizacion-tesoreria'), {
            selectorPanel: '#panel-filtros-cotizacion-tesoreria'
        });
