(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-perdida-personal').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-perdida-personal');
        ...
        $('#form-filtros-perdida-personal').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-perdida-personal').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-perdida-personal'), {
            selectorPanel: '#panel-filtros-perdida-personal'
        });
