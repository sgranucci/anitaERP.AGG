(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-estacionamiento-item').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-estacionamiento-item');
        ...
        $('#form-filtros-estacionamiento-item').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-estacionamiento-item').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-estacionamiento-item'), {
            selectorPanel: '#panel-filtros-estacionamiento-item'
        });
