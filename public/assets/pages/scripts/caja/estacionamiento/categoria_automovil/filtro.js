(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-estacionamiento-categoria-automovil').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-estacionamiento-categoria-automovil');
        ...
        $('#form-filtros-estacionamiento-categoria-automovil').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-estacionamiento-categoria-automovil').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-estacionamiento-categoria-automovil'), {
            selectorPanel: '#panel-filtros-estacionamiento-categoria-automovil'
        });
