(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-tipotransaccion-caja').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-tipotransaccion-caja');
        ...
        $('#form-filtros-tipotransaccion-caja').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-tipotransaccion-caja').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-tipotransaccion-caja'), {
            selectorPanel: '#panel-filtros-tipotransaccion-caja'
        });
