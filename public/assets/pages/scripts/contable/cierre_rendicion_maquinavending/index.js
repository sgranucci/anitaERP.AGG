(function () {
    ...
    var cfg = window.CIERRE_REND_VENDING || {};
    ...
    function abrirPreviewGrupo(grupo) {
        ...
        fetch(cfg.urlPreview, {
            ...
            .then(function (data) {
                ...
                $('#modal-preview-asiento-cierre-rend-vending').modal('show');
            })
            .catch(function () {
    ...
    function ejecutarCierre() {
        ...
        fetch(cfg.urlEjecutar, {
            ...
            .then(function (data) {
                ...
                $('#modal-preview-asiento-cierre-rend-vending').modal('hide');
    ...
    function ejecutarCierreRango() {
        ...
        fetch(cfg.urlEjecutarRango, {
            ...
            .then(function (data) {
                ...
                alert(msg);
                $('#modal-cierre-rango-rend-vending').modal('hide');
                window.location.reload();
            })
            .catch(function () {
