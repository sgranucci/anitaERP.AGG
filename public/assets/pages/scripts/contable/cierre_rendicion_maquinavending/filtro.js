(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-cierre-rend-vending').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-cierre-rend-vending');
        ...
        $('#form-filtros-cierre-rend-vending').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-cierre-rend-vending').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        if (LF && LF.initSubmitBusquedaRapida) {
            LF.initSubmitBusquedaRapida($('#form-filtros-cierre-rend-vending'), {
                selectorPanel: '#panel-filtros-cierre-rend-vending'
            });
        }
