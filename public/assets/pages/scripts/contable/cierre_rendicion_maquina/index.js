(function () {
    ...
    function mostrarPreview(preview) {
        ...
        document.getElementById('modal-preview-asiento-titulo').textContent = preview.titulo || 'Preview cierre máquinas';
        ...
        var infoFbi = document.getElementById('modal-preview-fsl-info');
        if (infoFbi) {
            var monto = preview.fsl_monto || 0;
            if (monto > 0) {
                infoFbi.textContent = 'Se emitirá FSL B (100% exento) en ventas ERP por $ '
                    + formatoNumero(monto) + ' (PV ' + (preview.puntoventa_fsl || '') + ').';
    ...
    function abrirPreviewGrupo(grupo) {
        ...
        fetch(cfg.urlPreview, {
            ...
            .then(function (data) {
                ...
                $('#modal-preview-asiento-cierre-rend-maquina').modal('show');
            })
            .catch(function () {
    ...
    function ejecutarCierre() {
        ...
        fetch(cfg.urlEjecutar, {
            ...
            .then(function (data) {
                ...
                $('#modal-preview-asiento-cierre-rend-maquina').modal('hide');
    ...
    function mostrarPreviewRango(preview) {
        ...
        (preview.grupos || []).forEach(function (g, idx) {
            var detalleId = 'rango-detalle-maquina-' + idx;
    ...
    function ejecutarCierreRango() {
        ...
        fetch(cfg.urlEjecutarRango, {
            ...
            .then(function (data) {
                ...
                alert(msg);
                $('#modal-cierre-rango-rend-maquina').modal('hide');
                window.location.reload();
            })
            .catch(function () {
                rangoEjecutando = false;
    ...
    window.CIERRE_REND_abrirRangoDesdePendientes = function (empresaId, desde, hasta) {
        ...
        setBotonEjecutarRango(false);
        limpiarPreviewRango();
        $('#modal-cierre-rango-rend-maquina').modal('show');
        previewCierreRango();
    };
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var btnConfirmar = document.getElementById('btn-confirmar-cierre-rend-maquina');
        if (btnConfirmar) {
