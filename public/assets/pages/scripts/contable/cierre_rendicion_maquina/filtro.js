(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-cierre-rend-maquina').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-cierre-rend-maquina');
        ...
        $('#form-filtros-cierre-rend-maquina').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-cierre-rend-maquina').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        if (LF && LF.initSubmitBusquedaRapida) {
            LF.initSubmitBusquedaRapida($('#form-filtros-cierre-rend-maquina'), {
                selectorPanel: '#panel-filtros-cierre-rend-maquina'
            });
        }
