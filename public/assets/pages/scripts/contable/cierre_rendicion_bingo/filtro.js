(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-cierre-rend-bingo').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-cierre-rend-bingo');
        ...
        $('#form-filtros-cierre-rend-bingo').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-cierre-rend-bingo').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        if (LF && LF.initSubmitBusquedaRapida) {
            LF.initSubmitBusquedaRapida($('#form-filtros-cierre-rend-bingo'), {
                selectorPanel: '#panel-filtros-cierre-rend-bingo'
            });
        }
