(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-sindicato-sueldos').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-sindicato-sueldos');
        ...
        $('#form-filtros-sindicato-sueldos').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-sindicato-sueldos').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-sindicato-sueldos'), {
            selectorPanel: '#panel-filtros-sindicato-sueldos'
        });
