(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-ganancia-linea-sueldos').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-ganancia-linea-sueldos');
        ...
        $('#form-filtros-ganancia-linea-sueldos').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-ganancia-linea-sueldos').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-ganancia-linea-sueldos'), {
            selectorPanel: '#panel-filtros-ganancia-linea-sueldos'
        });
