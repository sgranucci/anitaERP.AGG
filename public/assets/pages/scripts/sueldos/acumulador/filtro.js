(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-acumulador-sueldos').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-acumulador-sueldos');
        ...
        $('#form-filtros-acumulador-sueldos').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-acumulador-sueldos').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-acumulador-sueldos'), {
            selectorPanel: '#panel-filtros-acumulador-sueldos'
        });
