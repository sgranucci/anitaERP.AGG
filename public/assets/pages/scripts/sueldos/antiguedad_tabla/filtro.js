(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-antiguedad-tabla-sueldos').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-antiguedad-tabla-sueldos');
        ...
        $('#form-filtros-antiguedad-tabla-sueldos').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-antiguedad-tabla-sueldos').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-antiguedad-tabla-sueldos'), {
            selectorPanel: '#panel-filtros-antiguedad-tabla-sueldos'
        });
