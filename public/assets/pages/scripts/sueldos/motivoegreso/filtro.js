(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-motivoegreso-sueldos').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-motivoegreso-sueldos');
        ...
        $('#form-filtros-motivoegreso-sueldos').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-motivoegreso-sueldos').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-motivoegreso-sueldos'), {
            selectorPanel: '#panel-filtros-motivoegreso-sueldos'
        });
