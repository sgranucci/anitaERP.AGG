(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-sistema-numerador').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-sistema-numerador');
        ...
        $('#form-filtros-sistema-numerador').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-sistema-numerador').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-sistema-numerador'), {
            selectorPanel: '#panel-filtros-sistema-numerador'
        });
