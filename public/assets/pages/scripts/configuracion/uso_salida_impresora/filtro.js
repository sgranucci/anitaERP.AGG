(function ($) {
    ...
    $(function () {
        if (!$('#form-filtros-uso-salida-impresora').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-uso-salida-impresora');
        ...
        $('#form-filtros-uso-salida-impresora').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-uso-salida-impresora').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-uso-salida-impresora'), {
            selectorPanel: '#panel-filtros-uso-salida-impresora'
        });
