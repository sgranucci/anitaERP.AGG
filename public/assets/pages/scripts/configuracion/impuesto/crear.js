    ...
    function agregaRenglonCuentacontable(event){
    	...
    	let renglon = $('#template-renglon-cuentacontable-impuesto').html();

		$("#tbody-cuentacontable-impuesto-table").append(renglon);
    ...
    function actualizaRenglonesCuentacontable() {
    	...
    	$("#tbody-cuentacontable-impuesto-table .iicuenta").each(function() {
    		$(this).val(item++);
    	});
    }
