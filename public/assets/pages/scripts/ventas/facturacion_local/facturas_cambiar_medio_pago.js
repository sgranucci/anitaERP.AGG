...
(function () {
    ...
    function apiBase() {
        return (typeof carpetaBase !== 'undefined' ? carpetaBase : '') + '/ventas/facturacion-local/facturas';
    }
    ...
    function abrirConsultaCuentacaja(tr) {
        ...
        window.FACTURACION_LOCAL.empresaId = empresaId;
        window.FACTURACION_LOCAL.usocuentacajaLocalId = datosCarga
            ? parseInt(datosCarga.usocuentacaja_local_id, 10) || 0
            : 0;
