...
function empacarPedido(item)
{
    ...
    // Controla secuencia
    var listarUri = carpetaBase+"/produccion/ctrlsecuencia/"+codigoordentrabajo+"/"+operacion_id+"/"+tareaEmpaque+"/"+pedido_combinacion_id;
    ...
    $.get(listarUri, function(data){
        ...
        {
            $.post(carpetaBase+"/produccion/empacarTarea",
            {
                pedido: pedido,
...
$('#aceptaModal').on('click', function () {
    ...
    setTimeout(() => {
        ...
        var token = $('#csrf_token').val();
        $.post(carpetaBase+"/ventas/actualizarpedido",
                  {
                    pedido_combinacion_id: pedido_combinacion_id,
                    ordentrabajo_id: ordentrabajo_id,
...
function completarTareas(ordentrabajo_id)
{
    ...
    // Lee tareas
    $.get(carpetaBase+'/produccion/leerTareas/'+ordentrabajo_id, function(data){
