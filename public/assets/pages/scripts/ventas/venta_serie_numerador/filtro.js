(function ($) {
    ...
    function actualizarVisibilidad() {
        ...
        if (tipo === 'entero') {
            ...
            setPlaceholderValor('Texto o tipo ARCA');
        }
    }
    ...
    $(function () {
        if (!$('#form-filtros-venta-serie-numerador').length) {
            return;
        }
        ...
        function sincronizarValorAntesDeEnviar() {
            var $panel = $('#panel-filtros-venta-serie-numerador');
        ...
        $('#form-filtros-venta-serie-numerador').on('click', '[data-aplicar-filtros-panel]', function () {
            $valorPrincipal().val($valorPanel().val());
        });

        $('#form-filtros-venta-serie-numerador').on('submit.listadoFiltrosSync', function () {
            sincronizarValorAntesDeEnviar();
        });

        LF.initSubmitBusquedaRapida($('#form-filtros-venta-serie-numerador'), {
            selectorPanel: '#panel-filtros-venta-serie-numerador'
        });
