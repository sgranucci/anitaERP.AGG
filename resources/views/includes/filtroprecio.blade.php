            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form method='get' action=''>
                                ...
                                <div class='row-filter-combo row'>
                                    ...
                                    <div class='col-sm-5'>
										<select id="estado" name="filter_column[0][value]" class="filter-value form-control">
                                			...
                                			<option value="F">Facturables</option>    
                                			<option value="N">No facturables</option>    
                        ...
                        <input type="hidden" name="fecha_vigencia" value="{{ $fechaVigenciaFiltro ?? date('Y-m-d') }}">
                        <input type="hidden" name="listaprecio_id" value="{{ ($listaprecioIdFiltro ?? null) !== null ? $listaprecioIdFiltro : '' }}">
