...
<div class="mc-shell">
    ...
    <div class="mc-main">
        <header class="mc-topbar">
            ...
            <a href="{{ route('consulta_cliente_uif') }}" class="mc-btn">Clientes</a>
            <a href="{{ route('consulta_cliente_premio_uif') }}" class="mc-btn">Premios</a>
            <a href="{{ route('crear_exporta_operacion') }}" class="mc-btn">Informe</a>
            <button type="button" id="mc-theme-toggle" class="mc-btn" title="Cambiar tema">Tema</button>
            <a href="{{ route('manual_uif_pdf') }}" class="mc-btn" target="_blank" rel="noopener">PDF</a>
            <a href="{{ route('manual_uif_word') }}" class="mc-btn" target="_blank" rel="noopener">Word</a>
        </header>
            ...
            @foreach ($meta['secciones'] as $i => $sec)
                <article id="cap-{{ $i }}" class="mc-chapter">
                    ...
                    @include('manual.partials.capturas-seccion', [
                        'sec' => $sec,
                        'configKey' => 'manual_uif',
                        'imgPublicPrefix' => 'docs/manual-uif/img',
                    ])
