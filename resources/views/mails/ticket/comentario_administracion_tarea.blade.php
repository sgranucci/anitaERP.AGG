...
<body style="font-family: Arial, sans-serif; color:#222;">
    <p>Hola{{ optional($ticket->usuarios)->nombre ? ' '.$ticket->usuarios->nombre : '' }},</p>

    <p>
        <strong>{{ $autor->nombre ?? $autor->usuario }}</strong>
        agregó un comentario en su ticket <strong>#{{ $ticket->id }}</strong>
    ...
    @if (! empty($urlTicket))
        <p style="margin-top:18px;">
            <a href="{{ $urlTicket }}">Ver su ticket</a>
        </p>
    @endif
</body>
</html>
