...
<head>
    ...
    <title>Aprobación @if(isset($datosComprobante->numeroordenventa)) OV {{ $datosComprobante->numeroordenventa }} @elseif(isset($datosComprobante->numerorequisicion)) REQ {{ $datosComprobante->numerorequisicion }} @endif</title>
</head>
<body>
