@php
    ...
    $f = $filtros ?? [];
    $modo = $f['modo'] ?? FlashCajaListadoFiltros::MODO_TODOS;
        ...
        <div class="form-row align-items-end">
            ...
            <div class="form-group col-md-2 col-sm-6 mb-2">
                ...
                <select name="filtro_modo" id="filtro_modo" class="form-control form-control-sm">
                    <option value="{{ FlashCajaListadoFiltros::MODO_TODOS }}" {{ $modo === FlashCajaListadoFiltros::MODO_TODOS ? 'selected' : '' }}>Cualquier campo</option>
                    <option value="{{ FlashCajaListadoFiltros::MODO_CAMPO }}" {{ $modo === FlashCajaListadoFiltros::MODO_CAMPO ? 'selected' : '' }}>Campo determinado</option>
                </select>
            </div>
            <div class="form-group col-md-2 col-sm-6 mb-2 filtro-campo-wrap" style="{{ $modo !== FlashCajaListadoFiltros::MODO_CAMPO ? 'display:none' : '' }}">
                ...
                <select name="filtro_campo" id="filtro_campo" class="form-control form-control-sm">
                    @foreach($camposFiltro ?? FlashCajaListadoFiltros::CAMPOS as $key => $meta)
            ...
            <div class="form-group col-md-2 col-sm-6 mb-2">
                ...
                <select name="filtro_operador" id="filtro_operador" class="form-control form-control-sm"
                    ...
                    @foreach(FlashCajaListadoFiltros::operadoresParaCampo($modo === FlashCajaListadoFiltros::MODO_CAMPO ? $campoActivo : 'fecha') as $opKey => $opLabel)
            ...
            <div class="form-group col-md-3 col-sm-6 mb-2">
                ...
                <input type="text"
                       ...
                       value="{{ $f['valor'] ?? '' }}"
                       placeholder="Fecha, empresa o comentario"
                       autocomplete="off">
            </div>
