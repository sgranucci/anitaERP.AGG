    ...
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Crear flash diario</h3>
            ...
            <form action="{{ route('guardar_flash_caja', $filtrosQuery ?? []) }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
