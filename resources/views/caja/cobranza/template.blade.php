<template id="template-renglon-comprobante">
    <tr class="item-comprobante">
        ...
        <td class="cob-col-aplicar">
            <input type="number" name="montoaplicadocomprobantes[]" class="form-control montoaplicadocomprobante cob-monto-aplicar" value="">
        </td>
        <td>
        ...
        <td class="cob-col-acciones align-middle">
            <div class="cob-acciones">
                @if (can('editar-factura', false))
                    <a href="" target="_blank" rel="noopener noreferrer" class="btn-accion-tabla editarfactura tooltipsC" title="Editar factura">
                ...
                @if (can('generar-nota-de-credito', false))
                    <a href="" target="_blank" rel="noopener noreferrer" class="btn-accion-tabla generarnotadecredito tooltipsC" title="Generar nota de cr&eacute;dito">
                        <i class="fa fa-undo text-danger"></i>
                    </a>
                @endif
                @if (can('listar-factura', false))
                    <a href="" target="_blank" rel="noopener noreferrer" class="btn-accion-tabla listarfactura tooltipsC" title="Imprimir comprobante">
