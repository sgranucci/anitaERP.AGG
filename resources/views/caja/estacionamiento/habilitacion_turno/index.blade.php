...
@section('titulo')
    Habilitación y cierres de turno estacionamiento
@endsection

@section("scripts")
<style>
    .est-totales-panel { font-size: 1rem; }
    .est-totales-monto { font-size: 1.2rem; line-height: 1.3; }
    .est-totales-leyenda { font-size: 0.95rem !important; }
    .est-totales-tabla { font-size: 0.95rem; }
    .est-totales-tabla th,
    .est-totales-tabla td { padding: 0.45rem 0.6rem; vertical-align: middle; }
    .est-item-nombre { font-size: 1.05rem; }
    .est-turno-resumen-wrap { font-size: 1rem; }
    .est-turno-resumen-wrap strong { font-size: 1.05rem; }
    #panel-estado-turno .est-totales-bloque { box-shadow: none; }
    ...
    .est-medio-conciliar { cursor: pointer; text-decoration: underline dotted; }
    .est-tab-cierres {
    ...
    .est-tab-cierres .nav-item { margin-bottom: -2px; }
    .est-tab-cierres .nav-link {
        font-weight: 600;
        font-size: 0.95rem;
    ...
    .est-tab-cierres .nav-link:hover:not(.active) {
        color: #343a40;
        background: rgba(255, 255, 255, 0.85);
    }
    .est-tab-cierres .nav-link:not(.active) .fa { opacity: 0.55; }
    .est-tab-cierres .nav-link .fa { margin-right: 0.45rem; }
    .est-tab-cierres #tab-parcial-link.active {
        color: #664d03;
        background: #fff3cd;
    ...
    .est-tab-cierres #tab-parcial-link.active .fa {
        color: #856404 !important;
        opacity: 1;
    }
    .est-tab-cierres #tab-definitivo-link.active {
        color: #58151c;
        background: #f8d7da;
    ...
    .est-tab-cierres #tab-definitivo-link.active .fa {
    ...
    .est-cierre-fila-efectivo { background: #f0f9ff !important; }
    .est-cierre-fila-efectivo td:first-child { border-left: 3px solid #17a2b8; }
    .est-rendicion-esperado-efectivo { color: #0c5460; }
    .est-campo-auto-actualizado {
        background-color: #fff3cd !important;
        transition: background-color 0.3s ease;
    }
</style>
<script>
    window.HABILITACION_TURNO_ESTACIONAMIENTO = {
        csrf: @json(csrf_token()),
        modoCajaDirecto: @json($modo_caja_directo ?? false),
        accion: @json($accion ?? ''),
        urlFacturaVerBase: @json($url_factura_ver_base ?? url('caja/estacionamiento/facturas-dia')),
...
<div class="row" id="habilitacion-turno-app"
     data-api-estado="{{ url('caja/estacionamiento/habilitacion-turno/api/estado') }}"
     data-api-habilitar="{{ url('caja/estacionamiento/habilitacion-turno/api/habilitar') }}"
     data-api-actualizar-monto-habilitacion="{{ route('estacionamiento_habilitacion_turno_api_actualizar_monto_habilitacion') }}"
     data-api-cierre-parcial="{{ url('caja/estacionamiento/habilitacion-turno/api/cierre-parcial') }}"
     data-api-cerrar="{{ url('caja/estacionamiento/habilitacion-turno/api/cerrar') }}"
     data-api-anular-cierre="{{ route('estacionamiento_habilitacion_turno_api_anular_cierre') }}"
     data-api-conciliacion-turno="{{ url('caja/estacionamiento/habilitacion-turno/api/conciliacion-turno') }}"
     data-api-conciliacion-medio="{{ url('caja/estacionamiento/habilitacion-turno/api/conciliacion-medio') }}"
     data-api-conciliacion-notas-credito="{{ url('caja/estacionamiento/habilitacion-turno/api/conciliacion-notas-credito') }}"
     data-api-conciliacion-invitaciones="{{ url('caja/estacionamiento/habilitacion-turno/api/conciliacion-invitaciones') }}"
    ...
    <div class="col-lg-12">
        ...
        @if ($modo_caja_directo ?? false)
            <div class="alert alert-info">
                ...
                (<code>ESTACIONAMIENTO_REQUIERE_HABILITACION_TURNO=false</code>).
                No se utiliza habilitación ni cierre de turno por terminal.
            </div>
        @elseif (! $cfg)
            @include('caja.estacionamiento.habilitacion_turno.partials.filtro_empresa', [
            ...
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex flex-wrap align-items-center" style="gap: 4px;">
                        ...
                        @endif
                        <a href="{{ route('estacionamiento_cierres_turno') }}" class="btn btn-light btn-sm border-dark text-dark">
                ...
                <div class="card-body">
                    ...
                    @if (empty($jornada['jornada_abierta']))
                        <div class="alert alert-danger">
                            Debe abrir la <a href="{{ route('estacionamiento_jornada', ['empresa_id' => $empresa_id ?? $cfg->empresa_id]) }}">jornada</a> antes de habilitar un turno.
                        </div>
                    @endif
                        ...
                        <div class="card card-outline card-success mb-3" id="card-habilitar">
                            ...
                            <div class="card-body">
                                <form id="form-habilitar-turno" autocomplete="off">
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <label for="turno_estacionamiento_id" class="requerido">Turno</label>
                                        <select name="turno_estacionamiento_id" id="turno_estacionamiento_id" class="form-control" required>
                    ...
                    <div id="wrap-solapas-cierre" class="d-none">
                        <ul class="nav nav-tabs est-tab-cierres mb-0" id="tabs-cierre-turno" role="tablist">
                            <li class="nav-item">
                                ...
                                @if ($puede_cierre_parcial ?? false)
                                    ...
                                    <div class="card card-outline card-primary mb-3" id="card-conciliacion-parcial">
                                        ...
                                        <div class="card-body py-2">
                                            ...
                                            <div id="grilla-conciliacion-parcial" class="est-grilla-conciliacion-wrap">
                            ...
                            <div class="tab-pane fade" id="tab-cierre-definitivo" role="tabpanel">
                                ...
                                <div class="card card-outline card-primary mb-3" id="card-conciliacion-turno">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="grilla-conciliacion-turno" class="est-grilla-conciliacion-wrap">
                                            <p class="text-muted p-3 mb-0 small"><i class="fa fa-spinner fa-spin"></i> Cargando resumen…</p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <div class="table-responsive">
                    <table class="table table-sm table-striped mb-0 est-totales-tabla">
