...
@section('titulo')
    Saneamiento turnos estacionamiento
@endsection

@section("scripts")
<script>
    window.SANEAMIENTO_TURNO_ESTACIONAMIENTO = {
...
<script src="{{ asset('assets/pages/scripts/caja/estacionamiento/saneamiento_turno.js') }}?v={{ filemtime(public_path('assets/pages/scripts/caja/estacionamiento/saneamiento_turno.js')) }}" type="text/javascript"></script>
@endsection

@section('contenido')
<div class="row" id="saneamiento-turno-app"
     data-api-diagnostico="{{ route('estacionamiento_saneamiento_turno_api_diagnostico') }}"
     data-api-extender="{{ route('estacionamiento_saneamiento_turno_api_extender_cierre') }}"
     data-api-retroactivo="{{ route('estacionamiento_saneamiento_turno_api_crear_retroactivo') }}"
     data-api-recalcular="{{ route('estacionamiento_saneamiento_turno_api_recalcular_totales') }}"
     data-api-cerrar-cuentas="{{ route('estacionamiento_saneamiento_turno_api_cerrar_cuentas') }}"
     data-api-anular-tickets="{{ route('estacionamiento_saneamiento_turno_api_anular_tickets') }}"
     data-api-cerrar-turno-remoto="{{ route('estacionamiento_saneamiento_turno_api_cerrar_turno_remoto') }}"
     data-url-informe-pdf="{{ route('estacionamiento_saneamiento_turno_informe_pdf') }}"
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    @if (! ($puede_ejecutar ?? false))
                        ...
                        <em>Ejecutar saneamiento turno estacionamiento</em>.
                    @endif
                </div>

                <form method="get" action="{{ route('estacionamiento_saneamiento_turno') }}" class="form-inline mb-4" id="form-filtro-saneamiento">
