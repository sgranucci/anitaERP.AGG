...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        ...
        <small class="form-text text-muted">Corresponde a dto_codigo en Anita.</small>
    </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-lg-8 d-flex align-items-center flex-wrap">
        ...
        <small class="form-text text-muted w-100">Cliente al que se aplica el descuento o invitación. Distinto del cliente de facturación.</small>
    </div>
</div>
