...
<body>
    ...
    @include('caja.estacionamiento.cierres_turno.partials.numeracion_fiscal_turno', ['d' => $d])
    ...
    <p class="muted" style="margin-top:16px;">Documento generado por Anita ERP — Estnomía. Uso interno.</p>
</body>
</html>
