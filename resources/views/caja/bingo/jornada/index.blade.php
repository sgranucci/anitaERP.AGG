...
@section("scripts")
<script src="{{ asset('assets/pages/scripts/caja/bingo/jornada.js') }}?v={{ filemtime(public_path('assets/pages/scripts/caja/bingo/jornada.js')) }}" type="text/javascript"></script>
@endsection

@section('contenido')
<div class="row" id="jornada-bingo-app"
     data-api-estado="{{ url('caja/bingo/jornada/api/estado') }}"
     data-api-abrir="{{ url('caja/bingo/jornada/api/abrir') }}"
     data-api-cerrar="{{ url('caja/bingo/jornada/api/cerrar') }}"
     data-api-eliminar="{{ url('caja/bingo/jornada/api/eliminar') }}"
     data-api-anular-cierre="{{ route('bingo_jornada_api_anular_cierre') }}"
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Apertura y cierre de jornada — Bingo</h3>
            </div>
            <div class="card-body">
                <p class="text-muted mb-3">
                    La <strong>fecha de jornada</strong> agrupa los turnos operativos del bingo en caja
                    y se usará al presentar la rendición en Anita (<code>rendbingo</code>).
                </p>

                <form method="get" action="{{ url('caja/bingo/jornada') }}" class="form-inline mb-4" id="form-empresa-jornada-bingo">
                    ...
                    <div id="jornada-estado-panel" class="mb-4">
                        @if ($estado['jornada_abierta'])
                            <div class="alert alert-success">
                                ...
                                @if (! empty($estado['fecha_factura_hoy_fmt']))
                                    · Hoy: <span id="lbl-fecha-factura">{{ $estado['fecha_factura_hoy_fmt'] ?? $estado['fecha_factura_hoy'] }}</span>
                                @endif
                        ...
                        @else
                            <div class="alert alert-warning">
                                ...
                                No hay jornada abierta. Debe abrirla antes de habilitar turnos en caja.
                            </div>
                        @endif
                    </div>
                                    ...
                                    <div class="card-body">
                                        @if (! empty($estado['errores_cierre']))
                                            ...
                                            @if ($mostrarLinkSaneamiento)
                                                <div class="mb-2">
                                                    <a href="{{ $url_saneamiento_turno ?? url('caja/bingo/saneamiento-turno') }}?empresa_id={{ $empresa_id }}"
