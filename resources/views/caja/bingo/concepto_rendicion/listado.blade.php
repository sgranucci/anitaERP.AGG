...
<head>
	...
	<title>Conceptos de rendici&oacute;n de bingo</title>
	<style>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado de conceptos de rendici&oacute;n de bingo</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 6%;">Signo</th>
				<th style="width: 10%;">Porcentaje</th>
				<th style="width: 22%;">Base c&aacute;lculo</th>
