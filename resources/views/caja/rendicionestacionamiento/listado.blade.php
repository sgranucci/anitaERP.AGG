    ...
    <table class="listado-header">
        <tr>
            ...
            <td style="width: 47%; text-align: center;">
                <h2 style="margin: 0; font-size: 14px; font-weight: bold;">Rendiciones estacionamiento — caja</h2>
...
<table class="data">
    @if ($esExcel)
        ...
        <tbody>
            <tr>
                <td colspan="{{ $colspan }}"><strong style="font-size: 16pt;">Rendiciones estacionamiento — caja</strong></td>
            </tr>
            <tr>
