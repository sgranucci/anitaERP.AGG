    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="consultacierreModalLabel">Cierres de turno pendientes de rendir</h5>
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs mb-3" id="consultacierre-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="consultacierre-tab-busqueda" data-toggle="tab"
                           href="#consultacierre-panel-busqueda" role="tab" aria-controls="consultacierre-panel-busqueda"
                           aria-selected="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="consultacierre-tab-pdf" data-toggle="tab"
                           href="#consultacierre-panel-pdf" role="tab" aria-controls="consultacierre-panel-pdf"
                           aria-selected="false">
                ...
                <div class="tab-content" id="consultacierre-tab-content">
                    <div class="tab-pane fade show active" id="consultacierre-panel-busqueda" role="tabpanel"
                         aria-labelledby="consultacierre-tab-busqueda">
                        ...
                        <table class="table table-striped table-bordered table-hover table-sm mb-0" id="tabla-data-cierre">
                            <thead>
                                <tr>
                                    <th>Nº op.</th>
                                    <th>Turno</th>
                    ...
                    <div class="tab-pane fade" id="consultacierre-panel-pdf" role="tabpanel"
                         aria-labelledby="consultacierre-tab-pdf">
                        <div class="d-flex flex-wrap justify-content-between align-items-center mb-2">
                            <span id="consultacierre-pdf-titulo" class="small text-muted">Seleccione «Ver PDF» en un cierre de la búsqueda.</span>
