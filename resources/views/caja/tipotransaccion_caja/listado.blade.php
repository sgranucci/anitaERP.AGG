...
<head>
    ...
    <title>Tipos de transacciones de caja</title>
    <style>
    ...
    <table class="listado-header">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado de tipos de transacciones de caja</h2>
    ...
    <table class="data">
        <thead>
            <tr>
                ...
                <th style="width: 22%;">Operaci&oacute;n</th>
                <th style="width: 12%;">Abreviatura</th>
                <th style="width: 15%;">Signo</th>
