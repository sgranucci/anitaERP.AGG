...
<div class="row">
    <div class="col-lg-12">
        <div class="anita-arbol">
            ...
            <div class="anita-arbol-hero">
                <div class="anita-arbol-hero-row">
                    <div>
                        ...
                        <h1 class="anita-arbol-title">Editar árbol</h1>
                        <p class="anita-arbol-sub">{{ $data->nombre ?? '' }} · {{ $data->tipoarbol ?? '' }}@if(!empty($data->empresas->nombre)) · {{ $data->empresas->nombre }}@endif</p>
                    </div>
            ...
            <form action="{{ route('actualiza_arbolaprobacion', ['id' => $data->id]) }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
