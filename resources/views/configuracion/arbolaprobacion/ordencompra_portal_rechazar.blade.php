...
@section('titulo_pagina', 'Rechazar orden de compra '.$ordencompra->numeroordencompra)

@section('content')
@include('configuracion.arbolaprobacion.partials.ordencompra_portal_resumen', ['modoPortal' => 'rechazo'])
