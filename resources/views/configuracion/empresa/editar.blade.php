        ...
        <div class="card card-danger">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('empresa')}}" class="btn btn-outline-info btn-sm">
                        <i class="fa fa-fw fa-reply-all"></i> Volver al listado
                    </a>
                </div>
            </div>
            <form action="{{route('actualizar_empresa', ['id' => $data->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="card-body">
                    @include('configuracion.empresa.form')
                </div>
