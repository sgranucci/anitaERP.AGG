    ...
    <div class="col-lg-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Crear régimen de percepción</h3>
            ...
            <form action="{{ route('guardar_regimen_percepcion', $filtrosQuery ?? []) }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
