<div class="card form2" style="display: none">
    <div class="card-body">
    	<table class="table" id="cuentacontable-impuesto-table">
    		<thead>
    			<tr>
					<th>Empresa</th>
    		...
    		<tbody id="tbody-cuentacontable-impuesto-table">
		 		@if ($data->impuesto_cuentacontables ?? '') 
				@if (count($data->impuesto_cuentacontables) > 0)
					@foreach (old('tasa', $data->impuesto_cuentacontables->count() ? $data->impuesto_cuentacontables : ['']) as $cuentacontable)
            			<tr class="item-cuentacontable-impuesto">
							<td>
		...
		@include('configuracion.impuesto.template2')
        <div class="row">
        	<div class="col-md-12">
