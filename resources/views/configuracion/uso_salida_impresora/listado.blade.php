...
<head>
	...
	<title>Ubicaciones de impresora</title>
	<style>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado de usos de salida de impresión</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 30%;">Programas destino</th>
