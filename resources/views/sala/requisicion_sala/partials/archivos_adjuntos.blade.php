        ...
        @foreach ($archivosList as $arch)
            @php
                ...
                $urlInline = \App\Support\Archivos\ArchivoAdjuntoCacheSupport::conVersion(
                    ...
                    public_path('storage/archivos/requisiciones_sala/'.$data->id.'/'.basename($safeName))
                );
                $esImagen = in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'webp'], true);
                $esPdf = $ext === 'pdf';
            @endphp
            <div class="col-md-6 col-lg-4 mb-3 requisicion-sala-archivo-item">
                <div class="card card-outline card-secondary h-100 mb-0">
                    <div class="card-body p-2 d-flex flex-column">
                        ...
                        <div class="mt-auto pt-1">
                            ...
                            <a href="{{ $urlInline }}" class="btn btn-sm btn-outline-secondary ml-1" target="_blank" rel="noopener noreferrer" title="Abrir en nueva pesta&ntilde;a">
                        ...
                        @if (! $ocultarInputsConservar)
                            ...
                            <button type="button" class="btn btn-sm btn-outline-danger mt-2 eliminar-archivo-requisicion-sala" title="Quitar de la lista; se elimina al guardar">
