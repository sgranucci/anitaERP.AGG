...
<head>
	...
	<title>Gestiones de compra</title>
	<style>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 18px; font-weight: bold;">Listado de gestiones de compra</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 16%;">C&oacute;d. interno SIFAB</th>
				<th style="width: 16%;">C&oacute;digo</th>
				<th style="width: 48%;">Nombre</th>
				<th style="width: 12%;">Habilitado</th>
			</tr>
		</thead>
		<tbody>
