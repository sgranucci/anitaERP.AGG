<div class="form-group row">
	...
	<div class="col-lg-3">
		<input type="text" name="fechavigencia" id="fechavigencia" class="form-control" value="{{ old('fechavigencia', date('d-m-Y')) }}" required/>
	</div>
</div>
<div class="form-group row">
...
<div class="form-group row">
	...
	<div class="col-lg-8">
		...
		<small class="form-text text-muted">Columnas L_ por lista. Combinación 0 = precio genérico; un nro. de combinación = excepción de color.</small>
	</div>
</div>
