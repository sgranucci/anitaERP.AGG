@php
    $archivosList = isset($producto) && $producto && ($producto->articulo_archivos ?? null)
        ? $producto->articulo_archivos
        : collect();
...
@if ($archivosList->count())
    <div class="articulo-archivos-preview row">
        @foreach ($archivosList as $arch)
            @php
                ...
                $esPdf = $ext === 'pdf';
            @endphp
            <div class="col-md-6 col-lg-4 mb-3 articulo-archivo-item">
                <div class="card card-outline card-secondary h-100 mb-0">
                    <div class="card-body p-2 d-flex flex-column">
                        ...
                        @if (! $ocultarInputsConservar)
                            ...
                            <button type="button" class="btn btn-sm btn-outline-danger mt-2 eliminar-archivo-articulo" title="Quitar de la lista; se elimina al guardar">
