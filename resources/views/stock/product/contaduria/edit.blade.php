...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            ...
            <form action="{{ route('product.contaduria.update', ['id' => $producto->id] + ($filtrosQuery ?? [])) }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
