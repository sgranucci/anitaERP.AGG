...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            ...
            <form action="{{ route('product.tecnica.update', ['id' => $producto->id] + ($filtrosQuery ?? [])) }}" id="form-general" enctype="multipart/form-data" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
