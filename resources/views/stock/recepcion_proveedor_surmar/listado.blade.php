	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado recepción Surmar</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 12%;">OC</th>
				<th style="width: 30%;">Proveedor</th>
				<th style="width: 12%;">Origen</th>
				<th style="width: 14%;">Estado</th>
				<th style="width: 12%;">Ítems</th>
			</tr>
		</thead>
		<tbody>
