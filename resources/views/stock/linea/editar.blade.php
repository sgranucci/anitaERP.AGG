...
@if (config('app.empresa') == 'Calzados Ferli')
    ...
    $(document).ready(function(){
        let row_number = {{ count(old('modulos', $linea->modulos->count() ? $linea->modulos : [''])) }};
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Editar L&iacute;nea</h3>
            ...
            <form action="{{route('actualizar_linea', ['id' => $linea->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="card-body">
