    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Usos de art&iacute;culos</h3>
                <div class="card-tools">
                    <a href="{{route('crear_usoarticulo')}}" class="btn btn-outline-secondary btn-sm">
                       	@if (can('crear-uso-de-articulos', false))
