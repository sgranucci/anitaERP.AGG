...
<script src="{{ asset('assets/pages/scripts/stock/movimientostock/form-canje.js') }}?v={{ @filemtime(public_path('assets/pages/scripts/stock/movimientostock/form-canje.js')) ?: time() }}" type="text/javascript"></script>
