    ...
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-handshake-o"></i> Nuevo préstamo</h3>
            ...
            <form action="{{ route('guardar_prestamo') }}" id="form-prestamo" class="form-horizontal" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
