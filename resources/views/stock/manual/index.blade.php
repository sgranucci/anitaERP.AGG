...
<div class="mc-shell">
    <aside class="mc-sidebar">
        <div class="mc-sidebar-brand">
            <h1>Anita ERP</h1>
            <p>Manual de usuario · Recuento de inventario</p>
        </div>
        <nav class="mc-nav">
    ...
    <div class="mc-main">
        <header class="mc-topbar">
            ...
            <a href="{{ route('recuento') }}" class="mc-btn">Recuento</a>
            <button type="button" id="mc-theme-toggle" class="mc-btn" title="Cambiar tema">Tema</button>
            <a href="{{ route('manual_stock_pdf') }}" class="mc-btn" target="_blank" rel="noopener">PDF</a>
            <a href="{{ route('manual_stock_word') }}" class="mc-btn" target="_blank" rel="noopener">Word</a>
        </header>
        ...
        <main class="mc-content">
            ...
            @foreach ($meta['secciones'] as $i => $sec)
                <article id="cap-{{ $i }}" class="mc-chapter">
                    ...
                    @include('stock.manual.partials.capturas-seccion', ['sec' => $sec])
