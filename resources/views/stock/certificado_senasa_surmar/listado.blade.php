...
<head>
	...
	<title>Certificado SENASA Surmar</title>
	<style>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado certificado SENASA Surmar</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 36%;">Remito AFIP</th>
				<th style="width: 16%;">Ítems</th>
			</tr>
		</thead>
		<tbody>
