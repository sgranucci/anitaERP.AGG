...
@section("scripts")
<script>
    window.DEPMAE_EDITAR_URL = @json(route('editar_depmae', ['id' => '__ID__']));
</script>
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Editar Dep&oacute;sito</h3>
            ...
            <form action="{{route('actualizar_depmae', ['id' => $data->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="card-body">
