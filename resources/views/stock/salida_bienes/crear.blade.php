    ...
    <div class="col-lg-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-truck"></i> Nueva salida de bienes</h3>
            ...
            <form action="{{ route('guardar_salida_bienes') }}" id="form-prestamo" class="form-horizontal" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
