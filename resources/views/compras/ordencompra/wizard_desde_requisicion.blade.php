                    ...
                    <div class="card-body py-2">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row mb-2">
                                    @php
                                        $wzDetalleObligatorio = \App\Support\Compras\OrdencompraUiConfigSupport::detalleObligatorio();
                                    @endphp
                                    <label class="col-lg-3 col-form-label{{ $wzDetalleObligatorio ? ' requerido' : '' }} text-right pr-2" for="wz_detalle">Detalle</label>
                                    <div class="col-lg-9">
                                        <textarea id="wz_detalle" rows="3" class="form-control form-control-sm{{ !empty($wizardPlantilla['detalle_autogenerado']) ? ' border-warning' : '' }}" maxlength="2000" aria-describedby="wz_detalle_aviso"{{ $wzDetalleObligatorio ? ' required' : '' }}>{{ $wizardPlantilla['detalle'] ?? '' }}</textarea>
