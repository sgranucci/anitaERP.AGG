...
<div id="oc-solapa-principal" class="oc-solapa">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group row">
                <label for="empresa_id" class="col-lg-4 control-label requerido">Empresa</label>
                <div class="col-lg-8">
            ...
            <div class="form-group row align-items-center" id="div-proveedor-oc">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        @if (!$soloLectura)
                            <button type="button" title="Consulta proveedores" class="btn-accion-tabla consultaproveedor tooltipsC">
