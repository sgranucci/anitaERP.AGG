{{--
    Plantilla archivada: orden de compra en hoja Legal APaisada (horizontal).
    Reactivar desde imprimir-pdf con query: ?formato=apaisado
    Mantener alineada con pdf.blade.php (vertical) en datos y textos salvo columnas de ítems.
--}}
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <table class="items">
        <thead>
            <tr>
                ...
                <th style="width:{{ $ocMostrarPesoPdf ? '28%' : '36%' }};">Descripción</th>
                ...
                @endif
                <th class="num items-col-punit" style="width:8%;">P.unit.</th>
