<div class="collapse {{ \App\Support\Compras\CumplimientoRequisicionCompraListadoFiltros::tieneCriteriosAplicados($filtros ?? []) ? 'show' : '' }}" id="panel-filtros-cumple-req-compra">
    <div class="card-body border-top bg-light py-3">
        ...
        <a href="{{ $limpiarUrl ?? route('cumplir_requisicion_compra') }}" class="btn btn-link btn-sm">Limpiar</a>
    </div>
</div>
