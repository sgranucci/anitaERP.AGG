...
<style>
	...
	#arca-cuit-entry-modal .ft { padding: 12px 16px; border-top: 1px solid #e9ecef; display: flex; flex-wrap: wrap; align-items: center; gap: 8px; }
	#arca-cuit-entry-loading { display: none; padding: 6px 10px; background: #e7f3ff; border: 1px solid #b8daff; border-radius: 6px; color: #004085; font-size: 0.88em; align-items: center; gap: 8px; white-space: nowrap; }
