...
<style>
	...
	#arca-cuit-entry-modal .ft { padding: 12px 16px; border-top: 1px solid #e9ecef; display: flex; justify-content: flex-end; gap: 8px; }
	#arca-cuit-entry-loading { display: none; margin-top: 12px; padding: 10px 12px; background: #e7f3ff; border: 1px solid #b8daff; border-radius: 6px; color: #004085; font-size: 0.95em; align-items: center; gap: 10px; }
...
<div id="arca-cuit-entry-overlay" role="dialog" aria-modal="true" aria-labelledby="arca-cuit-entry-title">
	<div id="arca-cuit-entry-modal">
		...
		<div class="ft">
			<button type="button" class="btn btn-light" id="arca-cuit-entry-cancel">Cancelar</button>
