@php
    ...
    $f = $filtros ?? [];
    $modo = $f['modo'] ?? PagoproveedorListadoFiltros::MODO_TODOS;
    $campoActivo = $f['campo'] ?? 'proveedor';
    $operadorActivo = $f['operador'] ?? 'contiene';
    $operadoresJson = [];
    foreach (PagoproveedorListadoFiltros::CAMPOS as $key => $meta) {
        ...
        <div class="form-row align-items-end">
            <div class="form-group col-md-2 col-sm-6 mb-2">
                ...
                <select name="filtro_modo" id="filtro_modo" class="form-control form-control-sm">
                    ...
                    <option value="{{ PagoproveedorListadoFiltros::MODO_CAMPO }}" {{ $modo === PagoproveedorListadoFiltros::MODO_CAMPO ? 'selected' : '' }}>Campo determinado</option>
                </select>
            </div>
            <div class="form-group col-md-2 col-sm-6 mb-2 filtro-campo-wrap" style="{{ $modo !== PagoproveedorListadoFiltros::MODO_CAMPO ? 'display:none' : '' }}">
                ...
                <select name="filtro_campo" id="filtro_campo" class="form-control form-control-sm">
                    @foreach($camposFiltro ?? PagoproveedorListadoFiltros::CAMPOS as $key => $meta)
            ...
            <div class="form-group col-md-2 col-sm-6 mb-2">
                ...
                <select name="filtro_operador" id="filtro_operador" class="form-control form-control-sm"
                    ...
                    @foreach(PagoproveedorListadoFiltros::operadoresParaCampo($modo === PagoproveedorListadoFiltros::MODO_CAMPO ? $campoActivo : 'proveedor') as $opKey => $opLabel)
