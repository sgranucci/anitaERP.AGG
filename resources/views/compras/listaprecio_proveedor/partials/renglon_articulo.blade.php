...
<tr class="item-listaprecio-articulo">
    <td>
        ...
        <div class="form-group row celda-articulo-listaprecio mb-0">
            ...
            <button type="button" title="Consulta art&iacute;culos (F1)" class="btn-accion-tabla consultaarticulo tooltipsC" {{ $visualizar ? 'disabled' : '' }}>
                <i class="fa fa-search text-primary"></i>
            </button>
            <input type="text" class="codigoarticulo codigoarticulolocal form-control form-control-sm" name="codigoarticulos[]" value="{{ $sku }}" {{ $visualizar ? 'readonly' : '' }} placeholder="SKU" title="F1 consulta; Enter resuelve el c&oacute;digo">
        </div>
    </td>
    <td>
