@php
    ...
    $logosCabecera = EmpresaLogoArchivo::logosCabeceraDesdeColeccion($listas);
    $totalFilas = is_countable($listas) ? count($listas) : 0;
@endphp
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Listas de precio de proveedores</title>
    <style>
    ...
    <table class="listado-header">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listas de precio de proveedores</h2>
    ...
    <table class="data">
        <thead>
            <tr>
                ...
                <th style="width: 10%;">C&oacute;d. prov.</th>
