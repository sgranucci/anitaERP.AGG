...
<h4 class="mb-3">Archivos asociados</h4>
...
@if ($archivosSubidos->isNotEmpty())
    <h5 class="mt-2">Vista previa adjuntos ERP</h5>
...
<div class="card card-outline card-primary mb-4 mt-3">
    <div class="card-header py-2">
        <h5 class="card-title mb-0">Agregar archivos</h5>
    </div>
    <div class="card-body">
        ...
        <table class="table" id="cp-archivo-table">
            <thead>
                <tr>
                    <th>Archivo</th>
                    <th style="width: 160px;">Tipo</th>
        ...
        <div class="row">
            <div class="col-md-12">
                <button id="cp-agrega-renglon-archivo" type="button" class="pull-right btn btn-danger">+ Agrega renglón</button>
            </div>
        </div>
    </div>
</div>
