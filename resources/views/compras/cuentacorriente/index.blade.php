        ...
        <div class="card card-info">
            <div class="card-header">
                ...
                <div class="d-md-flex justify-content-md-end">
					<form action="{{ route('listar_cuentacorriente_proveedor', ['id' => $id]) }}" method="GET">
						<div class="btn-group">
            ...
            <div class="card-body table-responsive p-0">
                @include('includes.exportar-tabla-id', ['ruta' => 'listar_cuentacorriente_proveedor', 'id' => $id, 'busqueda' => $busqueda])
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="total" id="total" class="form-control total" value="{{$data->total}}"/>
                               	<a href="#" {{--"{{route('editar_cuentacorriente_proveedor', ['id' => $data->numerointerno])}}"--}} class="btn-accion-tabla tooltipsC" title="Editar este registro">
