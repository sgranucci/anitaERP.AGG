                        ...
                        <tr class="item-usuario-tipotransaccion-stock tm-tipotransaccion-stock-campo">
                            <td>
                                <div class="d-flex flex-nowrap align-items-center" style="gap: 4px;">
                                    ...
                                    <input type="text" name="tipotransaccion_stock_abreviaturas[]" class="form-control form-control-sm abreviaturatipotransaccionstock" value="{{ $tipoModel->abreviatura ?? '' }}" autocomplete="off" style="max-width: 6rem;">
                                </div>
                            </td>
                            <td>
