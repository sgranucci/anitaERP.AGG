@php
    ...
    $capex = $capex ?? collect();
    $logosCabecera = EmpresaLogoArchivo::logosCabeceraDesdeColeccion(collect($capex));
    $totalFilas = is_countable($capex) ? count($capex) : 0;
@endphp
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Capex</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 7%;">Nro. Proyecto</th>
				<th style="width: 6%;">Estado</th>
				<th style="width: 18%;">Partidas</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					...
					<td>
						@foreach($data->capex_partidas as $partida)
							...
							@endforeach
							Nro.{{$partida->codigo}} {{$partida->nombre}} {{ $partida->monedas->abreviatura ?? ''}} {{number_format($montoTotal,2)}}@if(!$loop->last); @endif
						@endforeach
					</td>
				</tr>
			@endforeach
