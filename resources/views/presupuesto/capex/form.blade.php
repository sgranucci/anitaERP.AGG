...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group row">
            <label for="nombre" class="col-lg-3 col-form-label text-right">Nombre</label>
    ...
    <div class="col-sm-6">
        <div class="form-group row">
            <label for="codigo" class="col-lg-3 col-form-label text-right">Número de Proyecto</label>
        ...
        <div class="form-group row">
            <label for="codigoproyecto" class="col-lg-3 col-form-label text-right">Código de Proyecto</label>
...
<div class="col-md-12">
    <div class="card card-outline card-info mb-3">
        <div class="card-header py-2">
            <h3 class="card-title mb-0"><i class="fa fa-list"></i> Partidas</h3>
        </div>
        <div class="card-body p-2">
            <div class="table-responsive">
                <table class="table table-sm table-bordered mb-2" id="capex-partida-table">
                            ...
                            @foreach (old('cuota', $data->capex_partidas->count() ? $data->capex_partidas : ['']) as $partida)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <button type="button" class="btn-accion-tabla eliminar_capex_partida tooltipsC" title="Elimina esta línea">
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <button type="button" id="agrega_renglon_capex_partida" class="btn btn-outline-primary btn-sm">
                        <i class="fa fa-plus"></i> Agrega renglón
                    </button>
                </div>
                <div class="col-sm-6">
                    <div class="form-group row mb-0 justify-content-end">
                        <label for="totalpartida" class="col-lg-4 col-form-label text-right">Total partidas</label>
