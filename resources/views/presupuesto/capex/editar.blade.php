    ...
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                @if (!isset($visualizar))
                    <h3 class="card-title">Editar Capex - Número {{$data->codigo ?? ''}} - Id {{$data->id}} - Proyecto {{$data->codigoproyecto}}</h3>
            ...
            <form action="{{route('actualizar_capex', ['id' => $data->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf @method("put")
