<template id="template-vianda-articulo-dia">
    <div class="vianda-articulo-fila mb-2 item-vianda-articulo-dia" data-dia="__DIA__">
        ...
        <div class="input-group input-group-sm mb-1">
            ...
            <input type="text" class="form-control form-control-sm codigoarticulo" name="codigoarticulos_dia[__DIA__][]" value="" placeholder="SKU">
        </div>
