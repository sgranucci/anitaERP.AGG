    ...
    <div class="col-lg-12">
        ...
        <div class="card card-danger">
            <div class="card-header">
                <h3 class="card-title">Crear tipo de men&uacute; de vianda</h3>
            ...
            <form action="{{ route('guardar_vianda_tipo_menu_gastronomia') }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
