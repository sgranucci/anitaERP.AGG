	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Destinos SENASA</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 10%;">Cód. zona</th>
				<th style="width: 18%;">Zona</th>
				<th style="width: 18%;">Localidad</th>
				<th style="width: 16%;">Provincia</th>
				<th style="width: 8%;">País</th>
				<th style="width: 10%;">Patagónico</th>
				<th style="width: 14%;">Código de localidad SENASA</th>
			</tr>
		</thead>
		<tbody>
