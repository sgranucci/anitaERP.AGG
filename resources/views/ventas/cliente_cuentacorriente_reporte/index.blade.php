...
@section('titulo')
    Deuda / cuenta corriente clientes
@endsection
...
@include('includes.proceso_overlay_aviso', [
    'overlayId' => 'cc-clientes-reporte-overlay',
    'tituloId' => 'cc-clientes-reporte-titulo',
    'subtituloId' => 'cc-clientes-reporte-subtitulo',
    'titulo' => 'Consultando cuenta corriente…',
    'subtitulo' => 'Puede demorar según el período y la cantidad de clientes. No cierre la página.',
])
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Deuda / ficha de cuenta corriente de clientes</h3>
                <div class="card-tools">
                    <a href="{{ route('cliente_cuentacorriente_reporte') }}" class="btn btn-outline-secondary btn-sm" title="Limpiar filtros">
                        <i class="fa fa-eraser"></i> Limpiar
                    </a>
                </div>
            </div>

            <form method="get" action="{{ route('cliente_cuentacorriente_reporte') }}" id="form-cc-clientes-reporte" class="mb-0">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <label class="custom-control-label" for="solo_totales">
                                    Imprimir solo el total de cada cliente (sin detalle de comprobantes)
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            @if ($consultado ?? false)
                <div class="card-body border-top pt-3">
                    ...
                    <div class="mb-3">
                        <a href="{{ route('listar_cliente_cuentacorriente_reporte', ['formato' => 'PDF']) }}?{{ $exportQuery }}" class="btn btn-app bg-danger js-cc-reporte-export">
                            <i class="fas fa-file-pdf"></i> Pdf
                        </a>
                        <a href="{{ route('listar_cliente_cuentacorriente_reporte', ['formato' => 'EXCEL']) }}?{{ $exportQuery }}" class="btn btn-app bg-success js-cc-reporte-export">
                            <i class="fas fa-file-excel"></i> Excel
                        </a>
                        <a href="{{ route('listar_cliente_cuentacorriente_reporte', ['formato' => 'CSV']) }}?{{ $exportQuery }}" class="btn btn-app bg-warning js-cc-reporte-export">
                    ...
                    <div class="table-responsive">
                        <table id="tabla-cc-clientes-reporte" class="table table-bordered table-hover table-sm mb-0" style="font-size: 0.82rem;">
