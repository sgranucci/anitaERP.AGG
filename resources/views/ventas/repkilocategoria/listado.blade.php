@php
    ...
    $tituloReporte = 'Kilos por categoría';
    $subtitulo = 'Reparto: '.KiloCategoriaListadoFiltros::formatearRepartoTexto($filtros)
        .' · Período: '.KiloCategoriaListadoFiltros::formatearPeriodoTexto($filtros);
@endphp
<!DOCTYPE html>
<html lang="es">
<head>
