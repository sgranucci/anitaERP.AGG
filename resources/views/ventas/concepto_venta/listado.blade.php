...
<head>
	...
	<title>Conceptos de venta</title>
	<style>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Conceptos de venta</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 12%;">Alícuota</th>
				<th style="width: 8%;">Unidad</th>
				<th style="width: 28%;">Cuentas contables</th>
		...
		<tbody>
			@foreach ($datas as $data)
				<tr>
					...
					<td>{!! nl2br(e($data->textoCuentasContables())) !!}</td>
