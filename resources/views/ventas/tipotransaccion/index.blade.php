    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Tipos de Transacciones de Ventas</h3>
                <div class="card-tools">
                    <a href="{{route('crear_tipotransaccion')}}" class="btn btn-outline-secondary btn-sm">
                       	@if (can('crear-tipos-transacciones', false))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
								...
								@endif
                       			@if (can('borrar-tipos-transacciones', false))
                                <form action="{{route('eliminar_tipotransaccion', ['id' => $data->id])}}" class="d-inline form-eliminar" method="POST">
                                    @csrf @method("delete")
