    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Configuración de PC de gastronomía</h3>
                <div class="card-tools">
                    ...
                    <a href="{{ route('crear_configuracion_puntoventa_gastronomia') }}" class="btn btn-outline-secondary btn-sm">
                        <i class="fa fa-fw fa-plus-circle"></i> Nueva PC
                    </a>
                    @endif
                </div>
            </div>
            <div class="card-body">
                <p class="text-muted mb-3">
                    Solo terminales del POS de gastronomía (facturación, Waitry, depósitos, PV CAE/CAEA).
                    Las PC de estacionamiento: Configuración → Configuración por módulo → Caja → Config. punto de venta estacionamiento.
                </p>
