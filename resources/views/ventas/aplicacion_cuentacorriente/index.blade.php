    ...
    <div class="acc-hero">
        <div class="d-flex justify-content-between align-items-start flex-wrap">
            <div>
                ...
                <p class="acc-sub">Elegí un crédito a la izquierda (NC o cobranza): la sugerencia automática y los tilde de facturas aplican solo ese crédito. Para cruzar todos a la vez usá Rehacer FIFO.</p>
            </div>
