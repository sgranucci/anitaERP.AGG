                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                    <div>
                        <h3 class="card-title mb-0">
                            <i class="fa fa-users mr-1"></i> Comisiones de vendedores
                        </h3>
                    ...
                    <div class="card-tools mt-2 mt-md-0">
                        <a href="{{ route($ruta_hermano ?? 'comision_vendedor_detalle', $filtrosQuery ?? []) }}"
                           class="btn btn-outline-light btn-sm mr-1" title="Ir al detalle por factura">
                            <i class="fa fa-list"></i> Ver detalle
                        </a>
                        <a href="{{ route($ruta_index ?? 'comision_vendedor') }}" class="btn btn-outline-light btn-sm" title="Limpiar filtros">
                            <i class="fa fa-eraser"></i> Limpiar
                        </a>
                    </div>
                </div>
            </div>
            <form method="get" action="{{ route($ruta_index ?? 'comision_vendedor') }}" id="form-comision-vendedor" class="mb-0">
                <div class="card-body pb-2">
                    <p class="text-muted small mb-3">
                        Agrega el detalle de facturas por cliente dentro de cada vendedor (neto gravado y comisi&oacute;n).
                        Misma base de c&aacute;lculo que el listado detalle.
                    </p>
                ...
                <div class="card-body p-0 border-top">
                        ...
                        <div class="comision-vendedor-kpis px-3 py-3">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <div class="comision-kpi">
                                        <div class="comision-kpi-label">Neto</div>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between px-3 py-2 border-bottom bg-light">
                        <div class="mb-1 mb-md-0">
                            @include('includes.exportar-tabla-queryparams', [
                                'ruta' => $ruta_export ?? 'listar_comision_vendedor',
                    ...
                    <style>
                        .comision-vendedor-hero {
                            background: linear-gradient(120deg, #145A32 0%, #1E8449 45%, #58D68D 100%) !important;
                            border-bottom: 0;
                        }
                    ...
                    <div class="table-responsive">
                        <table id="tabla-comision-vendedor" class="table table-striped table-bordered table-hover table-sm mb-0" style="font-size: 0.78rem;">
                            @include('ventas.comision_vendedor.partials.tabla_datos', [
                                'filas' => $filasVista ?? [],
