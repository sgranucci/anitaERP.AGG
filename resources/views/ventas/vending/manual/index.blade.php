...
<div class="mc-shell">
    ...
    <div class="mc-main">
        <header class="mc-topbar">
            ...
            <a href="{{ route('consultar_maquinavending_gastronomia') }}" class="mc-btn">Máquinas</a>
            <a href="{{ route('consultar_maquinavending_rendicion_gastronomia') }}" class="mc-btn">Rendiciones</a>
            <a href="{{ route('rendicionmaquinavending') }}" class="mc-btn">Caja</a>
            <button type="button" id="mc-theme-toggle" class="mc-btn" title="Cambiar tema">Tema</button>
            <a href="{{ route('manual_vending_pdf') }}" class="mc-btn" target="_blank" rel="noopener">PDF</a>
            <a href="{{ route('manual_vending_word') }}" class="mc-btn" target="_blank" rel="noopener">Word</a>
        </header>
        ...
        <main class="mc-content">
            <section class="mc-hero">
                ...
                <div class="mc-nota-agg">
                    Circuito en dos etapas: <strong>Ventas</strong> registra el cierre operativo (informe X) y replica a Anita;
                    <strong>Caja</strong> presenta la rendición en tesorería (total Z).
                    El salón gastronómico tiene manual propio en
                    <a href="{{ route('manual_gastronomia') }}" style="color:var(--mc-accent)">Gastronomía</a>.
                </div>
            </section>
            ...
            @foreach ($meta['secciones'] as $i => $sec)
                <article id="cap-{{ $i }}" class="mc-chapter">
                    ...
                    @include('ventas.vending.manual.partials.capturas-seccion', ['sec' => $sec])
