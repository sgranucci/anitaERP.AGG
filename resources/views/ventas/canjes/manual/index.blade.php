...
<div class="mc-shell">
    <aside class="mc-sidebar">
        <div class="mc-sidebar-brand">
            <h1>Anita ERP</h1>
            <p>Manual de usuario · Canjes Marketing</p>
        </div>
        <nav class="mc-nav">
    ...
    <div class="mc-main">
        <header class="mc-topbar">
            ...
            <a href="{{ route('canje_marketing_proceso_facturacion') }}" class="mc-btn">Facturador</a>
            <button type="button" id="mc-theme-toggle" class="mc-btn" title="Cambiar tema">Tema</button>
            <a href="{{ route('manual_canjes_marketing_pdf') }}" class="mc-btn" target="_blank" rel="noopener">PDF</a>
            <a href="{{ route('manual_canjes_marketing_word') }}" class="mc-btn" target="_blank" rel="noopener">Word</a>
        </header>
        ...
        <main class="mc-content">
            ...
            @foreach ($meta['secciones'] as $i => $sec)
                <article id="cap-{{ $i }}" class="mc-chapter">
                    ...
                    @include('ventas.canjes.manual.partials.capturas-seccion', ['sec' => $sec])
