<template id="template-renglon-factura">
	<tr class="item-factura">
		...
		<td style="margin : 0; padding : 0; height: 17px;">
			<input type="text" name="pesadas_fac[]" class="form-control pesada_fac" value="" readonly/>
		</td>			
		<td style="margin : 0; padding : 0; height: 17px;">
			<input type="text" name="porcentajedescuentos_fac[]" class="form-control porcentajedescuento_fac" value="" readonly/>
			<input type="hidden" name="descuentoventa_ids_fac[]" class="form-control descuentoventa_id_fac" value="" readonly/>
		</td>
        <td style="margin : 0; padding : 0; height: 17px;">
