...
@php
    $politicaCliente = isset($remito) && $remito->clientes
        ? \App\Support\Ventas\ClientePoliticaComercialSupport::payload($remito->clientes)
        : null;
@endphp
@include('includes.ventas.cliente_politica_contexto', ['contextoPoliticaCliente' => 'boleta', 'politicaCliente' => $politicaCliente])
