<div class="modal fade" id="facturarRemitoModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Facturaci&oacute;n de Remito</h5>
        ...
        <div class="modal-body">
            <form>
                ...
                <div class="form-group">
                    ...
                    <table class="table table-sm" id="factura-remito-table">
                        <thead>
                            <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <table class="table table-sm" id="total-factura-remito-table">
                            <thead>
            ...
            @include('ventas.remito.templatefacturapedido')
            @include('ventas.remito.templatetotalitemfacturapedido')
            @include('ventas.remito.templatetotalfacturapedido')
        </div>
