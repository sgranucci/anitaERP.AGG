<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group row">
			...
			<input type="text" id="estadopedido" name="estadopedido" class="col-lg-3 form-control" readonly value="{{ $pedido->estadopedido ?? '' }}">
			<input type="hidden" id="caja_reales" name="caja_reales" value="{{ old('caja_reales', $pedido->caja_reales ?? '') }}">
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			<label for="zonavta" class="col-lg-3 col-form-label">Zona de venta</label>
				<input type="hidden" id="zonavta_id_previa" name="zonavta_id_previa" value="{{old('zonavta_id', $pedido->zonavta_id ?? '')}}" >
				<input type="hidden" id="desc_zonavta" name="desc_zonavta" value="{{old('desc_zonavta', $pedido->desc_zonavta ?? '')}}" >
				<input type="hidden" class="col-form-label zonavta_id" id="zonavta_id" name="zonavta_id" value="{{$pedido->zonavta_id ?? ''}}" >
				<input type="text" class="form-control col-lg-2 codigozonavta" id="codigozonavta" name="codigozonavta" value="{{$pedido->zonavtas->codigo ?? ''}}" >
				<input type="text" class="form-control col-lg-4 nombrezonavta" id="nombrezonavta" name="nombrezonavta" value="{{$pedido->zonavtas->nombre ?? ''}}" readonly>
				<button type="button" title="Consulta zonavtaes" style="padding:1;" class="btn-accion-tabla consultazonavta tooltipsC">
					<i class="fa fa-search text-primary"></i>
				</button>
				<input type="hidden" name="nombrezonavta" id="nombrezonavta" class="form-control" value="{{old('nombrezonavta', $pedido->zonavtas->nombre ?? '')}}">
		</div>
       	<input type="hidden" name="condicionventa_id" id="condicionventa_id" value="{{$pedido->condicionventa_id??''}}">
        <input type="hidden" id="descuento" name="descuento" class="form-control col-lg-2" value="{{$pedido->descuento ?? '0'}}" />
	</div>
</div>
