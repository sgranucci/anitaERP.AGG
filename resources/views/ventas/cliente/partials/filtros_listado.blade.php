@php
    ...
    $f = $filtros ?? [];
    $modo = $f['modo'] ?? ClienteListadoFiltros::MODO_TODOS;
...
@endphp
<div class="collapse border-bottom" id="panel-filtros-cliente" data-listado-filtros-panel>
        ...
        <div class="form-row align-items-end">
            <div class="form-group col-md-2 col-sm-6 mb-2">
                ...
                <select name="filtro_modo" id="filtro_modo" class="form-control form-control-sm">
                    <option value="{{ ClienteListadoFiltros::MODO_TODOS }}" {{ $modo === ClienteListadoFiltros::MODO_TODOS ? 'selected' : '' }}>Cualquier campo</option>
                    <option value="{{ ClienteListadoFiltros::MODO_CAMPO }}" {{ $modo === ClienteListadoFiltros::MODO_CAMPO ? 'selected' : '' }}>Campo determinado</option>
                </select>
            </div>
            ...
            <div class="form-group col-md-2 col-sm-6 mb-2">
                ...
                <select name="filtro_operador" id="filtro_operador" class="form-control form-control-sm"
                    ...
                    @foreach(ClienteListadoFiltros::operadoresParaCampo($modo === ClienteListadoFiltros::MODO_CAMPO ? $campoActivo : 'nombre') as $opKey => $opLabel)
