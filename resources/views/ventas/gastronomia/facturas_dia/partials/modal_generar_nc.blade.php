{{--
    Modal y overlay de procesamiento para generar nota de crédito desde:
    - Listado «Facturas gastronomía del día»
    - Detalle «Ver comprobante» de facturas gastronomía

    El overlay full-screen actúa como aviso visible (móvil y desktop) mientras
    se procesa la NC, ya que es una operación que no debe interrumpirse.
--}}
