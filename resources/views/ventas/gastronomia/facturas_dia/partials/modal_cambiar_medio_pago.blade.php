        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-2">
                <p class="small text-muted mb-2 mb-md-1">
                    Misma grilla que en facturación gastronomía: busque la cuenta por código o use los accesos rápidos.
    ...
    <tr class="item-cuenta-fd-cmp" data-linea-id="" data-monto-original="">
        <td>
            ...
            <div class="fd-cmp-cc-cuenta-wrap">
                ...
                <button type="button" title="Consulta cuentas (uso Gastronomía)" class="btn-accion-tabla consultacuentacaja fd-cmp-consulta tooltipsC">
