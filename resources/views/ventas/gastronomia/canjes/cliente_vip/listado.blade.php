...
<head>
    ...
    <title>Clientes VIP gastronomía</title>
    <style>
    ...
    <table class="listado-header">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado de clientes VIP gastronomía</h2>
    ...
    <table class="data">
        <thead>
            <tr>
                ...
                <th style="width: 7%;">F. alta</th>
                <th style="width: 7%;">F. mod.</th>
            </tr>
        </thead>
        <tbody>
