        ...
        <div class="card card-outline card-primary">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="btn-group btn-group-sm mt-1 mt-md-0">
                    ...
                    @else
                        <a href="{{ route('gastronomia_cierres_turno') }}" class="btn btn-outline-secondary">
                            Volver al listado
                        </a>
                    @endif
                </div>
            ...
            <div class="card-body">
                <ul class="nav nav-tabs mb-3" id="cierre-turno-ver-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="tab-ver-canjes-premio-link" data-toggle="tab"
                           href="#tab-ver-canjes-premio" role="tab">Canjes premio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab-ver-canjes-fidelidad-link" data-toggle="tab"
                           href="#tab-ver-canjes-fidelidad" role="tab">Canjes fidelidad</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab-ver-tickets-tarjeta-link" data-toggle="tab"
                           href="#tab-ver-tickets-tarjeta" role="tab">Tickets tarjeta</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-ver-canjes-premio" role="tabpanel">
                        ...
                        <div class="table-responsive gastro-grilla-conciliacion-wrap">
                            <table class="table table-sm table-bordered mb-0">
                                ...
                                <tbody id="ct-canjes-premio-body">
                                    <tr><td colspan="9" class="text-muted small">Abra esta solapa para cargar.</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>

                    <div class="tab-pane fade" id="tab-ver-canjes-fidelidad" role="tabpanel">
                        ...
                        <div class="table-responsive gastro-grilla-conciliacion-wrap">
                            <table class="table table-sm table-bordered mb-0">
                                ...
                                <tbody id="ct-canjes-fidelidad-body">
                                    <tr><td colspan="9" class="text-muted small">Abra esta solapa para cargar.</td></tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="tab-pane fade" id="tab-ver-tickets-tarjeta" role="tabpanel">
                        ...
                        <div class="table-responsive gastro-grilla-conciliacion-wrap">
                            <table class="table table-sm table-bordered mb-0">
                                ...
                                <tbody id="ct-tickets-tarjeta-body">
                                    <tr><td colspan="7" class="text-muted small">Abra esta solapa para cargar.</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
