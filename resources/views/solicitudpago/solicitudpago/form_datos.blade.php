...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="form-group row">
            <label for="tratamiento" class="col-lg-3 col-form-label requerido">Tratamiento</label>
            <div class="col-lg-4">
        ...
        <div class="form-group row">
            <label for="concepto_solicitudpago_id" class="col-lg-3 col-form-label">Concepto</label>
            <div class="col-lg-7">
        ...
        <div class="form-group row">
            <label for="formapagosol_id" class="col-lg-3 col-form-label">Forma de pago</label>
            <div class="col-lg-6">
        ...
        <div class="form-group row">
            <label for="beneficiario" class="col-lg-3 col-form-label">Beneficiario</label>
            <div class="col-lg-7">
        ...
        <div class="form-group row">
            <label for="endoso" class="col-lg-3 col-form-label">Endoso</label>
            <div class="col-lg-7">
        ...
        <div class="form-group row">
            ...
            <label for="fecha_vencimiento" class="col-lg-2 col-form-label">Vencimiento</label>
            <div class="col-lg-3">
        ...
        <div class="form-group row">
            <label for="estado_mostrar" class="col-lg-3 col-form-label">Estado</label>
            <div class="col-lg-4">
                <input type="text" id="estado_mostrar" class="form-control" readonly
                       value="@foreach ($estado_enum as $opt)@if ($opt['valor'] === $estadoActual){{ $opt['nombre'] }}@endif@endforeach"/>
        ...
        @if (isset($data) && $data->madre)
            <div class="form-group row">
                <label class="col-lg-3 col-form-label">SP madre</label>
                <div class="col-lg-4">
