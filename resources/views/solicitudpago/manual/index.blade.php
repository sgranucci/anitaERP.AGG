...
<div class="mc-shell">
    <aside class="mc-sidebar">
        <div class="mc-sidebar-brand">
            <h1>Anita ERP</h1>
            <p>Manual · Solicitudes de pago</p>
        </div>
        <nav class="mc-nav">
    ...
    <div class="mc-main">
        <header class="mc-topbar">
            ...
            <a href="{{ route('consultar_solicitudpago') }}" class="mc-btn">Listado SP</a>
            <a href="{{ route('informe_solicitudpago') }}" class="mc-btn">Informe</a>
            <button type="button" id="mc-theme-toggle" class="mc-btn" title="Cambiar tema">Tema</button>
            <a href="{{ route('manual_solicitudpago_pdf') }}" class="mc-btn" target="_blank" rel="noopener">PDF</a>
            <a href="{{ route('manual_solicitudpago_word') }}" class="mc-btn" target="_blank" rel="noopener">Word</a>
        </header>
            ...
            @foreach ($meta['secciones'] as $i => $sec)
                <article id="cap-{{ $i }}" class="mc-chapter">
                    ...
                    @include('manual.partials.capturas-seccion', [
                        'sec' => $sec,
                        'configKey' => 'manual_solicitudpago',
                        'imgPublicPrefix' => 'docs/manual-solicitudpago/img',
                    ])
