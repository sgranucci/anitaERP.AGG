<div class="modal fade" id="modal-preview-asiento-cierre-rend-bingo" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="modal-preview-asiento-titulo">Preview cierre bingo</h5>
            ...
            <div class="modal-body">
                ...
                <p id="modal-preview-fbi-info" class="small text-info d-none mb-2"></p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btn-confirmar-cierre-rend-bingo">
                    <i class="fa fa-lock"></i> Confirmar cierre + FBI
                </button>
            </div>
        </div>
    </div>
