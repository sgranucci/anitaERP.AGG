...
<div class="mc-shell">
    ...
    <div class="mc-main">
        <header class="mc-topbar">
            ...
            <a href="{{ route('cierre_periodo_contable') }}" class="mc-btn">Cierre de período</a>
            <a href="{{ route('apertura_periodo_contable') }}" class="mc-btn">Aperturas</a>
            <button type="button" id="mc-theme-toggle" class="mc-btn" title="Cambiar tema">Tema</button>
            <a href="{{ route('manual_contable_pdf') }}" class="mc-btn" target="_blank" rel="noopener">PDF</a>
            <a href="{{ route('manual_contable_word') }}" class="mc-btn" target="_blank" rel="noopener">Word</a>
        </header>
            ...
            @foreach ($meta['secciones'] as $i => $sec)
                <article id="cap-{{ $i }}" class="mc-chapter">
                    ...
                    @include('manual.partials.capturas-seccion', [
                        'sec' => $sec,
                        'configKey' => 'manual_contable',
                        'imgPublicPrefix' => 'docs/manual-contable/img',
                    ])
