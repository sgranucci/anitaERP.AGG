<div class="modal fade" id="modal-preview-asiento-cierre-rend-maquina" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="modal-preview-asiento-titulo">Preview cierre m&aacute;quinas</h5>
            ...
            <div class="modal-body">
                ...
                <p id="modal-preview-fsl-info" class="small text-info d-none mb-2"></p>
                <div class="form-group row mb-2">
                    ...
                    <div class="col-lg-7 col-form-label text-muted small">
                        Fecha jornada del grupo (d&iacute;a operativo por empresa).
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btn-confirmar-cierre-rend-maquina">
                    <i class="fa fa-lock"></i> Confirmar cierre + FSL
                </button>
            </div>
        </div>
    </div>
