...
<head>
    ...
    <title>Cierre rend. m&aacute;quinas</title>
    <style>
...
@if ($esExcel)
    ...
    <table class="data">
        ...
        <tbody>
            <tr>
                <td colspan="{{ $colspan }}"><strong style="font-size: 16pt;">Cierre rendiciones m&aacute;quinas (Contable)</strong></td>
            </tr>
            <tr>
        ...
        <tbody>
            @forelse ($rendiciones as $row)
                <tr>
                    ...
                    <td>{{ $row->turno_label ?? $row->turno ?? '—' }}</td>
                    ...
                    <td class="num">{{ $fmtNum($row->resultado_turno) }}</td>
                </tr>
            @empty
                <tr>
    ...
    <table class="listado-header">
        <tr>
            ...
            <td style="width: 47%; text-align: center;">
                <h2 style="margin: 0; font-size: 13px; font-weight: bold;">Cierre rendiciones m&aacute;quinas (Contable)</h2>
