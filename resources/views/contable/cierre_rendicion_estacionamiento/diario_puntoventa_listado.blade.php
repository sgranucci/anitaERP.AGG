@php
    ...
    $resultado = $resultado ?? [];
    $matriz = $matriz ?? EstacionamientoDiarioPuntoventaExport::matrizAncha($resultado);
...
@if ($esExcel)
    <table>
        ...
        <tbody>
            <tr>
                <td colspan="{{ $colspan }}"><strong style="font-size: 14pt;">Diario estacionamiento por PV / medios (Contable)</strong></td>
            </tr>
            <tr>
    ...
    <table class="listado-header">
        <tr>
            ...
            <td style="width: 56%; text-align: center;">
                <h2 style="margin: 0; font-size: 12px; font-weight: bold;">Diario estacionamiento por PV / medios (Contable)</h2>
...
@if ($bloquesPv === [])
    <p style="text-align:center;">Sin facturaci&oacute;n estacionamiento en el rango indicado.</p>
@else
    <table class="data">
        <thead>
            <tr>
