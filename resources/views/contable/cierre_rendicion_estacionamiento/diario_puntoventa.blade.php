...
@section('titulo')
    Diario estacionamiento por PV (Contable)
@endsection
        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                <div class="alert alert-info py-2 small mb-3">
                    ...
                    <ul class="mb-0 pl-3">
                        <li>Una secci&oacute;n por <strong>jornada</strong>; dentro, una fila por <strong>punto de venta</strong> (solo estacionamiento).</li>
                        ...
                        <li>Fuente: emisiones estacionamiento ERP + cobranzas / cuentas de caja (misma l&oacute;gica que cierres de turno).</li>
                    </ul>
                </div>

                <form method="get" action="{{ route('cierre_rendicion_estacionamiento_diario_puntoventa') }}" class="mb-4">
                ...
                @if ($consultar && empty($error_reporte) && $resultado !== null)
                        ...
                        @if (can('exportar-cierre-rendicion-estacionamiento-contable', false))
                            <div class="mr-2 mb-1">
                                @include('includes.exportar-tabla-queryparams', [
                                    'ruta' => 'listar_cierre_rendicion_estacionamiento_diario_puntoventa',
                    ...
                    @if ($dias === [])
                        <p class="text-muted text-center py-4">Sin facturaci&oacute;n estacionamiento en el rango indicado.</p>
                    @else
