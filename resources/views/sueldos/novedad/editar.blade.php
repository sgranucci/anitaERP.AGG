    ...
    <div class="col-lg-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Editar novedad #{{ $data->id }}</h3>
            ...
            <form action="{{route('actualizar_novedad_sueldos', ['id' => $data->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method('PUT')
                <div class="card-body">
                    @include('sueldos.novedad.form', ['data' => $data])
                </div>
