...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-primary">
            ...
            <form action="{{route('guardar_novedad_sueldos')}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
                    @include('sueldos.novedad.form')
                </div>
