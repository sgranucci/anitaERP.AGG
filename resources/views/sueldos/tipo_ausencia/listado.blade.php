	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Tipos de ausencia</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 22%;">Categor&iacute;a</th>
				<th style="width: 10%;" class="text-center">Vacaci.</th>
				<th style="width: 8%;" class="text-center">Paga</th>
				<th style="width: 10%;" class="text-center">D&iacute;as</th>
				<th style="width: 10%;" class="text-center">Tope/a&ntilde;o</th>
			</tr>
		</thead>
		<tbody>
			@foreach ($datas as $data)
				<tr>
					...
					<td class="text-center">{{ $data->afecta_saldo_vacaciones ? 'Sí' : 'No' }}</td>
					<td class="text-center">{{ $data->goza_sueldo ? 'Sí' : 'No' }}</td>
