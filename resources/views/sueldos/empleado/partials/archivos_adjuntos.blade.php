    ...
    <div class="empleado-archivos-preview row">
        @foreach ($archivosList as $arch)
            @php
                ...
                $urlInline = \App\Support\Archivos\ArchivoAdjuntoCacheSupport::urlStoragePublico('archivos/empleados/'.$data->id.'/'.$safeName);
                ...
                <div class="card card-outline card-secondary h-100 mb-0">
                    <div class="card-body p-2 d-flex flex-column">
                        ...
                        @if (! $ocultarInputsConservar)
                            ...
                            <button type="button" class="btn btn-sm btn-outline-danger mt-2 eliminar-archivo-empleado" title="Quitar de la lista; se elimina al guardar">
