<div class="form-group row">
    <label for="fecha_ingreso" class="col-lg-3 control-label">Fecha ingreso</label>
    <div class="col-lg-2">
        <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control"
               value="{{ old('fecha_ingreso', optional($data->fecha_ingreso ?? null)->format('Y-m-d') ?? now()->format('Y-m-d')) }}">
    </div>
    <label for="antiguedad_anterior" class="col-lg-2 control-label">Antig. anterior</label>
    <div class="col-lg-2">
...
<div class="form-group row">
    <label for="categoria_id" class="col-lg-3 control-label">Categoría</label>
    <div class="col-lg-5">
...
<div class="form-group row">
    <label for="agrupamiento_id" class="col-lg-3 control-label">Agrupamiento</label>
    <div class="col-lg-4">
...
<div class="form-group row">
    <label for="lugartrabajo_id" class="col-lg-3 control-label">Lugar de trabajo</label>
    <div class="col-lg-4">
...
<div class="form-group row">
    <label for="centrocosto_id" class="col-lg-3 control-label">Centro de costo</label>
    <div class="col-lg-4">
...
<div class="form-group row">
    <label for="vacacion_id" class="col-lg-3 control-label">Vacaciones</label>
    <div class="col-lg-4">
    ...
    <label for="art_id" class="col-lg-1 control-label">ART</label>
    <div class="col-lg-3">
...
<div class="form-group row">
    <label for="sueldo_basico" class="col-lg-3 control-label">Sueldo básico</label>
    <div class="col-lg-2">
        <input type="number" step="0.0001" name="sueldo_basico" id="sueldo_basico" class="form-control"
               value="{{ old('sueldo_basico', $data->sueldo_basico ?? '') }}">
    </div>
    <label for="jornal_dia" class="col-lg-2 control-label">Jornal día</label>
    <div class="col-lg-2">
        <input type="number" step="0.0001" name="jornal_dia" id="jornal_dia" class="form-control"
               value="{{ old('jornal_dia', $data->jornal_dia ?? '') }}">
    </div>
</div>

<div class="form-group row">
    <label for="jornal_hora" class="col-lg-3 control-label">Jornal hora</label>
    <div class="col-lg-2">
        <input type="number" step="0.0001" name="jornal_hora" id="jornal_hora" class="form-control"
               value="{{ old('jornal_hora', $data->jornal_hora ?? '') }}">
    </div>
    <label for="codigo_liquidacion" class="col-lg-2 control-label">Cód. liquidación</label>
    <div class="col-lg-2">
...
<div class="form-group row">
    <label for="cuenta_bancaria" class="col-lg-3 control-label">Cuenta bancaria</label>
    <div class="col-lg-3">
    ...
    <label for="banco_codigo" class="col-lg-2 control-label">Cód. banco</label>
    <div class="col-lg-2">
...
<div class="form-group row">
    <label for="mano_obra" class="col-lg-3 control-label">Mano de obra</label>
    <div class="col-lg-2">
    ...
    <label for="personal_contratado" class="col-lg-2 control-label">Personal</label>
    <div class="col-lg-2">
...
<div class="form-group row">
    <label for="situacion_sijp" class="col-lg-3 control-label">Situación SIJP</label>
    <div class="col-lg-1">
    ...
    <label for="condicion_sijp" class="col-lg-2 control-label">Condición</label>
    <div class="col-lg-1">
    ...
    <label for="modalidad_sijp" class="col-lg-1 control-label">Modalidad</label>
    <div class="col-lg-1">
...
<div class="form-group row">
    <label for="a_cargo_de" class="col-lg-3 control-label">A cargo de</label>
    <div class="col-lg-4">
...
<div class="form-group row">
    <label for="puesto_jefe" class="col-lg-3 control-label">Puesto jefe</label>
    <div class="col-lg-4">
