...
<head>
	...
	<title>Tablas de antigüedad</title>
	<style>
	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Tablas de antigüedad</h2>
		...
		<tbody>
			@foreach ($datas as $data)
				<tr>
					...
					<td>{{ $data->tramos_count ?? $data->tramos->count() }}</td>
