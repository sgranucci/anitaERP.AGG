    ...
    <div class="col-lg-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Editar tipo de sanción #{{ $data->codigo }}</h3>
            ...
            <form action="{{route('actualizar_tipo_sancion_sueldos', ['id' => $data->id])}}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="card-body">
