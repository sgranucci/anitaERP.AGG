	...
	<table class="listado-header">
		<tr>
			...
			<td style="width: 40%; text-align: center;">
				<h2 style="margin: 0; font-size: 20px; font-weight: bold;">Listado de prendas</h2>
	...
	<table class="data">
		<thead>
			<tr>
				...
				<th style="width: 10%;" class="text-center">EPP</th>
				<th style="width: 14%;" class="text-center">Variantes</th>
			</tr>
		</thead>
		<tbody>
			@foreach ($datas as $data)
				<tr>
					...
					<td>{{ $data->marca }}</td>
					<td class="text-center">{{ $data->es_seguridad ? 'Sí' : 'No' }}</td>
					<td class="text-center">{{ $data->variantes_count ?? 0 }}</td>
				</tr>
			@endforeach
		</tbody>
	</table>
