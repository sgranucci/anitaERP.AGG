        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <p class="text-muted small mb-3">
                    ...
                    @else
                        <span class="text-danger">no configurado (SUELDOS_CONCEPTO_DESCUENTO_FALLO)</span>
                    @endif
                </p>

                @if (can('crear-descuento-fallo-sueldos', false))
                <form method="post" action="{{ route('generar_descuento_fallo_sueldos') }}" class="mb-4">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <label class="small mb-1">Empresa</label>
                            <select name="empresa_id" id="descuento_fallo_empresa_id" class="form-control form-control-sm" required>
                        ...
                        <div class="form-group col-md-2">
                            <label class="small mb-1">Per&iacute;odo de descuento (YYYYMM)</label>
                        ...
                        <div class="col-md-4 mb-3">
                            @include('sueldos.partials.campo_consulta_empleado_sueldos', [
                                'prefix' => 'descuento_fallo_legajo_desde',
                                'inputName' => 'legajo_desde',
                                'legajo' => old('legajo_desde', $defaults['legajo_desde']),
                                'label' => 'Empleado desde',
                                'nextFocus' => '#descuento_fallo_legajo_hasta_legajo',
                            ])
                        </div>
                        <div class="col-md-4 mb-3">
                            @include('sueldos.partials.campo_consulta_empleado_sueldos', [
                                'prefix' => 'descuento_fallo_legajo_hasta',
                        ...
                        <div class="form-group col-md-3 d-flex align-items-end">
                            ...
                            <a href="{{ route('consultar_descuento_fallo_sueldos') }}" class="btn btn-outline-secondary btn-sm"
                            ...
                            @forelse ($cierres as $c)
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="{{ route('ver_descuento_fallo_sueldos', $c->id) }}" class="btn-accion-tabla" title="Ver">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        @if ($c->estado !== 'anulado' && can('anular-descuento-fallo-sueldos', false))
                                            <form action="{{ route('anular_descuento_fallo_sueldos', $c->id) }}" method="post" class="d-inline"
