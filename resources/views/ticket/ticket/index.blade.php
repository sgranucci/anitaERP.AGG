    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Carga de Tickets</h3>
                <div class="card-tools">
                    <a href="{{route('crea_ticket')}}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="d-md-flex justify-content-md-end">
					<form action="{{ route('consulta_ticket') }}" method="GET">
						<div class="btn-group">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route('elimina_ticket', ['id' => $data->id])}}" class="d-inline form-eliminar" method="POST">
                                    @csrf @method("delete")
                                    <button type="submit" onclick="eliminarTicket(event)" class="btn-accion-tabla eliminar tooltipsC" title="Eliminar este registro">
