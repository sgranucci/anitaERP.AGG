    ...
    <div class="card-body">
    	<table class="table" id="cuentacontable-table">
    		...
    		<tbody id="tbody-cuentacontable-table">
		 		@if ($data->concepto_cuentacontable_ordenventas ?? '') 
				@if (count($data->concepto_cuentacontable_ordenventas) > 0)
					@foreach (old('cuenta', $data->concepto_cuentacontable_ordenventas->count() ? $data->concepto_cuentacontable_ordenventas : ['']) as $cuentacontable)
		...
		@include('ordenventa.concepto_ordenventa.template2')
        <div class="row">
        	<div class="col-md-12">
