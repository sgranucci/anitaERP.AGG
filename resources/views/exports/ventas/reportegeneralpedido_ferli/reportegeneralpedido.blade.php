...
<table>
    ...
    @foreach ($comprobantes as $renglon)
		...
		@foreach ($renglon as $data)
			@if ($data[$campoIdData] != $idCorteActual ||
				...
				@if ($idCorteActual != '')
					@include('exports.ventas.reportegeneralpedido_ferli.imprimetotalcorte')
				@endif
				@php 
			...
			@include('exports.ventas.reportegeneralpedido_ferli.imprimeunitem')
	...
	@if ($idCorteActual != '')
		...
		@endfor
	@endif
	@include('exports.ventas.reportegeneralpedido_ferli.imprimetotalfinal')
	</tbody>
</table>
