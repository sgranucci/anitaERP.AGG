@php
    ...
    $rendicionreceptivos = $rendicionreceptivos ?? collect();
    $colspan = 12;

    foreach ($rendicionreceptivos as $v) {
        $v->nombreempresa = $v->nombreempresa ?? '';
    }
    $logosCabecera = $esExcel ? [] : EmpresaLogoArchivo::logosCabeceraDesdeColeccion($rendicionreceptivos);
...
<head>
    ...
    <title>Rendicion de receptivo</title>
    <style>
...
<table class="data">
    @if ($esExcel)
        ...
        <tbody>
            <tr>
                <td colspan="{{ $colspan }}"><strong style="font-size: 16pt;">Rendici&oacute;n de receptivo</strong></td>
            </tr>
            <tr>
